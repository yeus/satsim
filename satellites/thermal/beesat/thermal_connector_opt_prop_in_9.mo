...
within ;
expandable connector thermal_connector_opt_prop_in_9 "thermal_connector_opt_prop_in_9.mo"
	...
	iboss.iboss_thermal.components.surface_properties_in lm annotation(Placement(
		...
		iconTransformation(
			origin={47.5754,49.0995},
			extent={{-20.9005,-20.9005},{20.9005,20.9005}})));
	iboss.iboss_thermal.components.surface_properties_in mm annotation(Placement(
		transformation(
			origin={35.2917,-25.3457},
			extent={{-29.3775,-29.3775},{29.3775,29.3775}}),
		iconTransformation(
		...
		Diagram(
			...
			graphics={
							...
							Text(
								...
								rotation=90)}));
end thermal_connector_opt_prop_in_9;
