...
within ;
model beesat_platine "beesat_platine.mo"
	...
	Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b heatpower_mm annotation(Placement(transformation(extent={{0,-0},{20,20}})));
	equation
