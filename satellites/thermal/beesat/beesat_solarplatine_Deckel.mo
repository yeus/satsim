...
within ;
model beesat_solarplatine_Deckel "beesat_solarplatine_Deckel.mo"
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop ol(
		...
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{65,-15},{85,5}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop om(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{140,-15},{160,5}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop ro(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{215,-15},{235,5}})));
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop ul(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{65,-120},{85,-100}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop um(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{140,-120},{160,-100}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop ur(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{215,-120},{235,-100}})));
	...
	annotation(
		...
		Icon(
			...
			graphics={
							...
							Polygon(
								points={{-358.4,-142.6},{164.9,-146},{161.7,29.4},{118.4,69.40000000000001},{-305.1,74.09999999999999},{-355.1,
								27.4}},
								lineColor={0,0,0},
								fillPattern=FillPattern.Solid,
								origin={-95.09999999999999,-199.3},
								rotation=-180),
							Polygon(
								points={{-256.7,70},{256.7,66.7},{260,226.7},{213.3,276.7},{-206.6,276.6},{-260,
								239.9}},
								lineColor={0,0,0},
								fillPattern=FillPattern.Solid),
							Text(
		...
		experiment(
			StopTime=1,
			StartTime=0));
end beesat_solarplatine_Deckel;
