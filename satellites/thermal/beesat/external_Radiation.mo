...
model external_Radiation "external_Radiation.mo"
	...
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_lo(Gr=thermal_connector_opt_prop_in1.lo.epsilon * thermal_connector_opt_prop_in1.lo.A) annotation(Placement(transformation(extent={{140,-30},{160,-10}})));
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_mo(Gr=thermal_connector_opt_prop_in1.mo.epsilon * thermal_connector_opt_prop_in1.mo.A) annotation(Placement(transformation(extent={{170,-30},{190,-10}})));
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_ro(Gr=thermal_connector_opt_prop_in1.ro.epsilon * thermal_connector_opt_prop_in1.ro.A) annotation(Placement(transformation(extent={{200,-30},{220,-10}})));
	...
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_lu(Gr=thermal_connector_opt_prop_in1.lu.epsilon * thermal_connector_opt_prop_in1.lu.A) annotation(Placement(transformation(extent={{140,-55},{160,-35}})));
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_mu(Gr=thermal_connector_opt_prop_in1.mu.epsilon * thermal_connector_opt_prop_in1.mu.A) annotation(Placement(transformation(extent={{170,-55},{190,-35}})));
	iboss.iboss_thermal.components.VariableRad_no_Input variableRad_ru(Gr=thermal_connector_opt_prop_in1.ru.epsilon * thermal_connector_opt_prop_in1.ru.A) annotation(Placement(transformation(extent={{200,-55},{220,-35}})));
