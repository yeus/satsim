...
within ;
model beesat_Solarplatine "beesat_Solarplatine.mo"
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop ul_4x5(
		...
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{20,-40},{40,-20}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop ur_4x5(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{200,-40},{220,-20}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop ol_4x5(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{20,50},{40,70}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop or_4x5(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{200,50},{220,70}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop um_2x4(
		...
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{105,-25},{125,-5}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop om_2x4(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Andere_Beschichtungen_NS_43_E(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_C_black()) annotation(Placement(transformation(extent={{105,40},{125,60}})));
	...
	iboss.iboss_thermal.components.surface_properties_out ur_zn annotation(Placement(
		...
		iconTransformation(extent={{140,120},{120,100}})));
	iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_ulol1(
		set_surface_area=true,
		TIM=false) annotation(Placement(transformation(
		origin={115,20},
		extent={{-10,-10},{10,10}},
	...
	equation
		...
		connect(or_4x5.zp,or_zp) annotation(Line(
			...
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_ulol1.surface_properties1,um_2x4.yp) annotation(Line(
			points={{115,10},{115,5},{115,-2.3},{115,-7.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_ulol1.surface_properties2,om_2x4.yn) annotation(Line(
			points={{115,30},{115,35},{115,37.3},{115,42.3}},
			color={255,0,0},
			thickness=0.0625));
	annotation(
		ul_4x5(
		...
		Icon(
			...
			graphics={
							Rectangle(
								...
								extent={{-200,203.3},{213.3,-203.3}}),
							Polygon(
								points={{-165,-100.6},{161.7,-100.6},{161.7,29.4},{118.4,69.40000000000001},{-111.6,69.40000000000001},{-165,
								32.7}},
								lineColor={0,0,0},
								fillPattern=FillPattern.Solid,
								origin={4.9,-112.7},
								rotation=-180),
							Polygon(
								points={{-156.7,10},{170,10},{170,140},{126.7,180},{-103.3,180},{-156.7,
								143.3}},
								lineColor={0,0,0},
								fillPattern=FillPattern.Solid),
							Text(
							...
							Text(
								textString="ul",
								lineColor={255,255,0},
								extent={{-145.7,-17},{-42.4,-87}}),
							Text(
								textString="zp-außen",
								lineColor={255,255,255},
								extent={{-79.90000000000001,-43.2},{100,-110}}),
							Text(
								textString="zn-innen",
								lineColor={255,255,255},
								extent={{-92.7,110},{94.09999999999999,33}})}),
		experiment(
			StopTime=1,
			StartTime=0));
end beesat_Solarplatine;
