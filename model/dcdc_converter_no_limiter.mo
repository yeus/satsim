model dcdc_converter_no_dclimiter
  ...
  SIunits.Current i1,i2;
  SIunits.Voltage v1,v2;
  ...
  Modelica.Electrical.Analog.Interfaces.NegativePin p_out "Positive Pin, V_out" annotation(Placement(visible = true, transformation(origin = {103.536,1.9802}, extent = {{-12,-12},{12,12}}, rotation = 0), iconTransformation(origin = {103.536,1.9802}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
  ...
  v1 = p_in.v - gnd.v;
  v2 = p_out.v - gnd.v;
  v2 = if v1 > V_out + 1 then V_out else 0;
