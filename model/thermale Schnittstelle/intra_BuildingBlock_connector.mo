model intra_BuildingBlock_connector "intra_BuildingBlock_connector"
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConnector_contact(G=G_c) annotation(Placement(transformation(origin={30,0}, extent={{-12,-12},{12,12}})));
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalConector_parallel(G=G_p) annotation(Placement(transformation(origin={-30,-0}, extent={{-12.2757,-12.2757},{12.2757,12.2757}})));
  Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyradiation1(Gr=Gr);
...
equation 
  connect(thermalConnector_contact.port_b,port_b) annotation(Line(points={{42,0},{51.6716,0},{73.7721,0},{100,0}}, visible=true));
  connect(thermalConector_parallel.port_b,thermalConnector_contact.port_a) annotation(Line(points={{-17.8621,0},{17.8621,0}}, color={191,0,0}, visible=true, origin={0.1379,0}));
  connect(thermalConector_parallel.port_a,port_a) annotation(Line(points={{28.8621,-0},{-28.8621,0}}, color={191,0,0}, visible=true, origin={-71.1379,-0}));
  connect(port_a,bodyradiation1.port_a) annotation(Line(points={{-94.6228,13.7414},{-58.0468,13.7414},{-58.0468,43.7414},{-23.0041,43.7414},{-6.6228,43.7414}}, visible=true, origin={-5.3772,-13.7414}));
  connect(bodyradiation1.port_b,port_b) annotation(Line(points={{12,30},{60,30},{60,0},{100,0}}, visible=true));
