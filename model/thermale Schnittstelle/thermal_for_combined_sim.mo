...
model thermal_for_combined_sim "thermisches model eines Bausteins mit 6 Seiten mit Schnittstellen für die gemeinsame Simulation"
  ...
  parameter MaterialDatabase.Kupferlegierungen_Kupfer Kupfer annotation(Placement(transformation(origin = {130,90}, extent = {{-10,-10},{10,10}})));
  parameter MaterialDatabase.Titanlegierungen_Handelsueblich_Rein_CP_Ti_UNS_R50700__Klasse_4_SS Titan annotation(Placement(transformation(origin = {130,30}, extent = {{-10,-10},{10,10}})));
  parameter MaterialDatabase.Aluminiumlegierungen_1060_H12 Aluminium annotation(Placement(transformation(origin = {130,-30}, extent = {{-10,-10},{10,10}})));
  parameter MaterialDatabase.Kohlenstofffasern_Carbon_Panel_tbd Panel annotation(Placement(transformation(origin = {130,-60}, extent = {{-10,-10},{10,10}})));
  parameter MaterialDatabase.Elektronik_Box_Composit elektronik_Box_Composit1 annotation(Placement(transformation(origin = {130,60}, extent = {{-10,-10},{10,10}})));
  ...
  thermal_connector thermal_connector_zp annotation(Placement(transformation(origin = {10,-250}, extent = {{10,10},{-10,-10}}, rotation = -180), iconTransformation(origin = {-87.4828,-87.7579}, extent = {{12,12},{-12,-12}}, rotation = -180)));
  ...
  Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperature_EB annotation(Placement(transformation(origin = {-75,-80}, extent = {{-10,-10},{10,10}}, rotation = -180)));
  ...
  Modelica.Blocks.Math.RealToBoolean realtoboolean1 annotation(Placement(visible = true, transformation(origin = {-42.9474,-11.7895}, extent = {{-10,-10},{10,10}}, rotation = 0)));
  Modelica.Blocks.Math.RealToBoolean realtoboolean2 annotation(Placement(visible = true, transformation(origin = {-55.1442,81.5176}, extent = {{-10,-10},{10,10}}, rotation = 0)));
protected
...
equation
  connect(gain2.u,realtoboolean2.u) annotation(Line(points = {{-22,45},{-76.123,45},{-76.123,80.0191},{-67.4318,80.0191},{-67.4318,80.0191}}));
  ...
  connect(const.y,onOffController1.reference) annotation(Line(points = {{-64,-35},{-59,-35},{-59,-39},{-62,-39},{-62,-44},{-57,-44}}, color = {0,0,127}, thickness = 0.0625));
  connect(temperature_EB.T,onOffController1.u) annotation(Line(points = {{-85,-80},{-90,-80},{-90,-56},{-62,-56},{-57,-56}}, color = {0,0,127}, thickness = 0.0625));
  connect(temperature_EB.port,thermalModel_ElectronicBox1.dissipationPower) annotation(Line(points = {{-65,-80},{-60,-80},{158,-80},{158,-98},{163,-98}}, color = {191,0,0}, thickness = 0.0625));
  connect(gain1.y,integrator1.u) annotation(Line(points = {{1,-50},{6,-50},{6,-35},{-27,-35},{-27,-20},{-22,-20}}, color = {0,0,127}, thickness = 0.0625));
  connect(gain1.y,prescribedHeatFlow_heater.Q_flow) annotation(Line(points = {{1,-50},{6,-50},{5,-50},{10,-50}}, color = {0,0,127}, thickness = 0.0625));
  connect(prescribedHeatFlow_heater.port,thermalModel_ElectronicBox1.dissipationPower) annotation(Line(points = {{30,-50},{35,-50},{158,-50},{158,-98},{163,-98}}, color = {191,0,0}, thickness = 0.0625));
  connect(temperature_EB.T,onOffController2.reference) annotation(Line(points = {{-85,-80},{-90,-80},{-90,51},{-62,51},{-57,51}}, color = {0,0,127}, thickness = 0.0625));
  connect(const1.y,onOffController2.u) annotation(Line(points = {{-64,20},{-59,20},{-59,29},{-62,29},{-62,39},{-57,39}}, color = {0,0,127}, thickness = 0.0625));
  connect(gain2.y,prescribedHeatFlow_heater1.Q_flow) annotation(Line(points = {{1,45},{6,45},{15,45},{20,45}}, color = {0,0,127}, thickness = 0.0625));
  connect(prescribedHeatFlow_heater1.port,thermalModel_ElectronicBox1.dissipationPower) annotation(Line(points = {{40,45},{45,45},{158,45},{158,-98},{163,-98}}, color = {191,0,0}, thickness = 0.0625));
  connect(total_heater_power,integrator1.y) annotation(Line(points = {{30,-20},{25,-20},{6,-20},{1,-20}}, color = {0,0,127}, thickness = 0.0625));
  connect(gain2.y,integrator2.u) annotation(Line(points = {{1,45},{6,45},{6,62},{-27,62},{-27,80},{-22,80}}, color = {0,0,127}, thickness = 0.0625));
  connect(integrator2.y,total_cooler_power) annotation(Line(points = {{1,80},{6,80},{25,80},{30,80}}, color = {0,0,127}, thickness = 0.0625));
  annotation(Icon(coordinateSystem(extent = {{-100,-100},{100,100}}), graphics = {Rectangle(lineColor = {255,0,0}, fillColor = {255,255,255}, fillPattern = FillPattern.CrossDiag, extent = {{-10,-50},{10,50}}),Rectangle(lineColor = {255,0,0}, fillColor = {255,255,255}, fillPattern = FillPattern.CrossDiag, extent = {{-10.2751,-50},{9.7249,50}}),Rectangle(lineColor = {255,0,0}, fillColor = {255,255,255}, fillPattern = FillPattern.CrossDiag, extent = {{-50,-10},{50,10}}),Rectangle(lineColor = {255,0,0}, fillColor = {255,255,255}, fillPattern = FillPattern.CrossDiag, extent = {{-50,-10},{50,10}}),Rectangle(lineColor = {255,0,0}, fillColor = {255,255,255}, lineThickness = 2, extent = {{-80,-80},{80,80}}),Text(textString = "%name", textStyle = {TextStyle.Bold}, lineColor = {0,0,0}, fillColor = {255,0,0}, fillPattern = FillPattern.Solid, extent = {{-78.4853,-65.6671},{78.4853,-25.6671}}),Text(textString = "yp", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{-12.0277,70.2527},{14.7787,93.1585}}),Text(textString = "yn", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{-12.3028,-89.8573},{14.5036,-66.9515}}),Text(textString = "xp", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{67.4771,-10.6276},{94.2835,12.2782}}),Text(textString = "xn", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{-92.6329,-12.5533},{-65.8265,10.3525}}),Text(textString = "zp", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{-79.428,-79.9536},{-52.6216,-57.0478}}),Text(textString = "zn", lineColor = {0,0,0}, fillPattern = FillPattern.Solid, extent = {{55.2109,58.9977},{82.0173,81.9035}})}), Diagram(coordinateSystem(extent = {{-100,-100},{100,100}})), Documentation(info = "<HTML>
=======
// CP: 65001
