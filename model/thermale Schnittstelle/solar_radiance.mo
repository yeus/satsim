model solar_radiance "Einwirkende Sonnenstrahlung auf Fläche A mit Absorptionsfaktor alpha"
  annotation(Icon(coordinateSystem(extent={{-100.0,-100.0},{100.0,100.0}}, preserveAspectRatio=true, initialScale=0.1, grid={10,10}), graphics={Ellipse(visible=true, origin={0.1779,0.0}, fillColor={255,255,0}, fillPattern=FillPattern.Solid, extent={{-99.8221,-100.0},{99.8221,100.0}}),Text(visible=true, origin={-1.6091,112.8385}, fillPattern=FillPattern.Solid, extent={{-98.3909,-12.8385},{98.3909,12.8385}}, textString="%name", fontName="Arial", textStyle={TextStyle.Bold}),Text(visible=true, origin={0.0,25.4866}, fillPattern=FillPattern.Solid, extent={{-90.0,-14.5134},{90.0,14.5134}}, textString="Period=%orbit_Period", fontName="Arial"),Text(visible=true, origin={0.0,-118.904}, fillPattern=FillPattern.Solid, extent={{-100.0,-18.904},{100.0,18.904}}, textString="Solar_constant=%solar_constant", fontName="Arial"),Text(visible=true, origin={0.0,-24.5134}, fillPattern=FillPattern.Solid, extent={{-90.0,-14.5134},{90.0,14.5134}}, textString="percent_sun=%percent_sun", fontName="Arial")}), Diagram(coordinateSystem(extent={{-148.5,-105.0},{148.5,105.0}}, preserveAspectRatio=true, initialScale=0.1, grid={5,5})));
