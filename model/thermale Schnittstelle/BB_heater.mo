...
<<<<<<< HEAD
  ...
  Modelica.Blocks.Math.BooleanToReal booleantoreal1 annotation(Placement(visible = true, transformation(origin = {-23.9234,-18.8198}, extent = {{-10,-10},{10,10}}, rotation = 0)));
equation
  connect(booleantoreal1.y,gain1.u) annotation(Line(points = {{-12.9234,-18.8198},{5.74163,-18.8198},{5.74163,-55.5024},{-16.9059,-55.5024},{-16.9059,-55.5024}}));
  connect(onOffController1.y,booleantoreal1.u) annotation(Line(points = {{-29,-55},{-47.2089,-55},{-47.2089,-19.7767},{-36.3636,-19.7767},{-36.3636,-19.7767}}));
  connect(temperature_EB.T,onOffController1.u) annotation(Line(points = {{-80,-85},{-85,-85},{-85,-61},{-57,-61},{-52,-61}}, color = {0,0,127}, thickness = 0.0625));
  connect(gain1.y,heater_power.Q_flow) annotation(Line(points = {{6,-55},{11,-55},{10,-55},{15,-55}}, color = {0,0,127}, thickness = 0.0625));
  connect(lower_Temp.y,onOffController1.reference) annotation(Line(points = {{-59,-40},{-54,-40},{-54,-44},{-57,-44},{-57,-49},{-52,-49}}, color = {0,0,127}, thickness = 0.0625));
  connect(temperature_EB.port,Heater) annotation(Line(points = {{-60,-85},{-55,-85},{50,-85},{50,-80},{55,-80}}, color = {191,0,0}, thickness = 0.0625));
  connect(heater_power.port,Heater) annotation(Line(points = {{35,-55},{40,-55},{50,-55},{50,-80},{55,-80}}, color = {191,0,0}, thickness = 0.0625));
  annotation(Icon(coordinateSystem(extent = {{-100,-100},{100,100}}), graphics = {Ellipse(lineColor = {255,255,255}, fillColor = {255,0,0}, fillPattern = FillPattern.CrossDiag, extent = {{100,-100},{-100,100}}),Text(textString = "heater", textStyle = {TextStyle.Bold}, lineColor = {0,0,0}, fillColor = {255,0,0}, extent = {{-99,37},{100,-35}})}), Diagram(coordinateSystem(extent = {{-100,-100},{100,100}})), Documentation(info = "<HTML>
=======
