model space_radiator
  ...
  thermal_connector thermal_connector annotation(Placement(visible=true, transformation(origin={90.0,0.0}, extent={{-47.5,-47.5},{47.5,47.5}}, rotation=-180), iconTransformation(origin={0.0,0.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
...
equation 
  ...
  connect(bodyRadiation_Rad.port_b,thermal_connector.Rad) annotation(Line(visible=true, origin={28.397,-47.706}, points={{-18.397,-12.294},{-13.397,-12.294},{-13.397,12.294},{45.191,12.294}}, color={191,0,0}));
  connect(bodyRadiation_TSS.port_b,thermal_connector.TSS) annotation(Line(visible=true, origin={40.5952,-15.9439}, points={{-30.5952,-4.0561},{-1.0952,-4.0561},{-1.0952,4.0561},{32.7856,4.0561}}, color={191,0,0}));
  connect(bodyRadiation_MSS.port_b,thermal_connector.MSS) annotation(Line(visible=true, origin={40.5591,16.0196}, points={{-30.5591,3.9804},{-1.0591,3.9804},{-1.0591,-3.9804},{32.6773,-3.9804}}, color={191,0,0}));
  connect(bodyRadiation_ESS.port_b,thermal_connector.ESS) annotation(Line(visible=true, origin={26.9872,46.9825}, points={{-16.9872,11.1837},{-14.5747,11.1837},{-14.5747,-11.1837},{46.1366,-11.1837}}, color={191,0,0}));
end space_radiator;
