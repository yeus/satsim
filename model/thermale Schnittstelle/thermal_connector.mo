...
connector thermal_connector "Verbindungselement fuer mehr als eine Schnittstelle"
	...
	Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a TSS annotation(Placement(
		transformation(
	...
	Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a MSS annotation(Placement(
		transformation(
	...
	Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a ESS annotation(Placement(
		transformation(
	...
	Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a Rad annotation(Placement(
		transformation(
