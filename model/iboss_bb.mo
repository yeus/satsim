model buildingblock
  ...
  iboss_interface iboss_interface1 annotation(Placement(visible = true, transformation(origin = {-80.9052,0}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  iboss_interface iboss_interface2 annotation(Placement(visible = true, transformation(origin = {-43.2815,61.1033}, extent = {{-12,-12},{12,12}}, rotation = 0)));
  ...
  iboss_interface iboss_interface3 annotation(Placement(visible = true, transformation(origin = {-0.848656,81.471}, extent = {{-12,12},{12,-12}}, rotation = -90)));
  iboss_interface iboss_interface5 annotation(Placement(visible = true, transformation(origin = {44.9788,-61.9519}, extent = {{12,12},{-12,-12}}, rotation = -180)));
  iboss_interface iboss_interface6 annotation(Placement(visible = true, transformation(origin = {-0.848656,-77.5106}, extent = {{12,-12},{-12,12}}, rotation = 90)));
  iboss_interface iboss_interface4 annotation(Placement(visible = true, transformation(origin = {80.3395,-0.282885}, extent = {{12,12},{-12,-12}}, rotation = -180)));
  OBC obc1 annotation(Placement(visible = true, transformation(origin = {-30.5516,13.0127}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
  connect(iboss_interface2.pin_n,pcu1.GND) annotation(Line(points = {{-31.1967,54.8232},{-28.2885,54.8232},{-28.2885,45.2617},{-55.1627,45.2617},{-55.1627,-40.1697},{-48.3281,-40.1697},{-48.3281,-40.1245}}));
  connect(iboss_interface3.pin_p,iboss_interface2.pin_p) annotation(Line(points = {{-11.0325,69.4201},{-11.0325,69.4201},{-11.0325,64.4979},{-26.3083,64.4979},{-26.3083,46.959},{-31.4003,46.959},{-31.4003,50.9194},{-31.2306,50.9194}}));
  connect(iboss_interface2.pin_n,iboss_interface3.pin_n) annotation(Line(points = {{-31.1967,54.8232},{-28.2885,54.8232},{-28.2885,66.4781},{-7.35502,66.4781},{-7.35502,69.3862},{-7.12871,69.3862}}));
  ...
  connect(iboss_interface6.pin_p,pcu1.VCC) annotation(Line(points = {{9.33522,-65.4597},{9.05233,-65.4597},{9.05233,-60.5375},{-52.6167,-60.5375},{-52.6167,-34.2291},{-48.2942,-34.2291},{-48.2942,-33.8444}}));
  connect(iboss_interface6.pin_p,iboss_interface5.pin_p) annotation(Line(points = {{9.33522,-65.4597},{9.05233,-65.4597},{9.05233,-60.5375},{29.9859,-60.5375},{29.9859,-51.768},{32.9279,-51.768},{32.9279,-51.768}}));
  connect(iboss_interface6.pin_n,pcu1.GND) annotation(Line(points = {{5.4314,-65.4258},{5.09194,-65.4258},{5.09194,-62.2348},{-55.1627,-62.2348},{-55.1627,-40.1697},{-48.3281,-40.1697},{-48.3281,-40.1245}}));
  connect(iboss_interface5.pin_n,iboss_interface6.pin_n) annotation(Line(points = {{32.894,-55.6718},{28.2885,-55.6718},{28.2885,-62.2348},{5.09194,-62.2348},{5.09194,-65.4258},{5.4314,-65.4258}}));
  connect(iboss_interface4.pin_n,iboss_interface5.pin_n) annotation(Line(points = {{68.2547,5.99717},{28.2885,5.99717},{28.2885,-55.7284},{32.894,-55.7284},{32.894,-55.6718}}));
  connect(iboss_interface4.pin_p,iboss_interface5.pin_p) annotation(Line(points = {{68.2886,9.90099},{29.9859,9.90099},{29.9859,-52.0509},{32.9279,-52.0509},{32.9279,-51.768}}));
  connect(iboss_interface2.pin_p,pcu1.VCC) annotation(Line(points = {{-31.2306,50.9194},{-31.4003,50.9194},{-31.4003,46.959},{-52.6167,46.959},{-52.6167,-34.2291},{-48.2942,-34.2291},{-48.2942,-33.8444}}));
  connect(iboss_interface1.pin_n,pcu1.GND) annotation(Line(points = {{-68.8204,-6.28006},{-55.1627,-6.28006},{-55.1627,-40.1697},{-48.3281,-40.1697},{-48.3281,-40.1245}}));
  connect(iboss_interface1.pin_p,pcu1.VCC) annotation(Line(points = {{-68.8543,-10.1839},{-52.6167,-10.1839},{-52.6167,-34.2291},{-48.2942,-34.2291},{-48.2942,-33.8444}}));
  connect(Yn,iboss_interface6.iBoss_connector);
  connect(Xn,iboss_interface1.iBoss_connector);
  connect(Zp,iboss_interface2.iBoss_connector);
  connect(Yp,iboss_interface3.iBoss_connector);
  connect(Xp,iboss_interface4.iBoss_connector);
end buildingblock;
