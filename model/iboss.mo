package iboss
  ...
  package satellites
    ...
    equation
      ...
      //*/
      annotation(experiment(StartTime = 0.0, StopTime = 20000.0, Tolerance = 1e-06));
    end generic_sat;
    model EVS2x2x1
    ...
    model EVS4x1x1
      ...
      Modelica.Blocks.Sources.Trapezoid trapezoid1(amplitude = 1367, rising = 60, width = 1000, falling = 60, period = 3000) annotation(Placement(transformation(origin = {-82.6673,-70.14830000000001}, extent = {{-12,-12},{12,12}})));
    equation
    ...
    model EVS2x2x3
      ...
      buildingblocks.verbraucher bb4 annotation(Placement(transformation(origin = {-65.31359999999999,53.1044}, extent = {{-5.08917,-5.08917},{5.08917,5.08917}})));
      ...
      components.connectionelement conn15 annotation(Placement(transformation(origin = {9.552670000000001,39.9801}, extent = {{-5.08917,5.08917},{5.08917,-5.08917}}, rotation = -90)));
      ...
      buildingblocks.battery battery1(SOC_start = 0.9399999999999999) annotation(Placement(transformation(origin = {-70,25}, extent = {{-5.49199,-5.49199},{5.49199,5.49199}})));
    ...
    equation
      connect(bs2.Xp,bs3.Xn) annotation(Line(points = {{8,0},{31.9444,0},{31.9444,0},{31.9444,0}}));
      connect(bs1.Xp,bs2.Xn) annotation(Line(points = {{-32,0},{-8.61111,0},{-8.61111,0.277778},{-8.61111,0.277778}}));
      connect(r.frame_b,bs2.Yp) annotation(Line(points = {{-15.2708,59.6844},{-0.277778,59.6844},{-0.277778,8.61111},{-0.277778,8.61111}}));
      connect(world.frame_b,r.frame_a) annotation(Line(points = {{-50,60},{-35.2941,60},{-35.2708,60.5452},{-35.2708,59.6844}}));
      annotation(Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), Diagram(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), experiment(StartTime = 0, StopTime = 100, Tolerance = 1e-05));
