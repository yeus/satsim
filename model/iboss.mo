// CP: 65001
// SimulationX Version: 3.5.706.23
package iboss
	package components
		model iboss_interface
			...
			Modelica.Electrical.Analog.Sensors.VoltageSensor voltageSensor1 annotation(Placement(transformation(
				...
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			Modelica.Electrical.Analog.Basic.Resistor resistor1(R(displayUnit="mOhm")=0.001) annotation(Placement(transformation(extent={{-50,-5},{-30,15}})));
			Modelica.Electrical.Analog.Basic.Resistor resistor2(R(displayUnit="mOhm")=0.001) annotation(Placement(transformation(extent={{-30,-50},{-50,-30}})));
			Modelica.Electrical.Analog.Basic.Resistor resistor3(R(displayUnit="mOhm")=0.001) annotation(Placement(transformation(extent={{10,-50},{-10,-30}})));
			Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C(displayUnit="nF")=1.0000000000000002e-006) annotation(Placement(transformation(
				origin={-20,-15},
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			...
			equation
				...
				connect(resistor2.p,resistor3.n) annotation(Line(
					points={{-30,-40},{-25,-40},{-15,-40},{-10,-40}},
					thickness=0.0625));
				connect(resistor3.p,voltageSensor1.n) annotation(
					Line(
						points={{10,-40},{45,-40},{45,-50},{85,-50},{85,-45}},
						thickness=0.0625),
					AutoRoute=false);
				connect(resistor2.n,voltageSensor2.n) annotation(Line(
					points={{-50,-40},{-55,-40},{-65,-40},{-65,-35}},
					thickness=0.0625));
				connect(resistor1.p,voltageSensor2.p) annotation(Line(
					points={{-50,5},{-55,5},{-65,5},{-65,-10},{-65,-15}},
					thickness=0.0625));
				connect(capacitor1.n,resistor3.n) annotation(Line(
					points={{-20,-25},{-20,-30},{-20,-40},{-15,-40},{-10,-40}},
					thickness=0.0625));
				connect(resistor1.n,variableResistor1.p) annotation(Line(
					points={{-30,5},{-25,5},{-15,5},{-10,5}},
					thickness=0.0625));
