	...
	package buildingblocks
		...
		model verbraucher
			...
			Modelica.Electrical.Analog.Basic.Capacitor capacitor2(C(displayUnit="µF")=9.9999999999999995e-007) annotation(Placement(transformation(
				...
				rotation=270)));
			equation
				connect(resistor3.n,pcu1.gnd) annotation(Line(points={{32.8324,-20.5202},{32.659,-20.5202},{32.659,-33.237},{-17.6301,-33.237},{-17.6301,-8.381500000000001},{-17.6301,
				-8.381500000000001}}));
				...
				connect(pcu1.GND,pcu1.gnd) annotation(Line(points={{-37.8447,-5.88639},{-38.1503,-5.88639},{-38.1503,-23.6994},{-17.6301,-23.6994},{-17.6301,-8.381500000000001},{-17.6301,
				-8.381500000000001}}));
				...
				connect(int_Xn.vcc,pcu1.VCC) annotation(Line(points={{-68.75239999999999,-2.17255},{-47.9769,-2.17255},{-47.9769,-0.578035},{-38.1503,-0.578035},{-38.1503,-0.578035}}));
				connect(int_Xn.gnd,pcu1.GND) annotation(Line(points={{-68.71850000000001,-6.11033},{-38.4393,-6.11033},{-38.4393,-6.06936},{-38.4393,-6.06936}}));
				connect(capacitor2.p,int_Xn.vcc) annotation(Line(
					points={{-45,10},{-45,15},{-55,15},{-55,0},{-65,-2},{-69,
					-2}},
					thickness=0.0625));
				connect(capacitor2.n,int_Xn.gnd) annotation(Line(
					points={{-45,-10},{-45,-15},{-55,-15},{-55,-5},{-65,-6},{-69,
					-6}},
					thickness=0.0625));
			annotation(experiment(
				StopTime=11000,
