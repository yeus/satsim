...
package iboss
	...
	package buildingblocks
		...
		model battery
			extends iboss.buildingblocks.basic_ess_mss;
			satcomponents.power.batteries.battery battery1(Vnominal=100) annotation(Placement(
				visible=true,
				transformation(
			...
			Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10,-10},{10,10}},
					rotation=0)));
			satcomponents.power.batteries.BDR bdr1(Vmin=70) annotation(Placement(
				visible=true,
				transformation(
					origin={-33.0827,8.7218},
					extent={{-10,-10},{10,10}},
					rotation=0)));
			equation
	...
	package satellites
		...
		model EVS2x2x1
			iboss.components.connectionelement connectionelement1 annotation(Placement(
				...
				transformation(
					...
					extent={{-12,-12},{12,12}},
					rotation=0)));
			iboss.buildingblocks.verbraucher v1 annotation(Placement(
				visible=true,
				transformation(
			...
			iboss.components.connectionelement connectionelement3 annotation(Placement(
				...
				transformation(
					...
					extent={{-12,-12},{12,12}},
					rotation=0)));
			iboss.buildingblocks.verbraucher v2 annotation(Placement(
				visible=true,
				transformation(
					origin={-24.0453,41.867},
					extent={{-12,-12},{12,12}},
					rotation=0)));
			iboss.buildingblocks.solar s1 annotation(Placement(
				visible=true,
				transformation(
			...
			iboss.components.connectionelement connectionelement2 annotation(Placement(
				...
				transformation(
					...
					extent={{-12,12},{12,-12}},
					rotation=-90)));
			iboss.buildingblocks.battery b1 annotation(Placement(
				visible=true,
				transformation(
			...
			Modelica.Blocks.Sources.Trapezoid trapezoid1(
				...
				transformation(
					...
					extent={{-12,-12},{12,12}},
					rotation=0)));
			iboss.components.connectionelement connectionelement4 annotation(Placement(
				visible=true,
				transformation(
		...
		model EVS2x2x3
			iboss.buildingblocks.verbraucher bb9 annotation(Placement(
				visible=true,
				transformation(
					origin={10.4503,24.8534},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb8 annotation(Placement(
				visible=true,
				transformation(
					origin={35.0094,25.4955},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb6 annotation(Placement(
				visible=true,
				transformation(
					origin={9.9688,52.1413},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn19 annotation(Placement(
				visible=true,
				transformation(
					origin={22.8756,25.3731},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn18 annotation(Placement(
				visible=true,
				transformation(
					origin={22.8756,51.6978},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb2 annotation(Placement(
				visible=true,
				transformation(
					origin={-40.594,28.5453},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb4 annotation(Placement(
				visible=true,
				transformation(
					origin={-65.3136,53.1044},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb5 annotation(Placement(
				visible=true,
				transformation(
					origin={-41.0755,52.1413},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn16 annotation(Placement(
				visible=true,
				transformation(
					origin={-52.8884,52.1794},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn17 annotation(Placement(
				visible=true,
				transformation(
					origin={-53.0489,28.1019},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn9 annotation(Placement(
				visible=true,
				transformation(
					origin={-16.451,61.4894},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn8 annotation(Placement(
				visible=true,
				transformation(
					origin={-16.13,48.648},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn7 annotation(Placement(
				visible=true,
				transformation(
					origin={-16.13,35.3251},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn6 annotation(Placement(
				visible=true,
				transformation(
					origin={-15.9695,22.1627},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb11 annotation(Placement(
				visible=true,
				transformation(
					origin={10.7714,-10.7813},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb12 annotation(Placement(
				visible=true,
				transformation(
					origin={10.4503,-34.3773},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn20 annotation(Placement(
				visible=true,
				transformation(
					origin={23.3571,-10.9037},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn1 annotation(Placement(
				visible=true,
				transformation(
					origin={23.6782,-34.6602},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb7 annotation(Placement(
				visible=true,
				transformation(
					origin={35.3304,52.1413},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb10 annotation(Placement(
				visible=true,
				transformation(
					origin={35.491,-10.2998},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.buildingblocks.verbraucher bb1 annotation(Placement(
				visible=true,
				transformation(
					origin={35.9725,-34.5378},
					extent={{-5.08917,-5.08917},{5.08917,5.08917}},
					rotation=0)));
			iboss.components.connectionelement conn12 annotation(Placement(
				visible=true,
				transformation(
					origin={10.5158,-22.6214},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn13 annotation(Placement(
				visible=true,
				transformation(
					origin={35.5564,-22.6214},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn15 annotation(Placement(
				visible=true,
				transformation(
					origin={9.55267,39.9801},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn11 annotation(Placement(
				visible=true,
				transformation(
					origin={-41.0101,40.7827},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn10 annotation(Placement(
				visible=true,
				transformation(
					origin={-65.5692,40.6222},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn4 annotation(Placement(
				visible=true,
				transformation(
					origin={19.8257,6.75313},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn3 annotation(Placement(
				visible=true,
				transformation(
					origin={32.8276,6.75313},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn14 annotation(Placement(
				visible=true,
				transformation(
					origin={35.3959,39.1775},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn5 annotation(Placement(
				visible=true,
				transformation(
					origin={6.66337,6.59262},
					extent={{-5.08917,5.08917},{5.08917,-5.08917}},
					rotation=-90)));
			iboss.components.connectionelement conn2 annotation(Placement(
				visible=true,
				transformation(
			...
			iboss.components.connectionelement connectionelement1 annotation(Placement(
				...
				transformation(
					...
					rotation=0)));
			iboss.buildingblocks.battery battery1 annotation(Placement(
				visible=true,
				transformation(
					origin={-66.0066,27.6315},
