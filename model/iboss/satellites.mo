			...
			annotation(
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2,2}),
					graphics={Rectangle(origin = {0.22,0}, fillColor = {255,220,168}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-100,100},{100,-100}})}),
				Diagram(
					coordinateSystem(
						extent={{-100,-100},{100,100}},
						preserveAspectRatio=true,
						initialScale=0.1,
						grid={2,2}),
					graphics={Text(fillPattern = FillPattern.Solid, extent = {{-102.764,-102.343},{97.23560000000001,-162.343}}, textString = "%name"),Rectangle(origin = {-1.11,1.88}, fillColor = {255,220,168}, fillPattern = FillPattern.Solid, extent = {{-91.81,87.72},{91.81,-87.72}})}));
		end iboss_int;
		...
		model passivestructure3x2x1
			...
			Modelica.Mechanics.MultiBody.Joints.FreeMotion r(
				...
				transformation(
					...
					extent={{-10,-10},{10,10}},
					rotation=0)));
			iboss.buildingblocks.basic_structure bs2 annotation(Placement(
				visible=true,
				transformation(
					origin={0,0},
					extent={{-10,-10},{10,10}},
					rotation=0)));
			iboss.buildingblocks.basic_structure bs1 annotation(Placement(
				visible=true,
				transformation(
					origin={-40,0},
					extent={{-10,-10},{10,10}},
					rotation=0)));
			iboss.buildingblocks.basic_structure bs3 annotation(Placement(
				visible=true,
				transformation(
					origin={40,0},
					extent={{-10,-10},{10,10}},
