...
equation
  ...
  connect(alphaRad.y, panel_surface1.alpha_Rad) annotation(Line(points = {{-94, -81}, {-89, -81}, {25, -81}, {25, -30}, {30, -30}}, color = {0, 0, 127}, thickness = 0.0625));
  ...
  connect(epsilonRad.y, panel_surface1.epsilon_Rad) annotation(Line(points = {{-94, -116}, {-89, -116}, {25, -116}, {25, -30}, {30, -30}}, color = {0, 0, 127}, thickness = 0.0625));
