...
protected
  ExternalObject tableID = Modelica.Blocks.Types.ExternalCombiTable1D(if tableOnFile then tableName else "NoName", if tableOnFile and fileName <> "NoName" and not Modelica.Utilities.Strings.isEmpty(fileName) then fileName else "NoName", table, columns, smoothness) "External table object";
  ...
  function readTableData "Read table data from ASCII text or MATLAB MAT-file"
    ...
    external "C" readSuccess = ModelicaStandardTables_CombiTable1D_read(tableID, forceRead, verboseRead) annotation(Library = "ModelicaStandardTables");
  end readTableData;
  ...
  function getTableValue "Interpolate 1-dim. table defined by matrix"
    ...
    external "C" y = ModelicaStandardTables_CombiTable1D_getValue(tableID, icol, u) annotation(Library = "ModelicaStandardTables");
  ...
  function getDerTableValue "Derivative of interpolated 1-dim. table defined by matrix"
    ...
    external "C" der_y = ModelicaStandardTables_CombiTable1D_getDerValue(tableID, icol, u, der_u) annotation(Library = "ModelicaStandardTables");
...
equation
  ...
  annotation(Icon(graphics = {Line(points = {{-60, 40}, {-60, -40}, {60, -40}, {60, 40}, {30, 40}, {30, -40}, {-30, -40}, {-30, 40}, {-60, 40}, {-60, 20}, {60, 20}, {60, 0}, {-60, 0}, {-60, -20}, {60, -20}, {60, -40}, {-60, -40}, {-60, 40}, {60, 40}, {60, -40}}), Line(points = {{0, 40}, {0, -40}}), Rectangle(fillColor = {255, 215, 136}, fillPattern = FillPattern.Solid, extent = {{-60, 20}, {-30, 40}}), Rectangle(fillColor = {255, 215, 136}, fillPattern = FillPattern.Solid, extent = {{-60, 0}, {-30, 20}}), Rectangle(fillColor = {255, 215, 136}, fillPattern = FillPattern.Solid, extent = {{-60, -20}, {-30, 0}}), Rectangle(fillColor = {255, 215, 136}, fillPattern = FillPattern.Solid, extent = {{-60, -40}, {-30, -20}})}), Diagram(graphics = {Rectangle(fillColor = {235, 235, 235}, fillPattern = FillPattern.Solid, extent = {{-60, 60}, {60, -60}}), Line(points = {{-100, 0}, {-58, 0}}), Line(points = {{60, 0}, {100, 0}}), Text(textString = "1 dimensional linear table interpolation", extent = {{-100, 100}, {100, 64}}), Line(points = {{-54, 40}, {-54, -40}, {54, -40}, {54, 40}, {28, 40}, {28, -40}, {-28, -40}, {-28, 40}, {-54, 40}, {-54, 20}, {54, 20}, {54, 0}, {-54, 0}, {-54, -20}, {54, -20}, {54, -40}, {-54, -40}, {-54, 40}, {54, 40}, {54, -40}}, color = {0, 0, 0}), Line(points = {{0, 40}, {0, -40}}, color = {0, 0, 0}), Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-54, 40}, {-28, 20}}), Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-54, 20}, {-28, 0}}), Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-54, 0}, {-28, -20}}), Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, extent = {{-54, -20}, {-28, -40}}), Text(textString = "u", extent = {{-52, 56}, {-34, 44}}), Text(textString = "y[1]", extent = {{-22, 54}, {2, 42}}), Text(textString = "y[2]", extent = {{4, 54}, {28, 42}}), Text(textString = "columns", extent = {{0, -40}, {32, -54}})}), Documentation(info = "<html>
		 <p>
