...
model environment_var_rad
  ...
  components.var_Gain factor_Rad annotation(Placement(transformation(extent = {{-35, -50}, {-15, -30}})));
  ...
  components.VariableRad bodyRadiation_Rad annotation(Placement(transformation(origin = {130, -40}, extent = {{-10, -10}, {10, 10}})));
  ...
  Modelica.Blocks.Math.Gain factor_effective_Area_Rad(k = effective_area_Rad / effective_area_total) annotation(Placement(transformation(origin = {60, -95}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
equation
  ...
  connect(temperatureSensor_Radiator.T, combiTable1Ds1.u) annotation(Line(points = {{120, -70}, {125, -70}, {128, -70}, {133, -70}}, color = {0, 0, 127}, thickness = 0.0625));
  connect(temperatureSensor_Radiator.port, bodyRadiation_Rad.port_a) annotation(Line(points = {{100, -70}, {95, -70}, {95, -40}, {115, -40}, {120, -40}}, color = {191, 0, 0}, thickness = 0.0625));
  connect(combiTable1Ds1.y[1], factor_Area_Rad.u) annotation(Line(points = {{156, -70}, {161, -70}, {173, -70}, {178, -70}}, color = {0, 0, 127}, thickness = 0.0625));
  connect(factor_Rad.k_gain, factor_effective_Area_Rad.y) annotation(Line(points = {{-25, -31}, {-25, -26}, {9.300000000000001, -26}, {9.300000000000001, -95}, {44, -95}, {49, -95}}, color = {0, 0, 127}, thickness = 0.0625));
  connect(factor_effective_Area_Rad.u, combiTable1Ds1.y[2]) annotation(Line(points = {{72, -95}, {77, -95}, {161, -95}, {161, -70}, {156, -70}}, color = {0, 0, 127}, thickness = 0.0625));
  ...
  connect(factor_Area_Rad.y, bodyRadiation_Rad.Gr) annotation(Line(points = {{201, -70}, {206, -70}, {206, -26}, {130, -26}, {130, -31}}, color = {0, 0, 127}, thickness = 0.0625));
  annotation(combiTable1Ds1(y(flags = 2)), Icon(graphics = {Rectangle(lineColor = {0, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Ellipse(lineColor = {0, 0, 0}, fillColor = {255, 255, 0}, fillPattern = FillPattern.Solid, extent = {{98, -96}, {-96, 98}})}), experiment(StopTime = 10, StartTime = 0));
