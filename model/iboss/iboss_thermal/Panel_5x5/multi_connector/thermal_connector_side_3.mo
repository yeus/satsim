...
connector thermal_connector_side_3 "Verbindungselement fuer mehr als eine Schnittstelle"
  ...
  annotation(Icon(graphics = {Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-100, 100}, {100, -100}}), Text(textString = "3", lineColor = {0, 0, 0}, extent = {{-99, 96.7}, {97.7, -100}})}));
