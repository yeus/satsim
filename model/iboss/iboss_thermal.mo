...
<pre>
    ...
    where
       ...
       e2: Emission value of outer cylinder (0..1)
		...
		expandable connector thermal_connector_opt_prop_out "Verbindungselement fuer mehr als eine Schnittstelle"
			import Modelica.Thermal.HeatTransfer.Interfaces;
		...
		model Panel_opt_prop "Panel_opt_prop.mo"
			...
			thermal_connector_opt_prop_out thermal_connector_out_zp_multi annotation(Placement(transformation(extent={{-115,-110},{-95,-90}})));
			thermal_connector_opt_prop_out thermal_connector_out_zn_multi annotation(Placement(transformation(extent={{155,70},{175,90}})));
...
especially if it shall be allowed that a ThermalResistance is defined to be zero (i.e. no temperature difference).
		...
		expandable connector thermal_connector_opt_prop_in "thermal_connector_opt_prop_in.mo"
			import Modelica.Thermal.HeatTransfer.Interfaces;
