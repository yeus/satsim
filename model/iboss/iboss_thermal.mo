	...
	package components "components"
		...
		model thermal_Panel_with_Interface_with_optical_properties_var_rad "Seitenpanel mit Schnittstelle mit alpha - epsilon"
			...
			Modelica.Blocks.Tables.CombiTable1Ds combiTable1Ds1(
				...
				fileName="/home/jens/iBOSS2/Simulation_Linux/ibosssim/model/iboss/thermochrom_alpha_epsilon.txt") annotation(Placement(transformation(extent={{50,59},{70,79}})));
			equation
				connect(BuildingBlock_Panel.port_b_xp,schnittstelle1.port_a) annotation(Line(
					points={{-10,0},{-5,0},{12.3,0},{17.3,0}},
					color={191,0,0},
...
"),
		...
		model environment_optical_properties
			parameter Real illumination[:,2]=[0,0;1,1];
			discrete Real Gr_Rad(unit="m2")=panel_surface1.epsilon_Rad * panel_surface1.A_Rad "Net radiation conductance between two surfaces (see docu)";
			discrete Real Gr_MSS(unit="m2")=panel_surface1.epsilon_MSS * panel_surface1.A_MSS "Net radiation conductance between two surfaces (see docu)";
			discrete Real Gr_ESS(unit="m2")=panel_surface1.epsilon_ESS * panel_surface1.A_ESS "Net radiation conductance between two surfaces (see docu)";
			discrete Real Gr_TSS(unit="m2")=panel_surface1.epsilon_TSS * panel_surface1.A_TSS "Net radiation conductance between two surfaces (see docu)";
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_TSS annotation(Placement(transformation(extent={{10,40},{30,60}})));
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_MSS annotation(Placement(transformation(extent={{10,10},{30,30}})));
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_ESS annotation(Placement(transformation(extent={{10,-20},{30,0}})));
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_Rad(alpha=0) annotation(Placement(transformation(extent={{10,-50},{30,-30}})));
			...
			variable_Gain factor_ESS(k=panel_surface1.A_ESS * panel_surface1.alpha_ESS / (panel_surface1.A_TSS+panel_surface1.A_MSS+panel_surface1.A_ESS+panel_surface1.A_Rad)) annotation(Placement(transformation(extent={{-35,-20},{-15,0}})));
			VariableRad_no_Input bodyRadiation_Rad(Gr=Gr_Rad) annotation(Placement(transformation(
				origin={130,-40},
				extent={{-10,-10},{10,10}})));
			VariableRad_no_Input bodyRadiation_TSS(Gr=Gr_TSS) annotation(Placement(transformation(
				origin={130,50},
				extent={{-10,-10},{10,10}})));
			VariableRad_no_Input bodyRadiation_MSS(Gr=Gr_MSS) annotation(Placement(transformation(
				origin={130,20},
				extent={{-10,-10},{10,10}})));
			VariableRad_no_Input bodyRadiation_ESS(Gr=Gr_ESS) annotation(Placement(transformation(
				origin={130,-10},
				extent={{-10,-10},{10,10}})));
