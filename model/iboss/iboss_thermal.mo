...
package iboss_thermal "iboss_thermal"
	...
	package components "components"
		...
		model thermal_Panel_with_Interface_with_optical_properties "Seitenpanel mit Schnittstelle mit alpha - epsilon"
			...
			Modelica.Blocks.Sources.Constant A_Rad(k=y_Panel*z_Panel-(y_TSS*z_TSS+y_MSS*z_MSS+y_ESS*z_ESS)) annotation(Placement(transformation(extent={{105,39},{125,59}})));
...
"),
		...
		model thermal_TIM_optical_properties "thermal interfacial material parameters (Conductance)"
			...
			panel_surface panel_surface2 annotation(Placement(transformation(
				...
				extent={{-10,-10},{10,10}},
				rotation=90)));
			variable_ThermalConductor Conductance_TIM_TSS(G=h_TSS*panel_surface1.A_TSS) "Lumped thermal element transporting heat without storing it" annotation(Placement(transformation(
				origin={-0,10},
				extent={{-6.1349,-6.1349},{6.1349,6.1349}})));
			variable_ThermalConductor Conductance_MSS(G=h_MSS*panel_surface1.A_MSS) "Lumped thermal element transporting heat without storing it" annotation(Placement(transformation(
				origin={-0,-10},
				extent={{-6.0931,-6.0931},{6.0931,6.0931}})));
			variable_ThermalConductor Conductance_ESS(G=h_ESS*panel_surface1.A_ESS) "Lumped thermal element transporting heat without storing it" annotation(Placement(transformation(
				origin={0,-30},
				extent={{-6.1934,-6.1934},{6.1934,6.1934}})));
			parameter Real h_TSS(unit="W/(m³·K)")=300 "Heat transfer coefficient TSS - TSS";
			parameter Real h_MSS(unit="W/(m³·K)")=190 "Heat transfer coefficient MSS - MSS";
			parameter Real h_ESS(unit="W/(m³·K)")=240 "Heat transfer coefficient ESS - ESS";
			parameter Real ViewFactor_Rad=0.2 "Viewfactor of Radiator";
			VariableRad Radiator "Lumped thermal element for radiation heat transfer" annotation(Placement(transformation(
				origin={0,30},
				extent={{-6.25,-6.25},{6.25,6.25}})));
			Modelica.Blocks.Sources.Constant get_a_real(k=1) annotation(Placement(transformation(
				origin={90,49},
				extent={{-10,-10},{10,10}},
				rotation=-180)));
			variable_Gain variable_Gain_Rad(k=panel_surface1.A_Rad*ViewFactor_Rad/((1/panel_surface1.epsilon_Rad)+(1/panel_surface2.epsilon_Rad))) annotation(Placement(transformation(
				origin={5,54},
				extent={{-10,-10},{10,10}},
				rotation=-180)));
			equation
				...
				connect(variable_Gain_Rad.y,Radiator.u) annotation(Line(
					points={{-6,54},{-11,54},{-11,47.3},{0,47.3},{0,40.7},{0,
					35.7}},
					color={0,0,127},
					thickness=0.0625));
				
				connect(variable_Gain_Rad.u,get_a_real.y) annotation(Line(
					points={{17,54},{22,54},{74,54},{74,49},{79,49}},
					color={0,0,127},
					thickness=0.0625));
			annotation(
				Icon(
		...
		model environment_optical_properties
			...
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_ESS annotation(Placement(transformation(extent={{10,-20},{30,0}})));
			Modelica.Thermal.HeatTransfer.Sources.PrescribedHeatFlow HeatFlow_Rad(alpha=0) annotation(Placement(transformation(extent={{10,-50},{30,-30}})));
			Modelica.Blocks.Math.Gain factor_Rad(k=panel_surface1.A_Rad * panel_surface1.alpha_Rad / (panel_surface1.A_TSS+panel_surface1.A_MSS+panel_surface1.A_ESS+panel_surface1.A_Rad)) annotation(Placement(transformation(extent={{-35,-50},{-15,-30}})));
			Modelica.Blocks.Sources.TimeTable timeTable1(
				table=illumination,
				offset=0) annotation(Placement(transformation(extent={{-95,-5},{-75,15}})));
			Modelica.Blocks.Math.Gain factor_TSS(k=panel_surface1.A_TSS * panel_surface1.alpha_TSS / (panel_surface1.A_TSS+panel_surface1.A_MSS+panel_surface1.A_ESS+panel_surface1.A_Rad)) annotation(Placement(transformation(extent={{-35,40},{-15,60}})));
			Modelica.Blocks.Math.Gain factor_MSS(k=panel_surface1.A_MSS * panel_surface1.alpha_MSS / (panel_surface1.A_TSS+panel_surface1.A_MSS+panel_surface1.A_ESS+panel_surface1.A_Rad)) annotation(Placement(transformation(extent={{-35,10},{-15,30}})));
			Modelica.Blocks.Math.Gain factor_ESS(k=panel_surface1.A_ESS * panel_surface1.alpha_ESS / (panel_surface1.A_TSS+panel_surface1.A_MSS+panel_surface1.A_ESS+panel_surface1.A_Rad)) annotation(Placement(transformation(extent={{-35,-20},{-15,0}})));
			Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyRadiation_Rad(Gr=panel_surface1.epsilon_Rad * panel_surface1.A_Rad) annotation(Placement(transformation(
				origin={130,-40},
				extent={{-10,-10},{10,10}})));
			Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyRadiation_TSS(Gr=panel_surface1.epsilon_TSS * panel_surface1.A_TSS) annotation(Placement(transformation(
				origin={130,50},
				extent={{-10,-10},{10,10}})));
			Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyRadiation_MSS(Gr=panel_surface1.epsilon_MSS * panel_surface1.A_MSS) annotation(Placement(transformation(
				origin={130,20},
				extent={{-10,-10},{10,10}})));
			Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyRadiation_ESS(Gr=panel_surface1.epsilon_ESS * panel_surface1.A_ESS) annotation(Placement(transformation(
				origin={130,-10},
				extent={{-10,-10},{10,10}})));
			thermal_connector thermal_connector_env "Verbindungselement fuer mehr als eine Schnittstelle" annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-20,20},{20,-20}},
					rotation=270)));
			panel_surface panel_surface1 annotation(Placement(transformation(extent={{75,65},{95,85}})));
			Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedTemperature1(T(displayUnit="K")=3) annotation(Placement(transformation(
				origin={175,5},
				extent={{10,10},{-10,-10}},
				rotation=180)));
