...
signal <b>u</b> exceeds the <b>reference</b> signal plus half of the bandwidth.</p>
		...
		model thermal_conductor_A "thermal_conductor_A.mo"
			...
			Modelica.Thermal.HeatTransfer.Components.ThermalResistor thermalResistor1(R=(if TIM then R_T else 0)) annotation(Placement(transformation(extent={{-30,20},{-10,40}})));
			protected
				parameter Real R_T=(if set_surface_area then 1/(h_contact*A_set) else (if surface_properties1.A<surface_properties2.A then 1/(h_contact*surface_properties1.A) else 1/(h_contact*surface_properties2.A)))if TIM;
			equation
...
<pre>
    ...
    where
       ...
       e2: Emission value of outer cylinder (0..1)
		...
		expandable connector thermal_connector_opt_prop "Verbindungselement fuer mehr als eine Schnittstelle"
			import Modelica.Thermal.HeatTransfer.Interfaces;
				...
				Diagram(
					...
					graphics={
																	...
																	Text(
																		...
																		origin={-142.343,2.7644},
																		rotation=90)}));
		end thermal_connector_opt_prop;
		model Panel_opt_prop "Panel_opt_prop.mo"
			iboss.iboss_thermal.components.surface_properties_out surface_properties_out_yp annotation(Placement(transformation(extent={{30,85},{50,105}})));
			iboss.iboss_thermal.components.surface_properties_out surface_properties_out_yn annotation(Placement(transformation(extent={{30,-105},{50,-85}})));
			iboss.iboss_thermal.components.surface_properties_out surface_properties_out_xp annotation(Placement(transformation(extent={{160,-25},{180,-5}})));
			iboss.iboss_thermal.components.surface_properties_out surface_properties_out_xn annotation(Placement(transformation(extent={{-140,-25},{-120,-5}})));
			thermal_connector_opt_prop thermal_connector_out_zp_multi annotation(Placement(transformation(extent={{-115,-110},{-95,-90}})));
			thermal_connector_opt_prop thermal_connector_out_zn_multi annotation(Placement(transformation(extent={{155,70},{175,90}})));
			...
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_MSS_inner(
				...
				TIM=true,
				h_contact=1000) annotation(Placement(transformation(extent={{30,-35},{50,-15}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_TSS_inner(
				set_surface_area=false,
				h_contact=1000) annotation(Placement(transformation(extent={{30,10},{50,30}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_TSS_outer(h_contact=1000) annotation(Placement(transformation(extent={{30,-10},{50,10}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_MSS_outer(h_contact=1000) annotation(Placement(transformation(extent={{30,-55},{50,-35}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSxn_MSSxn(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,-45},{-20,-25}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSyn_MSSyn(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,-70},{-20,-50}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSyp_MSSyp(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,35},{-20,55}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSxp_MSS_xp(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,5},{-20,25}})));
			...
			equation
				connect(thermal_conductor_Panel_MSS_inner.surface_properties1,MSS.zn) annotation(Line(
					points={{30,-25},{25,-25},{10,-25},{10,-5},{5,-5}},
					color={255,0,0},
					thickness=0.0625));
				...
				connect(thermal_conductor_Panel_TSS_inner.surface_properties1,TSS.zn) annotation(Line(
					points={{30,20},{25,20},{-50,20},{-50,-5},{-55,-5}},
					color={255,0,0},
					thickness=0.0625));
				
				connect(thermal_conductor_Panel_TSS_outer.surface_properties1,MSS.zp) annotation(Line(
					points={{30,0},{25,0},{0,0},{0,-15},{-5,-15}},
					color={255,0,0},
					thickness=0.0625));
				...
				connect(Panel.yp,surface_properties_out_yp) annotation(Line(
					...
					color={0,0,0},
					thickness=0.0625));
				connect(thermal_conductor_Panel_TSS_outer.surface_properties2,Panel.zp) annotation(Line(
					points={{50,0},{55,0},{73.7,0},{73.7,-31.3},{78.7,-31.3}},
					color={255,0,0},
					thickness=0.0625));
				connect(thermal_conductor_Panel_TSS_inner.surface_properties2,Panel.zn) annotation(Line(
					points={{50,20},{55,20},{111.3,20},{111.3,6.3},{106.3,6.3}},
					color={255,0,0},
					thickness=0.0625));
				connect(thermal_conductor_Panel_MSS_outer.surface_properties2,Panel.zp) annotation(Line(
					points={{50,-45},{55,-45},{73.7,-45},{73.7,-31.3},{78.7,-31.3}},
					color={255,0,0},
					thickness=0.0625));
				connect(thermal_conductor_Panel_MSS_inner.surface_properties2,Panel.zn) annotation(Line(
					points={{50,-25},{55,-25},{111.3,-25},{111.3,6.3},{106.3,6.3}},
					color={255,0,0},
					thickness=0.0625));
				...
				connect(MSS.zp,thermal_connector_out_zp_multi.MSS) annotation(
					Line(
						...
						thickness=0.0625),
					AutoRoute=false);
				connect(TSS.zp,thermal_connector_out_zp_multi.TSS) annotation(
					Line(
						points={{-65,-15},{-55,-15},{-100,-15},{-100,-100},{-105,-100}},
						color={0,0,0},
						thickness=0.0625),
					AutoRoute=false);
				...
				connect(thermal_conductor_TSSzn_MSSzp.surface_properties1,TSS.zn) annotation(Line(
					...
					color={255,0,0},
					thickness=0.0625));
				connect(thermal_conductor_Panel_MSS_outer.surface_properties1,TSS.zp) annotation(Line(
					points={{30,-45},{25,-45},{-60,-45},{-60,-15},{-65,-15}},
					color={255,0,0},
					thickness=0.015625));
				connect(TSS.yp,thermal_conductor_TSSyp_MSSyp.surface_properties1) annotation(Line(
					points={{-60,-2.3},{-60,2.7},{-60,45},{-45,45},{-40,45}},
					color={0,0,0},
					thickness=0.0625));
				connect(thermal_conductor_TSSyp_MSSyp.surface_properties2,MSS.yp) annotation(Line(
					points={{-20,45},{-15,45},{0,45},{0,2.7},{0,-2.3}},
					color={255,0,0},
					thickness=0.0625));
				connect(TSS.xp,thermal_conductor_TSSxp_MSS_xp.surface_properties1) annotation(Line(
					points={{-50,-10},{-45,-10},{-45,15},{-40,15}},
					color={0,0,0},
					thickness=0.0625));
				connect(thermal_conductor_TSSxp_MSS_xp.surface_properties2,MSS.xp) annotation(Line(
					points={{-20,15},{-15,15},{15,15},{15,-10},{10,-10}},
					color={255,0,0},
					thickness=0.0625));
				connect(TSS.xn,thermal_conductor_TSSxn_MSSxn.surface_properties1) annotation(Line(
					points={{-70,-10},{-75,-10},{-75,-35},{-45,-35},{-40,-35}},
					color={0,0,0},
					thickness=0.0625));
				connect(thermal_conductor_TSSxn_MSSxn.surface_properties2,MSS.xn) annotation(Line(
					points={{-20,-35},{-15,-35},{-15,-10},{-10,-10}},
					color={255,0,0},
					thickness=0.0625));
				connect(TSS.yn,thermal_conductor_TSSyn_MSSyn.surface_properties1) annotation(Line(
					points={{-60,-17.7},{-60,-22.7},{-60,-60},{-45,-60},{-40,-60}},
					color={0,0,0},
					thickness=0.0625));
				connect(thermal_conductor_TSSyn_MSSyn.surface_properties2,MSS.yn) annotation(Line(
					points={{-20,-60},{-15,-60},{0,-60},{0,-22.7},{0,-17.7}},
					color={255,0,0},
					thickness=0.0625));
			annotation(
				experiment(
