       ...
       e2: Emission value of outer cylinder (0..1)
		...
		model Panel_opt_prop "Panel_opt_prop.mo"
			...
			iboss.iboss_thermal.components.thermal_element_opt_prop TSS(
				...
				opticalProperties_zp=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band()) annotation(Placement(transformation(extent={{-55,-20},{-35,0}})));
			iboss.iboss_thermal.components.thermal_element_opt_prop MSS(
				...
				opticalProperties_zp=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium()) annotation(Placement(transformation(extent={{-25,-20},{-5,0}})));
			...
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSxn_MSSxp(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,-45},{-20,-25}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSyn_MSSyp(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,30},{-20,50}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSyp_MSSyn(
				TIM=false,
				h_contact=1000) annotation(Placement(transformation(extent={{-40,5},{-20,25}})));
			iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSxp_MSS_xn(
				TIM=false,
			...
			equation
				connect(thermal_conductor_Panel_MSS_inner.surface_properties1,MSS.zn) annotation(Line(
					points={{30,-25},{25,-25},{-5,-25},{-5,-5},{-10,-5}},
					color={255,0,0},
					thickness=0.0625));
				...
				connect(thermal_conductor_Panel_MSS_outer.surface_properties1,TSS.zp) annotation(Line(
					points={{30,-45},{25,-45},{-45,-45},{-45,-15},{-50,-15}},
					color={255,0,0},
					thickness=0.0625));
				
				
				connect(thermal_conductor_Panel_TSS_inner.surface_properties1,TSS.zn) annotation(Line(
					points={{30,20},{25,20},{-35,20},{-35,-5},{-40,-5}},
					color={255,0,0},
					thickness=0.0625));
				
				connect(thermal_conductor_Panel_TSS_outer.surface_properties1,MSS.zp) annotation(Line(
					points={{30,0},{25,0},{-15,0},{-15,-15},{-20,-15}},
					color={255,0,0},
					thickness=0.0625));
				
				connect(TSS.xn,thermal_conductor_TSSxn_MSSxp.surface_properties1) annotation(Line(
					points={{-55,-10},{-60,-10},{-60,-35},{-45,-35},{-40,-35}},
					color={0,0,0},
					thickness=0.0625));
				connect(MSS.xp,thermal_conductor_TSSxn_MSSxp.surface_properties2) annotation(Line(
					points={{-5,-10},{0,-10},{0,-35},{-15,-35},{-20,-35}},
					color={0,0,0},
					thickness=0.0625));
				connect(TSS.xp,thermal_conductor_TSSxp_MSS_xn.surface_properties1) annotation(Line(
					points={{-35,-10},{-30,-10},{-30,-35},{-45,-35},{-45,-60},{-40,
					-60}},
					color={0,0,0},
					thickness=0.0625));
				connect(MSS.xn,thermal_conductor_TSSxp_MSS_xn.surface_properties2) annotation(Line(
					points={{-25,-10},{-30,-10},{-30,-35},{-15,-35},{-15,-60},{-20,
					-60}},
					color={0,0,0},
					thickness=0.0625));
				connect(TSS.yp,thermal_conductor_TSSyp_MSSyn.surface_properties1) annotation(Line(
					points={{-45,-2.3},{-45,2.7},{-45,15},{-40,15}},
					color={0,0,0},
					thickness=0.0625));
				connect(MSS.yn,thermal_conductor_TSSyp_MSSyn.surface_properties2) annotation(Line(
					points={{-15,-17.7},{-15,-22.7},{-15,15},{-20,15}},
					color={0,0,0},
					thickness=0.0625));
				
				
				connect(thermal_conductor_TSSyn_MSSyp.surface_properties1,TSS.yn) annotation(Line(
					points={{-40,40},{-45,40},{-45,-22.7},{-45,-17.7}},
					color={255,0,0},
					thickness=0.0625));
				connect(MSS.yp,thermal_conductor_TSSyn_MSSyp.surface_properties2) annotation(Line(
					points={{-15,-2.3},{-15,2.7},{-15,40},{-20,40}},
					color={0,0,0},
					thickness=0.0625));
				...
				connect(TSS.zn,thermal_connector_out_zn_multi.TSS) annotation(Line(
					points={{-40,-5},{-35,-5},{160,-5},{160,80},{165,80}},
					color={0,0,0},
					thickness=0.0625));
				connect(MSS.zn,thermal_connector_out_zn_multi.MSS) annotation(Line(
					points={{-10,-5},{-5,-5},{160,-5},{160,80},{165,80}},
					color={0,0,0},
					thickness=0.0625));
				...
				connect(Panel.zp,thermal_connector_out_zp_multi.Rad) annotation(Line(
					...
					color={0,0,0},
					thickness=0.0625));
				connect(MSS.zp,thermal_connector_out_zp_multi.MSS) annotation(Line(
					points={{-20,-15},{-25,-15},{-100,-15},{-100,-100},{-105,-100}},
					color={0,0,0},
					thickness=0.0625));
				connect(TSS.zp,thermal_connector_out_zp_multi.TSS) annotation(Line(
					points={{-50,-15},{-55,-15},{-100,-15},{-100,-100},{-105,-100}},
					color={0,0,0},
					thickness=0.0625));
			annotation(
				experiment(
