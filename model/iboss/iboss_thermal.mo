...
"),
		...
		model BB_opt_prop "BB_opt_prop.mo"
			...
			Panel_opt_prop panel_opt_prop_xn annotation(Placement(transformation(extent={{-90,-16},{-69,5}})));
			Panel_opt_prop panel_opt_prop_yp annotation(Placement(transformation(extent={{5,54},{26,75}})));
			Panel_opt_prop panel_opt_prop_xp annotation(Placement(transformation(extent={{110,-16},{131,5}})));
			Panel_opt_prop panel_opt_prop_yn annotation(Placement(transformation(extent={{15,-91},{36,-70}})));
			Panel_opt_prop panel_opt_prop_zp annotation(Placement(transformation(extent={{-85,-86},{-64,-65}})));
			Panel_opt_prop panel_opt_prop_zn annotation(Placement(transformation(extent={{105,54},{126,75}})));
