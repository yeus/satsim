...
model thermal_conductor_A "thermal_conductor_A.mo"
	...
	equation
		connect(thermalVariableResistor1.port_b,surface_properties2.thermal_port) annotation(Line(
			points={{-10,30},{-5,30},{30,30},{30,5},{35,5}},
			color={191,0,0},
			thickness=0.0625));
		connect(thermalVariableResistor1.port_a,surface_properties1.thermal_port) annotation(Line(
		...
		Icon(
			...
			graphics={
																								...
																								Text(
																									...
																									textStyle={TextStyle.Bold},
																									fillPattern=FillPattern.Solid,
																									extent={{-65.59999999999999,72},{54.4,148.7}},
																									visible=true,
																									origin={5.6,-108.7}),
																								Text(
																									textString="xn",
																									lineColor={0,0,0},
																									extent={{-97.59999999999999,17.4},{-50.4,-16.2}}),
																								Text(
																									textString="zp",
																									lineColor={0,0,0},
																									extent={{-104.3,-29.2},{-57.1,-62.8}}),
																								Text(
																									textString="yn",
																									lineColor={0,0,0},
																									extent={{-24.1,-32.6},{23.1,-66.2}}),
																								Text(
																									textString="yp",
																									lineColor={0,0,0},
																									extent={{-24.7,67.40000000000001},{22.5,33.8}}),
																								Text(
																									textString="xp",
																									lineColor={0,0,0},
																									extent={{49,17.2},{96.2,-16.4}}),
																								Text(
																									textString="zn",
																									lineColor={0,0,0},
																									extent={{55.6,63.7},{102.8,30.1}})}),
experiment(
	StopTime=1,
	StartTime=0));
end thermal_element_opt_prop;
connector thermal_connector_opt_prop_out "Verbindungselement fuer mehr als eine Schnittstelle"
	import Modelica.Thermal.HeatTransfer.Interfaces;
	iboss.iboss_thermal.components.surface_properties_out TSS annotation(Placement(
		transformation(
			origin={34.9878,25.027},
			extent={{-29.3849,-29.3849},{29.3849,29.3849}}),
		iconTransformation(
			origin={47.5754,49.0995},
			extent={{-20.9005,-20.9005},{20.9005,20.9005}})));
	iboss.iboss_thermal.components.surface_properties_out MSS annotation(Placement(
		transformation(
			origin={35.2917,-25.3457},
			extent={{-29.3775,-29.3775},{29.3775,29.3775}}),
		iconTransformation(
			origin={-44.5202,-48.8898},
			extent={{-21.1102,-21.1102},{21.1102,21.1102}})));
	iboss.iboss_thermal.components.surface_properties_out Rad annotation(Placement(
		transformation(
			origin={34.5515,74.5515},
			extent={{-28.326,-28.326},{28.326,28.326}}),
		iconTransformation(
...
Diagram(
	...
	graphics={
																																							...
																																							Text(
																																								...
																																								origin={-142.343,2.7644},
																																								rotation=90)}));
end thermal_connector_opt_prop_out;
model Panel_opt_prop "Panel_opt_prop.mo"
	parameter Modelica.SIunits.Height x_Panel=0.4 "height of Panel in m";
	parameter Modelica.SIunits.Height y_Panel=0.4 "width of Panel in m";
	parameter Modelica.SIunits.Height z_Panel=0.02 "thickness of Panel in m";
	parameter Modelica.SIunits.Height x_MSS=0.04 "height of MSS in m";
	parameter Modelica.SIunits.Height y_MSS=0.08 "width of MSS in m";
	parameter Modelica.SIunits.Height z_MSS=0.08 "thickness of MSS in m";
	parameter Modelica.SIunits.Height x_TSS=0.2 "height of TSS in m";
	parameter Modelica.SIunits.Height y_TSS=0.2 "width of TSS in m";
	parameter Modelica.SIunits.Height z_TSS=0.005 "thickness of TSS in m";
	parameter MaterialDatabase.Material material_MSS=MaterialDatabase.Aluminiumlegierungen_1060_Legierung() "Material of MSS from MaterialDataBase" annotation(
		Placement(transformation(extent={{-10,-10},{10,10}})),
		choicesAllMatching=true);
	parameter MaterialDatabase.Material material_TSS=MaterialDatabase.Kupferlegierungen_Kupfer() "Material of TSS from MaterialDataBase" annotation(
	...
	parameter MaterialDatabase.Material material_Panel=MaterialDatabase.Kohlenstofffasern_Carbon_Panel_tbd() "Material of TSS from MaterialDataBase" annotation(
		Placement(transformation(extent={{-10,-10},{10,10}})),
		choicesAllMatching=true);
	iboss.iboss_thermal.components.surface_properties_out surface_properties_out_yp "optical properties of the outer surface of the side panel" annotation(Placement(
		transformation(extent={{30,85},{50,105}}),
		iconTransformation(extent={{-11.7,91.7},{8.300000000000001,111.7}})));
	iboss.iboss_thermal.components.surface_properties_out surface_properties_out_yn "optical properties of the outer surface of the side panel" annotation(Placement(
		transformation(extent={{30,-105},{50,-85}}),
		iconTransformation(
			origin={-1.7,-98.3},
			extent={{-10,-10},{10,10}},
			rotation=-180)));
	iboss.iboss_thermal.components.surface_properties_out surface_properties_out_xp "optical properties of the outer surface of the side panel" annotation(Placement(
		transformation(extent={{160,-25},{180,-5}}),
		iconTransformation(
			origin={98.3,1.7},
			extent={{-10,-10},{10,10}},
			rotation=-90)));
	iboss.iboss_thermal.components.surface_properties_out surface_properties_out_xn "optical properties of the outer surface of the side panel" annotation(Placement(
		transformation(extent={{-140,-25},{-120,-5}}),
		iconTransformation(
			origin={-101.7,1.7},
			extent={{-10,-10},{10,10}},
			rotation=90)));
	thermal_connector_opt_prop_out thermal_connector_out_zp_multi annotation(Placement(
		transformation(extent={{-115,-110},{-95,-90}}),
		iconTransformation(extent={{-61.7,-108.3},{-41.7,-88.3}})));
	thermal_connector_opt_prop_out thermal_connector_out_zn_multi annotation(Placement(
		transformation(extent={{155,70},{175,90}}),
		iconTransformation(extent={{88.3,41.7},{108.3,61.7}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop Panel(
		dissipation_power_on=false,
		material=material_Panel,
		x=x_Panel,
		y=y_Panel,
		z=z_Panel,
		opticalProperties_xn=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_xp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_yn=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.MLI()) annotation(Placement(transformation(extent={{65,-50},{120,25}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop TSS(
		material=material_TSS,
		x=x_TSS,
		y=y_TSS,
		z=z_TSS,
		opticalProperties_xn=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band(),
		opticalProperties_xp=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band(),
		opticalProperties_yn=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band(),
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Folien_Baender___Matt_Kupferfolie_Band()) annotation(Placement(transformation(extent={{-70,-20},{-50,0}})));
	iboss.iboss_thermal.components.thermal_element_opt_prop MSS(
		material=material_MSS,
		x=x_MSS,
		y=y_MSS,
		z=z_MSS,
		opticalProperties_xn=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium(),
		opticalProperties_xp=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium(),
		opticalProperties_yn=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium(),
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Oberflaechenbehandlungen_Poliert_Anfang_der_Nutzungsdauer_Aluminium()) annotation(Placement(transformation(extent={{-10,-20},{10,0}})));
	iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_MSS_inner(
		set_surface_area=false,
		TIM=true,
		h_contact=1000) annotation(Placement(transformation(extent={{30,-20},{50,0}})));
	iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_outer_TSS_inner(h_contact=1000) annotation(Placement(transformation(extent={{30,5},{50,25}})));
	iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_Panel_MSS_outer(h_contact=1000) annotation(Placement(transformation(extent={{30,-50},{50,-30}})));
	iboss.iboss_thermal.components.thermal_conductor_A thermal_conductor_TSSzn_MSSzp(
		TIM=false,
		h_contact=1000) annotation(Placement(transformation(extent={{-40,-20},{-20,0}})));
	equation
		connect(thermal_conductor_Panel_MSS_inner.surface_properties1,MSS.zn) annotation(Line(
			points={{30,-10},{25,-10},{10,-10},{10,-5},{5,-5}},
			color={255,0,0},
			thickness=0.0625));
		...
		connect(Panel.xn,surface_properties_out_xn) annotation(Line(
			points={{65,-12.7},{60,-12.7},{-125,-12.7},{-125,-15},{-130,-15}},
			color={0,0,0},
			thickness=0.0625));
		connect(Panel.yn,surface_properties_out_yn) annotation(Line(
			points={{92.7,-40.7},{92.7,-45.7},{92.7,-95},{45,-95},{40,-95}},
			color={0,0,0},
			thickness=0.0625));
		connect(Panel.xp,surface_properties_out_xp) annotation(Line(
			points={{120,-12.7},{125,-12.7},{165,-12.7},{165,-15},{170,-15}},
			color={0,0,0},
			thickness=0.0625));
		connect(Panel.yp,surface_properties_out_yp) annotation(Line(
			points={{92.7,15.7},{92.7,20.7},{92.7,95},{45,95},{40,95}},
			color={0,0,0},
			thickness=0.0625));
		
		connect(thermal_conductor_Panel_MSS_outer.surface_properties2,Panel.zp) annotation(Line(
			points={{50,-40},{55,-40},{73.7,-40},{73.7,-31.3},{78.7,-31.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_Panel_MSS_inner.surface_properties2,Panel.zn) annotation(Line(
			points={{50,-10},{55,-10},{111.3,-10},{111.3,6.3},{106.3,6.3}},
			color={255,0,0},
			thickness=0.0625));
		...
		connect(TSS.zn,thermal_connector_out_zn_multi.TSS) annotation(Line(
			points={{-55,-5},{-50,-5},{160,-5},{160,80},{165,80}},
			color={0,0,0},
			thickness=0.0625));
		connect(MSS.zn,thermal_connector_out_zn_multi.MSS) annotation(Line(
			points={{5,-5},{10,-5},{160,-5},{160,80},{165,80}},
			color={0,0,0},
			thickness=0.0625));
		connect(Panel.zn,thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{106.3,6.3},{111.3,6.3},{160,6.3},{160,80},{165,80}},
			color={0,0,0},
			thickness=0.0625));
		connect(Panel.zp,thermal_connector_out_zp_multi.Rad) annotation(Line(
			points={{78.7,-31.3},{73.7,-31.3},{-100,-31.3},{-100,-100},{-105,-100}},
			color={0,0,0},
			thickness=0.0625));
		connect(MSS.zp,thermal_connector_out_zp_multi.MSS) annotation(
			Line(
				points={{-5,-15},{-25,-20},{-100,-20},{-100,-100},{-105,-100}},
				color={0,0,0},
				thickness=0.0625),
			AutoRoute=false);
		
		
		connect(thermal_conductor_TSSzn_MSSzp.surface_properties2,MSS.zp) annotation(Line(
			points={{-20,-10},{-15,-10},{-10,-10},{-10,-15},{-5,-15}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_TSSzn_MSSzp.surface_properties1,TSS.zn) annotation(Line(
			points={{-40,-10},{-45,-10},{-50,-10},{-50,-5},{-55,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_Panel_MSS_outer.surface_properties1,MSS.zp) annotation(
			Line(
				points={{30,-40},{25,-45},{-5,-45},{-5,-15}},
				color={255,0,0},
				thickness=0.0625),
			AutoRoute=false);
		connect(thermal_conductor_Panel_outer_TSS_inner.surface_properties2,Panel.zp) annotation(Line(
			points={{50,15},{55,15},{73.7,15},{73.7,-31.3},{78.7,-31.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_Panel_outer_TSS_inner.surface_properties1,TSS.zn) annotation(Line(
			points={{30,15},{25,15},{-50,15},{-50,-5},{-55,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(TSS.zp,thermal_connector_out_zp_multi.TSS) annotation(Line(
			points={{-65,-15},{-70,-15},{-100,-15},{-100,-100},{-105,-100}},
			color={0,0,0},
			thickness=0.0625));
	annotation(
		Icon(
			...
			graphics={
																...
																lineColor={0,0,0},
															fillPattern=FillPattern.Solid,
															extent={{-103.3,101.3},{103.3,-105.3}}),
														Ellipse(
															lineColor={0,0,0},
															fillColor={210,180,140},
															fillPattern=FillPattern.Solid,
															extent={{67.7,-72},{-69,68}}),
														Ellipse(
															lineColor={0,0,0},
															fillColor={192,192,192},
															fillPattern=FillPattern.Solid,
															extent={{25.3,-29.7},{-28,23.7}}),
														Ellipse(
															lineColor={0,0,0},
															fillColor={255,0,0},
															fillPattern=FillPattern.Solid,
...
connector thermal_connector_opt_prop_in "thermal_connector_opt_prop_in.mo"
	import Modelica.Thermal.HeatTransfer.Interfaces;
	surface_properties_in TSS annotation(Placement(
		transformation(
			origin={34.9878,25.027},
			extent={{-29.3849,-29.3849},{29.3849,29.3849}}),
		iconTransformation(
			origin={47.5754,49.0995},
			extent={{-20.9005,-20.9005},{20.9005,20.9005}})));
	surface_properties_in MSS annotation(Placement(
		transformation(
			origin={35.2917,-25.3457},
			extent={{-29.3775,-29.3775},{29.3775,29.3775}}),
		iconTransformation(
			origin={-44.5202,-48.8898},
			extent={{-21.1102,-21.1102},{21.1102,21.1102}})));
	surface_properties_in Rad annotation(Placement(
		transformation(
			origin={34.5515,74.5515},
			extent={{-28.326,-28.326},{28.326,28.326}}),
		iconTransformation(
...
Diagram(
	...
	graphics={
																																							...
																																							Text(
																																								...
																																								origin={-142.343,2.7644},
																																								rotation=90)}));
end thermal_connector_opt_prop_in;
model BB_connector "BB_connector.mo"
	...
	thermal_connector_opt_prop_in thermal_connector_opt_prop_in2 annotation(Placement(transformation(
		origin={70,-5},
		extent={{-10,-10},{10,10}},
		rotation=-180)));
	thermal_conductor_A thermal_conductor_MSS annotation(Placement(transformation(extent={{-10,-15},{10,5}})));
	...
	equation
		connect(thermal_conductor_TSS.surface_properties1,thermal_connector_opt_prop_in1.TSS) annotation(Line(
			points={{-10,20},{-15,20},{-60,20},{-60,-5},{-65,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_MSS.surface_properties1,thermal_connector_opt_prop_in1.MSS) annotation(Line(
			points={{-10,-5},{-15,-5},{-60,-5},{-65,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_rad.surface_properties1,thermal_connector_opt_prop_in1.Rad) annotation(Line(
			points={{-10,-30},{-15,-30},{-60,-30},{-60,-5},{-65,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_TSS.surface_properties2,thermal_connector_opt_prop_in2.TSS) annotation(Line(
			points={{10,20},{15,20},{65,20},{65,-5},{70,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_MSS.surface_properties2,thermal_connector_opt_prop_in2.MSS) annotation(Line(
			points={{10,-5},{15,-5},{65,-5},{70,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_rad.surface_properties2,thermal_connector_opt_prop_in2.Rad) annotation(Line(
			points={{10,-30},{15,-30},{65,-30},{65,-5},{70,-5}},
			color={255,0,0},
			thickness=0.0625));
	annotation(
		Icon(
...
model environment_opt_prop_external_Verosim "environment_opt_prop_external_Verosim.mo"
	iboss.iboss_thermal.components.thermal_connector_opt_prop_in thermal_connector_opt_prop_in1 "Verbindungselement fuer mehr als eine Schnittstelle" annotation(Placement(
		transformation(
			origin={110,-25},
			extent={{10,10},{-10,-10}},
			rotation=180),
	...
	input Modelica.Blocks.Interfaces.RealInput u annotation(Placement(
		transformation(extent={{-85,-50},{-45,-10}}),
		iconTransformation(extent={{-120,-20},{-80,20}})));
	iboss.iboss_thermal.components.VariableHeatFlow variableHeatFlow_TSS(Q_flow=u*thermal_connector_opt_prop_in1.TSS.alpha*thermal_connector_opt_prop_in1.TSS.A/(thermal_connector_opt_prop_in1.TSS.A+thermal_connector_opt_prop_in1.MSS.A+thermal_connector_opt_prop_in1.Rad.A)) annotation(Placement(transformation(extent={{70,5},{90,25}})));
	iboss.iboss_thermal.components.VariableHeatFlow variableHeatFlow_MSS(Q_flow=u*thermal_connector_opt_prop_in1.MSS.alpha*thermal_connector_opt_prop_in1.MSS.A/(thermal_connector_opt_prop_in1.TSS.A+thermal_connector_opt_prop_in1.MSS.A+thermal_connector_opt_prop_in1.Rad.A)) annotation(Placement(transformation(extent={{70,-35},{90,-15}})));
	iboss.iboss_thermal.components.VariableHeatFlow variableHeatFlow_Rad(Q_flow=u*thermal_connector_opt_prop_in1.Rad.alpha*thermal_connector_opt_prop_in1.Rad.A/(thermal_connector_opt_prop_in1.TSS.A+thermal_connector_opt_prop_in1.MSS.A+thermal_connector_opt_prop_in1.Rad.A)) annotation(Placement(transformation(extent={{70,-70},{90,-50}})));
	...
	equation
		connect(variableHeatFlow_TSS.port,thermal_connector_opt_prop_in1.TSS.thermal_port) annotation(Line(
			points={{90,15},{95,15},{105,15},{105,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableHeatFlow_MSS.port,thermal_connector_opt_prop_in1.MSS.thermal_port) annotation(Line(
			points={{90,-25},{95,-25},{105,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableHeatFlow_Rad.port,thermal_connector_opt_prop_in1.Rad.thermal_port) annotation(Line(
			points={{90,-60},{95,-60},{105,-60},{105,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_MSS.port_b,fixedTemperature1.port) annotation(Line(
			points={{155,-25},{160,-25},{210,-25},{205,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_TSS.port_b,fixedTemperature1.port) annotation(Line(
			points={{155,15},{160,15},{210,15},{210,-25},{205,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_Rad.port_b,fixedTemperature1.port) annotation(Line(
			points={{155,-60},{160,-60},{210,-60},{210,-25},{205,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_TSS.port_a,thermal_connector_opt_prop_in1.TSS.thermal_port) annotation(Line(
			points={{135,15},{130,15},{115,15},{115,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_MSS.port_a,thermal_connector_opt_prop_in1.MSS.thermal_port) annotation(Line(
			points={{135,-25},{130,-25},{115,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
		connect(variableRad_Rad.port_a,thermal_connector_opt_prop_in1.Rad.thermal_port) annotation(Line(
			points={{135,-60},{130,-60},{115,-60},{115,-25},{110,-25}},
			color={191,0,0},
			thickness=0.0625));
	annotation(
		Icon(graphics={
...
model BB_opt_prop "BB_opt_prop.mo"
	parameter Modelica.SIunits.Height x_Panel=0.4 "height of Panel in m";
	parameter Modelica.SIunits.Height y_Panel=0.4 "width of Panel in m";
	parameter Modelica.SIunits.Height z_Panel=0.02 "thickness of Panel in m";
	parameter Modelica.SIunits.Height x_MSS=0.04 "height of MSS in m";
	...
	parameter MaterialDatabase.Material material_EB=MaterialDatabase.Elektronik_Box_Composit() "Material of Electronic Box from MaterialDataBase" annotation(
		Placement(transformation(extent={{-10,-10},{10,10}})),
		choicesAllMatching=true);
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_xn annotation(Placement(transformation(extent={{-150,-10},{-130,10}})));
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_xp annotation(Placement(transformation(extent={{180,-15},{200,5}})));
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_yp annotation(Placement(transformation(
		origin={15,100},
		extent={{-10,-10},{10,10}},
		rotation=270)));
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_yn annotation(Placement(transformation(
		origin={30,-125},
		extent={{-10,-10},{10,10}},
		rotation=-270)));
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_zn annotation(Placement(transformation(extent={{155,80},{175,100}})));
	thermal_connector_opt_prop_out thermal_connector_opt_prop_out_zp annotation(Placement(transformation(extent={{-110,-125},{-90,-105}})));
	Panel_opt_prop panel_opt_prop_xn(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{-90,-16},{-69,5}})));
	Panel_opt_prop panel_opt_prop_yp(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{5,54},{26,75}})));
	Panel_opt_prop panel_opt_prop_xp(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{110,-16},{131,5}})));
	Panel_opt_prop panel_opt_prop_yn(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{15,-91},{36,-70}})));
	Panel_opt_prop panel_opt_prop_zp(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{-85,-86},{-64,-65}})));
	Panel_opt_prop panel_opt_prop_zn(
		x_Panel=x_Panel,
		y_Panel=y_Panel,
		z_Panel=z_Panel,
		x_MSS=x_MSS,
		...
		material_MSS=material_MSS,
		material_TSS=material_TSS,
		material_Panel=material_Panel) annotation(Placement(transformation(extent={{105,54},{126,75}})));
	thermal_conductor_A thermal_conductor_A_xpyp_ypxp(h_contact=1000) annotation(Placement(transformation(extent={{70,55},{90,75}})));
	thermal_conductor_A thermal_conductor_A_xnyp_ypxn(h_contact=1000) annotation(Placement(transformation(extent={{-55,45},{-35,65}})));
	thermal_conductor_A thermal_conductor_A_xnyn_ynxn(h_contact=1000) annotation(Placement(transformation(extent={{-40,-60},{-20,-40}})));
	thermal_conductor_A thermal_conductor_A_xpyn_ynxp(h_contact=1000) annotation(Placement(transformation(extent={{115,-90},{135,-70}})));
	thermal_conductor_A thermal_conductor_A_xpxn_zpxp(h_contact=1000) annotation(Placement(transformation(extent={{-45,-85},{-25,-65}})));
	thermal_conductor_A thermal_conductor_A_ypyn_zpyp(h_contact=1000) annotation(Placement(transformation(extent={{-30,15},{-10,35}})));
	thermal_conductor_A thermal_conductor_A_xnxp_zpxn(h_contact=1000) annotation(Placement(transformation(
		origin={-95,-50},
		extent={{-10,-10},{10,10}},
		rotation=90)));
	thermal_conductor_A thermal_conductor_A_ynyp_zpyn(h_contact=1000) annotation(Placement(transformation(extent={{-20,-100},{0,-80}})));
	thermal_conductor_A thermal_conductor_A_xpxp_znxn(h_contact=1000) annotation(Placement(transformation(extent={{135,35},{155,55}})));
	thermal_conductor_A thermal_conductor_A_ypyp_znyp(h_contact=1000) annotation(Placement(transformation(extent={{50,80},{70,100}})));
	thermal_conductor_A thermal_conductor_A_ynyn_znyn(h_contact=1000) annotation(Placement(transformation(extent={{90,-110},{110,-90}})));
	thermal_conductor_A thermal_conductor_A_xnxn_znxp(h_contact=1000) annotation(Placement(transformation(extent={{-75,70},{-55,90}})));
	thermal_element_opt_prop central_electronic_box(
		...
		opticalProperties_yp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_zn=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint(),
		opticalProperties_zp=iboss.OpticalPropertiesDatabase.Schwarze_Beschichtungen_Black_paint()) annotation(Placement(transformation(extent={{20,-15},{40,5}})));
	thermal_conductor_A thermal_conductor_A_Panelxn_EBxn(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(extent={{-25,-15},{-5,5}})));
	thermal_conductor_A thermal_conductor_A_Panelxp_EBxp(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(extent={{75,-20},{95,0}})));
	thermal_conductor_A thermal_conductor_A_Panelyn_EByn(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(
		origin={50,-55},
		extent={{-10,-10},{10,10}},
		rotation=-90)));
	thermal_conductor_A thermal_conductor_A_Panelyp_EByp(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(
		origin={30,30},
		extent={{-10,-10},{10,10}},
		rotation=-90)));
	thermal_conductor_A thermal_conductor_A_Panelzn_EBzn(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(extent={{50,0},{70,20}})));
	thermal_conductor_A thermal_conductor_A_Panelzp_EBzp(
		TIM=true,
		h_contact=300) annotation(Placement(transformation(extent={{-15,-40},{5,-20}})));
	thermal_radiation_A thermal_radiation_A_xnxp annotation(Placement(transformation(extent={{20,-40},{40,-20}})));
	thermal_radiation_A thermal_radiation_A_xnyn annotation(Placement(transformation(extent={{-55,-35},{-35,-15}})));
	thermal_radiation_A thermal_radiation_A_xnyp annotation(Placement(transformation(extent={{-60,10},{-40,30}})));
	thermal_radiation_A thermal_radiation_A_xnzp annotation(Placement(transformation(
		origin={-125,-50},
		extent={{-10,-10},{10,10}},
		rotation=-270)));
	thermal_radiation_A thermal_radiation_A_xnzn annotation(Placement(transformation(extent={{100,85},{120,105}})));
	thermal_radiation_A thermal_radiation_A_xpyn annotation(Placement(transformation(extent={{75,-65},{95,-45}})));
	thermal_radiation_A thermal_radiation_A_xpyp annotation(Placement(transformation(extent={{75,25},{95,45}})));
	thermal_radiation_A thermal_radiation_A_xpzn annotation(Placement(transformation(extent={{175,15},{195,35}})));
	thermal_radiation_A thermal_radiation_A_xpzp annotation(Placement(transformation(extent={{55,-100},{75,-80}})));
	thermal_radiation_A thermal_radiation_A_ynyp annotation(Placement(transformation(extent={{175,-65},{195,-45}})));
	thermal_radiation_A thermal_radiation_A_ynzn annotation(Placement(transformation(extent={{165,-100},{185,-80}})));
	thermal_radiation_A thermal_radiation_A_ynzp annotation(Placement(transformation(extent={{-55,-115},{-35,-95}})));
	thermal_radiation_A thermal_radiation_A_ypzn annotation(Placement(transformation(extent={{40,45},{60,65}})));
	thermal_radiation_A thermal_radiation_A_ypzp annotation(Placement(transformation(extent={{150,-45},{170,-25}})));
	thermal_radiation_A thermal_radiation_A_znzp annotation(Placement(transformation(extent={{220,-85},{240,-65}})));
	thermal_radiation_A thermal_radiation_A_Panelxn_EBxn annotation(Placement(transformation(extent={{-5,0},{15,20}})));
	thermal_radiation_A thermal_radiation_A_Panelxp_EBxp annotation(Placement(transformation(extent={{75,5},{95,25}})));
	thermal_radiation_A thermal_radiation_A_Panelyn_EByn annotation(Placement(transformation(extent={{-5,-65},{15,-45}})));
	thermal_radiation_A thermal_radiation_A_Panelyp_EByp annotation(Placement(transformation(extent={{-5,25},{15,45}})));
	thermal_radiation_A thermal_radiation_A_Panelzp_EBzp annotation(Placement(transformation(extent={{-70,-55},{-50,-35}})));
	thermal_radiation_A thermal_radiation_A_Panelzn_EBzn annotation(Placement(transformation(extent={{105,20},{125,40}})));
	equation
		connect(panel_opt_prop_xp.surface_properties_out_yp,thermal_conductor_A_xpyp_ypxp.surface_properties2) annotation(Line(
			points={{120.3,5},{120.3,10},{120.3,65},{95,65},{90,65}},
			color={0,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yp.surface_properties_out_xp,thermal_conductor_A_xpyp_ypxp.surface_properties1) annotation(Line(
			points={{25.7,64.7},{30.7,64.7},{65,64.7},{65,65},{70,65}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xnyp_ypxn.surface_properties2,panel_opt_prop_yp.surface_properties_out_xn) annotation(Line(
			points={{-35,55},{-30,55},{0,55},{0,64.7},{5,64.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xnyp_ypxn.surface_properties1,panel_opt_prop_xn.surface_properties_out_yp) annotation(Line(
			points={{-55,55},{-60,55},{-79.7,55},{-79.7,10},{-79.7,5}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yn.surface_properties_out_xn,thermal_conductor_A_xnyn_ynxn.surface_properties2) annotation(Line(
			points={{15,-80.3},{10,-80.3},{-15,-80.3},{-15,-50},{-20,-50}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xnyn_ynxn.surface_properties1,panel_opt_prop_xn.surface_properties_out_yn) annotation(Line(
			points={{-40,-50},{-45,-50},{-79.7,-50},{-79.7,-20.7},{-79.7,-15.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yn.surface_properties_out_xp,thermal_conductor_A_xpyn_ynxp.surface_properties1) annotation(Line(
			points={{35.7,-80.3},{40.7,-80.3},{110,-80.3},{110,-80},{115,-80}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xpyn_ynxp.surface_properties2,panel_opt_prop_xp.surface_properties_out_yn) annotation(Line(
			points={{135,-80},{140,-80},{140,-50.3},{120.3,-50.3},{120.3,-20.7},{120.3,
			-15.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xpxn_zpxp.surface_properties1,panel_opt_prop_zp.surface_properties_out_xp) annotation(Line(
			points={{-45,-75},{-50,-75},{-59.3,-75},{-59.3,-75.3},{-64.3,-75.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xpxn_zpxp.surface_properties2,panel_opt_prop_xp.surface_properties_out_xn) annotation(Line(
			points={{-25,-75},{-20,-75},{105,-75},{105,-5.3},{110,-5.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_ypyn_zpyp.surface_properties2,panel_opt_prop_yp.surface_properties_out_yn) annotation(Line(
			points={{-10,25},{-5,25},{15.3,25},{15.3,49.3},{15.3,54.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_ypyn_zpyp.surface_properties1,panel_opt_prop_zp.surface_properties_out_yp) annotation(Line(
			points={{-30,25},{-35,25},{-74.7,25},{-74.7,-60},{-74.7,-65}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xn.surface_properties_out_xp,thermal_conductor_A_xnxp_zpxn.surface_properties2) annotation(
			Line(
				points={{-69.33333587646484,-5.333335876464844},{-64.3,-5},{-64.3,-25},{-95,-25},{-95,-35},{-95,
				-40}},
				color={0,0,0},
				thickness=0.0625),
			AutoRoute=false);
		connect(thermal_conductor_A_xnxp_zpxn.surface_properties1,panel_opt_prop_zp.surface_properties_out_xn) annotation(Line(
			points={{-95,-60},{-95,-65},{-95,-75.3},{-90,-75.3},{-85,-75.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yn.surface_properties_out_yp,thermal_conductor_A_ynyp_zpyn.surface_properties2) annotation(Line(
			points={{25.3,-70},{25.3,-65},{15.3,-65},{15.3,-90},{5,-90},{0,
			-90}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_ynyp_zpyn.surface_properties1,panel_opt_prop_zp.surface_properties_out_yn) annotation(Line(
			points={{-20,-90},{-25,-90},{-25,-90.7},{-74.7,-90.7},{-74.7,-85.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_zn.surface_properties_out_xn,thermal_conductor_A_xpxp_znxn.surface_properties1) annotation(Line(
			points={{105,64.7},{100,64.7},{100,45},{130,45},{135,45}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xpxp_znxn.surface_properties2,panel_opt_prop_xp.surface_properties_out_xp) annotation(Line(
			points={{155,45},{160,45},{160,-5.3},{135.7,-5.3},{130.7,-5.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_zn.surface_properties_out_yp,thermal_conductor_A_ypyp_znyp.surface_properties2) annotation(Line(
			points={{115.3,75},{115.3,80},{115.3,90},{75,90},{70,90}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_ypyp_znyp.surface_properties1,panel_opt_prop_yp.surface_properties_out_yp) annotation(Line(
			points={{50,90},{45,90},{15.3,90},{15.3,80},{15.3,75}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yn.surface_properties_out_yn,thermal_conductor_A_ynyn_znyn.surface_properties1) annotation(Line(
			points={{25.3,-90.7},{25.3,-95.7},{25.3,-100},{85,-100},{90,-100}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_ynyn_znyn.surface_properties2,panel_opt_prop_zn.surface_properties_out_yn) annotation(Line(
			points={{110,-100},{115,-100},{115.3,-100},{115.3,49.3},{115.3,54.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_zn.surface_properties_out_xp,thermal_conductor_A_xnxn_znxp.surface_properties2) annotation(Line(
			points={{125.7,64.7},{130.7,64.7},{130.7,80},{-50,80},{-55,80}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_xnxn_znxp.surface_properties1,panel_opt_prop_xn.surface_properties_out_xn) annotation(Line(
			points={{-75,80},{-80,80},{-95,80},{-95,-5.3},{-90,-5.3}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xn.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_xn) annotation(Line(
			points={{-85,-15.7},{-85,-20.7},{-110,-20.7},{-110,0},{-135,0},{-140,
			0}},
			thickness=0.0625));
		connect(panel_opt_prop_xp.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_xp) annotation(Line(
			points={{115,-15.7},{115,-20.7},{150,-20.7},{150,-5},{185,-5},{190,
			-5}},
			thickness=0.0625));
		connect(panel_opt_prop_zn.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_zn) annotation(Line(
			points={{110,54.3},{110,49.3},{135,49.3},{135,90},{160,90},{165,
			90}},
			thickness=0.0625));
		connect(panel_opt_prop_yn.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_yn) annotation(Line(
			points={{20,-90.7},{20,-95.7},{20,-125},{25,-125},{30,-125}},
			thickness=0.0625));
		connect(panel_opt_prop_zp.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_zp) annotation(Line(
			points={{-80,-85.7},{-80,-90.7},{-80,-115},{-95,-115},{-100,-115}},
			thickness=0.0625));
		connect(panel_opt_prop_yp.thermal_connector_out_zp_multi,thermal_connector_opt_prop_out_yp) annotation(Line(
			points={{10,54.3},{10,49.3},{10,100},{15,100}},
			thickness=0.0625));
		
		
		connect(central_electronic_box.xn,thermal_conductor_A_Panelxn_EBxn.surface_properties2) annotation(Line(
			points={{20,-5},{15,-5},{0,-5},{-5,-5}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelxn_EBxn.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-25,-5},{-30,-5},{-64.3,-5},{-64.3,0},{-69.3,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad,thermal_conductor_A_Panelxp_EBxp.surface_properties2) annotation(Line(
			points={{130.7,0},{135.7,0},{135.7,-10},{100,-10},{95,-10}},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelxp_EBxp.surface_properties1,central_electronic_box.xp) annotation(Line(
			points={{75,-10},{70,-10},{45,-10},{45,-5},{40,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad,thermal_conductor_A_Panelyn_EByn.surface_properties2) annotation(Line(
			points={{35.7,-75},{40.7,-75},{50,-75},{50,-70},{50,-65}},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelyn_EByn.surface_properties1,central_electronic_box.yn) annotation(Line(
			points={{50,-45},{50,-40},{50,-17.7},{30,-17.7},{30,-12.7}},
			color={255,0,0},
			thickness=0.0625));
		
		connect(thermal_conductor_A_Panelyp_EByp.surface_properties1,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{30,40},{30,45},{30.7,45},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelyp_EByp.surface_properties2,central_electronic_box.yp) annotation(Line(
			points={{30,20},{30,15},{30,7.7},{30,2.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelzn_EBzn.surface_properties1,central_electronic_box.zn) annotation(Line(
			points={{50,10},{45,10},{40,10},{40,0},{35,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelzn_EBzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{70,10},{75,10},{130.7,10},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(central_electronic_box.zp,thermal_conductor_A_Panelzp_EBzp.surface_properties2) annotation(Line(
			points={{25,-10},{20,-10},{10,-10},{10,-30},{5,-30}},
			color={0,0,0},
			thickness=0.0625));
		connect(thermal_conductor_A_Panelzp_EBzp.surface_properties1,panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-15,-30},{-20,-30},{-59.3,-30},{-59.3,-70},{-64.3,-70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnxp.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{20,-30},{15,-30},{-64.3,-30},{-64.3,0},{-69.3,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnxp.surface_properties2,panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{40,-30},{45,-30},{135.7,-30},{135.7,0},{130.7,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnyn.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-55,-25},{-60,-25},{-64.3,-25},{-64.3,0},{-69.3,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnyn.surface_properties2,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-35,-25},{-30,-25},{40.7,-25},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnyp.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-60,20},{-65,20},{-65,10},{-64.3,10},{-64.3,0},{-69.3,
			0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnyp.surface_properties2,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-40,20},{-35,20},{30.7,20},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_xnzp.surface_properties2) annotation(Line(
			points={{-69.3,0},{-64.3,0},{-64.3,-17.3},{-125,-17.3},{-125,-35},{-125,
			-40}},
			thickness=0.0625));
		connect(thermal_radiation_A_xnzp.surface_properties1,panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-125,-60},{-125,-65},{-59.3,-65},{-59.3,-70},{-64.3,-70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{120,95},{125,95},{130.7,95},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xnzn.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{100,95},{95,95},{-64.3,95},{-64.3,0},{-69.3,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpyn.surface_properties1,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{75,-55},{70,-55},{40.7,-55},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpyn.surface_properties2,panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{95,-55},{100,-55},{135.7,-55},{135.7,0},{130.7,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpyp.surface_properties2,panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{95,35},{100,35},{135.7,35},{135.7,0},{130.7,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpyp.surface_properties1,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{75,35},{70,35},{30.7,35},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_xpzn.surface_properties1) annotation(Line(
			points={{130.7,0},{135.7,0},{170,0},{170,25},{175,25}},
			thickness=0.0625));
		connect(thermal_radiation_A_xpzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{195,25},{200,25},{200,70},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpzp.surface_properties2,panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{75,-90},{80,-90},{135.7,-90},{135.7,0},{130.7,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_xpzp.surface_properties1,panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{55,-90},{50,-90},{-59.3,-90},{-59.3,-70},{-64.3,-70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynyp.surface_properties1,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{175,-55},{170,-55},{40.7,-55},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynyp.surface_properties2,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{195,-55},{200,-55},{200,70},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynzn.surface_properties1,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{165,-90},{160,-90},{40.7,-90},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{185,-90},{190,-90},{190,70},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynzp.surface_properties2,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-35,-105},{-30,-105},{40.7,-105},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ynzp.surface_properties1,panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-55,-105},{-60,-105},{-60,-87.7},{-59.3,-87.7},{-59.3,-70},{-64.3,
			-70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ypzn.surface_properties1,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{40,55},{35,55},{30.7,55},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ypzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{60,55},{65,55},{130.7,55},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ypzp.surface_properties1,panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{150,-35},{145,-35},{30.7,-35},{30.7,70},{25.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_ypzp.surface_properties2,panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{170,-35},{175,-35},{175,-70},{-59.3,-70},{-64.3,-70}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_znzp.surface_properties1) annotation(Line(
			points={{-64.3,-70},{-59.3,-70},{215,-70},{215,-75},{220,-75}},
			thickness=0.0625));
		connect(thermal_radiation_A_znzp.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{240,-75},{245,-75},{245,70},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelxn_EBxn.surface_properties1,panel_opt_prop_xn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{-5,10},{-10,10},{-64.3,10},{-64.3,0},{-69.3,0}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelxn_EBxn.surface_properties2,central_electronic_box.xn) annotation(Line(
			points={{15,10},{20,10},{20,2.7},{15,2.7},{15,-5},{20,
			-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_xp.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_Panelxp_EBxp.surface_properties2) annotation(Line(
			points={{130.7,0},{135.7,0},{135.7,15},{100,15},{95,15}},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelxp_EBxp.surface_properties1,central_electronic_box.xp) annotation(Line(
			points={{75,15},{70,15},{45,15},{45,-5},{40,-5}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelyn_EByn.surface_properties2,panel_opt_prop_yn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{15,-55},{20,-55},{40.7,-55},{40.7,-75},{35.7,-75}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelyn_EByn.surface_properties1,central_electronic_box.yn) annotation(Line(
			points={{-5,-55},{-10,-55},{-10,-36.3},{30,-36.3},{30,-17.7},{30,
			-12.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_yp.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_Panelyp_EByp.surface_properties2) annotation(Line(
			points={{25.7,70},{30.7,70},{30.7,35},{20,35},{15,35}},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelyp_EByp.surface_properties1,central_electronic_box.yp) annotation(Line(
			points={{-5,35},{-10,35},{-10,21.3},{30,21.3},{30,7.7},{30,
			2.7}},
			color={255,0,0},
			thickness=0.0625));
		connect(panel_opt_prop_zp.thermal_connector_out_zn_multi.Rad,thermal_radiation_A_Panelzp_EBzp.surface_properties1) annotation(Line(
			points={{-64.3,-70},{-59.3,-70},{-59.3,-57.7},{-75,-57.7},{-75,-45},{-70,
			-45}},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelzp_EBzp.surface_properties2,central_electronic_box.zp) annotation(Line(
			points={{-50,-45},{-45,-45},{20,-45},{20,-10},{25,-10}},
			color={255,0,0},
			thickness=0.0625));
		
		
		connect(thermal_radiation_A_Panelzn_EBzn.surface_properties2,panel_opt_prop_zn.thermal_connector_out_zn_multi.Rad) annotation(Line(
			points={{125,30},{130,30},{130.7,30},{130.7,70},{125.7,70}},
			color={255,0,0},
			thickness=0.0625));
		connect(thermal_radiation_A_Panelzn_EBzn.surface_properties1,central_electronic_box.zn) annotation(Line(
			points={{105,30},{100,30},{40,30},{40,0},{35,0}},
			color={255,0,0},
			thickness=0.0625));
