...
model Panel_opt_prop "Panel_opt_prop.mo"
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop Panel(
		...
		material=iboss.MaterialDatabase.Kohlenstofffasern_Carbon_Panel_tbd(),
		x=0.4,
		y=0.4,
		z=0.02,
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop TSS(
		material=iboss.MaterialDatabase.Kupferlegierungen_Kupfer(),
		x=0.2,
		y=0.2,
		z=0.005,
	...
	iboss.iboss_thermal.components.thermal_element_opt_prop MSS(
		material=iboss.MaterialDatabase.Aluminiumlegierungen_1060_H12(),
		x=0.08,
		y=0.08,
		z=0.04,
