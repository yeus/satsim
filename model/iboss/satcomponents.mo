...
package satcomponents
	model Cubesat
		...
		satcomponents.AOCS.Parts.reactionwheel3axis reactionwheel3axis1 annotation(Placement(
			visible=true,
			transformation(
				origin={22.6012,58.0347},
				extent={{-13.815,-13.815},{13.815,13.815}},
				rotation=0)));
		...
		Modelica.Blocks.Sources.Pulse pulse1[3](
			width={1,1,1},
			period={2000,1000,1500},
			nperiod={1,2,3},
			startTime={2000,2000,2000},
			amplitude={0.001,0.001,0.001}) annotation(Placement(
			visible=true,
			transformation(
				origin={53.1792,25.1445},
				extent={{-10,-10},{10,10}},
				rotation=90)));
		Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r={0,0.04,0.03}) annotation(Placement(
			visible=true,
			transformation(
				origin={-10.1156,58.6705},
				extent={{-10,-10},{10,10}},
				rotation=0)));
		equation
		...
		package dcmodel
			...
			model dcdc_ideal_simple_improved
				...
				dcmodel.dcdc_ideal_simple dcdc_ideal_simple1(
					...
					extent={{-12,-12},{12,12}})));
				equation
					connect(p1,dcdc_ideal_simple1.p1) annotation(Line(points = {{-92,42},{-87,42},{-21,42},{-21,13},{-16,13}}));
					v1 = p1.v - n1.v;
					v2 = p2.v - n2.v;
					i1 = p1.i;
					i2 = p2.i;
					connect(dcdc_ideal_simple1.p2,p2) annotation(Line(points = {{8,13},{13,13},{88,13},{88,42},{93,42}}, thickness = 0.0625));
					connect(dcdc_ideal_simple1.n2,n2) annotation(Line(points = {{8,1},{13,1},{88,1},{88,-47},{93,-47}}, thickness = 0.0625));
					connect(dcdc_ideal_simple1.n1,n1) annotation(Line(points = {{-16,1},{-21,1},{-88,1},{-88,-32},{-93,-32}}, thickness = 0.0625));
				annotation(
					Icon(
						coordinateSystem(extent={{-100,-100},{100,100}}),
			...
			package examples
				...
				model dcdc_pid_jump
					...
					dcdc_pid dcdc_pid1(
						P_out=100,
						V_out=20,
						V_in_min=22) annotation(Placement(transformation(extent={{-40,10},{-20,30}})));
					Modelica.Electrical.Analog.Sources.TrapezoidVoltage trapezoidVoltage1(
						V=100,
						rising=0.5,
						width=3,
						falling=0.5,
						...
						rotation=-90)));
					equation
						connect(resistor1.n,ground1.p) annotation(Line(points = {{0,-7},{-5,-7},{-37,-7},{-37,-23},{-37,-28}}));
						connect(dcdc_pid1.n2,dcdc_pid1.n1) annotation(Line(points = {{-20.66667175292969,15.33333587646484},{-16,15},{-16,5},{-44,5},{-44,16},{-39.33333587646484,16}}, thickness = 0.0625), AutoRoute = false);
						connect(dcdc_pid1.n1,ground1.p) annotation(Line(points = {{-39,16},{-44,16},{-44,-3},{-37,-3},{-37,-23},{-37,-28}}, thickness = 0.0625));
						connect(dcdc_pid1.p2,resistor1.p) annotation(Line(points = {{-21,24},{-16,24},{29,24},{29,-7},{24,-7}}, thickness = 0.0625));
						connect(trapezoidVoltage1.p,dcdc_pid1.p1) annotation(Line(points = {{-70,25},{-70,30},{-57,30},{-57,24},{-44,24},{-39,24}}, thickness = 0.0625));
						connect(dcdc_pid1.n1,trapezoidVoltage1.n) annotation(Line(points = {{-39,16},{-44,16},{-44,0},{-70,0},{-70,5}}, thickness = 0.0625));
					annotation(
						resistor1(
							v(flags=2),
							i(flags=2),
	...
	package AOCS
		model freerotatingcube
			...
			equation
				connect(iMU1.frame_a,bodybox1.frame_b) annotation(Line(
					points={{45,15},{40,15},{25.3,15},{25.3,17.7},{20.3,17.7}},
					color={95,95,95},
					thickness=0.0625));
			annotation(
				iMU1(
		...
		model cubesatwith3axisreactionwheel
			...
			Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(
				useQuaternions=false,
				w_rel_a_start={3.0,0,0}) annotation(Placement(
				visible=true,
				transformation(
					origin={-44.2197,45.3757},
					extent={{-10,-10},{10,10}},
		...
		package Parts
			...
			model IMU
				...
				iboss.satcomponents.blocks.noise_ung noise_ung2(
					amplitude=noiseamp,
					seed=2+id) annotation(Placement(transformation(extent={{-40,14},{-19,25}})));
				iboss.satcomponents.blocks.noise_ung noise_ung1(
					amplitude=noiseamp,
					seed=1+id) annotation(Placement(transformation(extent={{-40,29},{-19,40}})));
				iboss.satcomponents.blocks.noise_ung noise_ung3(
					amplitude=noiseamp,
				...
				equation
					...
					connect(absoluteangularvelocity1.w,add1.u2) annotation(Line(
						points={{-19,-5.3},{-14,-5.3},{-7,-5.3},{-7,-6},{-2,-6}},
						color={0,0,127},
						thickness=0.0625));
					connect(noise_ung2.y,add1[2].u1) annotation(Line(
						points={{-18,19.3},{-13,19.3},{-7,19.3},{-7,6},{-2,6}},
						color={0,0,127},
						thickness=0.015625));
					connect(noise_ung1.y,add1[1].u1) annotation(Line(
						points={{-18,34.3},{-13,34.3},{-7,34.3},{-7,6},{-2,6}},
						color={0,0,127},
						thickness=0.015625));
					connect(noise_ung3.y,add1[3].u1) annotation(Line(
						points={{-19.3,49.3},{-14.3,49.3},{-7,49.3},{-7,6},{-2,6}},
						color={0,0,127},
						thickness=0.015625));
					connect(fixedDelay1.y,acs_bus.w[id,:]) annotation(Line(
						points={{66,0},{71,0},{95,0},{100,0}},
						color={0,0,127},
						thickness=0.0625));
					connect(add1.y,sampler1.u) annotation(Line(
						points={{21,0},{26,0},{23,0},{28,0}},
						color={0,0,127},
						thickness=0.0625));
					connect(sampler1.y,fixedDelay1.u) annotation(Line(
			...
			model IMU_no_sam_delay
				...
				equation
					...
					connect(add1.y,acs_bus.w[id,:]) annotation(Line(
						points={{21,0},{26,0},{95,0},{100,0}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					noise_ung2(y(flags=2)),
		...
		package ctrl
			model ACS
				...
				equation
					connect(pulse1.y,acs_bus.w_a[4,1]) annotation(Line(
						points={{16,-10},{21,-10},{85,-10},{85,15},{90,15}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					viewinfo[0](
...
bus",
			...
			model ACS_P
				...
				equation
					...
					points={{-39,20},{-34,20},{-27,20},{-27,21},{-22,21}},
					color={0,0,127},
					thickness=0.0625));
					connect(error.y,gain1.u) annotation(Line(
						points={{1,15},{6,15},{8,15},{13,15}},
						color={0,0,127},
						thickness=0.0625));
					connect(error.u2,acs_bus.w[1,:]) annotation(
						Line(
							points={{-22,9},{-27,9},{-27,-15},{85,-15},{85,15},{90,
							15}},
							color={0,0,127},
							thickness=0.0625),
						AutoRoute=false);
					connect(gain1.y,product1.u2) annotation(Line(
						points={{36,15},{41,15},{43,15},{43,14},{48,14}},
						color={0,0,127},
						thickness=0.0625));
					connect(product1.y,acs_bus.w_a[1,:]) annotation(Line(
						points={{71,20},{76,20},{85,20},{85,15},{90,15}},
						color={0,0,127},
						thickness=0.0625));
					connect(step1.y,product1.u1) annotation(Line(
						points={{31,50},{36,50},{43,50},{43,26},{48,26}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					error(y(flags=2)),
			...
			model ACS_PID
				...
				Modelica.Blocks.Continuous.LimPID PID[3](
					...
					k=2,
					yMax=2,
					strict=true) annotation(Placement(transformation(extent={{-10,40},{10,60}})));
				Modelica.Blocks.Discrete.Sampler sampler1[3](
					samplePeriod=0.1,
					startTime=3) annotation(Placement(transformation(extent={{30,40},{50,60}})));
				equation
					connect(const.y,PID.u_s) annotation(Line(
						points={{-54,50},{-49,50},{-17,50},{-12,50}},
						color={0,0,127},
						thickness=0.0625));
					connect(PID.u_m,acs_bus.w[1,:]) annotation(
						Line(
							points={{20,13},{20,-10},{85,-10},{90,15}},
							color={0,0,127},
							thickness=0.0625),
						AutoRoute=false);
					connect(PID.y,sampler1.u) annotation(Line(
						points={{11,50},{16,50},{23,50},{28,50}},
						color={0,0,127},
						thickness=0.0625));
					connect(sampler1.y,acs_bus.w_a[1,:]) annotation(Line(
						points={{51,50},{56,50},{85,50},{85,15},{90,15}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					viewinfo[2](
		...
		model momentum_add "momentum_add"
			...
			equation
				connect(world.frame_b,freeMotion1.frame_a) annotation(Line(
					points={{-90,75},{-85,75},{-55,75},{-50,75}},
					color={95,95,95},
					thickness=0.0625));
				connect(freeMotion1.frame_b,bodyBox1.frame_a) annotation(Line(
					points={{-30,75},{-25,75},{20,75},{25,75}},
					color={95,95,95},
					thickness=0.0625));
				connect(world.frame_b,freeMotion2.frame_a) annotation(Line(
					points={{-90,75},{-85,75},{-50,75},{-50,-5},{-45,-5}},
					color={95,95,95},
					thickness=0.0625));
				connect(freeMotion2.frame_b,bodyBox2.frame_a) annotation(Line(
					points={{-25,-5},{-20,-5},{25,-5},{30,-5}},
					color={95,95,95},
					thickness=0.0625));
				connect(bodyBox2.frame_b,reactionwheelsimple_noelectricity2.frame_a) annotation(Line(
					points={{50,-5},{55,-5},{95,-5},{95,5},{95,10}},
					color={95,95,95},
					thickness=0.0625));
				connect(bodyBox1.frame_b,reactionwheelsimple_noelectricity1.frame_a) annotation(Line(
					points={{45,75},{50,75},{70,75},{70,80}},
					color={95,95,95},
					thickness=0.0625));
				connect(reactionwheelsimple_noelectricity3.frame_a,bodyBox2.frame_a) annotation(Line(
					points={{0,10},{0,5},{0,-5},{25,-5},{30,-5}},
					color={95,95,95},
					thickness=0.0625));
				
				connect(pulse1.y,reactionwheelsimple_noelectricity2.acs_bus.w_a[3,3]) annotation(Line(
					points={{144,55},{139,55},{110,55},{110,20},{105,20}},
					color={0,0,127},
					thickness=0.0625));
				connect(pulse1.y,reactionwheelsimple_noelectricity3.acs_bus.w_a[2,3]) annotation(Line(
					points={{144,55},{139,55},{15,55},{15,20},{10,20}},
					color={0,0,127},
					thickness=0.0625));
				connect(pulse1.y,reactionwheelsimple_noelectricity1.acs_bus.w_a[1,3]) annotation(Line(
					points={{144,55},{139,55},{85,55},{85,92},{80,92}},
					color={0,0,127},
					thickness=0.0625));
			annotation(
				bodyBox1(body(
					...
					Icon(
						...
						graphics={
							Rectangle(
								...
								fillColor={255,255,255},
								fillPattern=FillPattern.Solid,
								extent={{-80,56.7},{53.3,-40}}),
							Line(
								points={{-70,-20},{-66.7,20},{-66.7,-3.3},{-63.3,3.3},{-63.3,0},{-63.3,
								10},{-60,-3.3},{-56.7,16.7},{-56.7,-13.3},{-53.3,36.7},{-50,-3.3},{-50,
								10},{-46.7,-10},{-43.3,6.7},{-43.3,-3.3},{-36.7,-23.3},{-36.7,-10},{-33.3,
								-3.3},{-30,-10},{-30,-3.3},{-30,30},{-26.7,30},{-20,6.7},{-20,
								-13.3},{-16.7,-16.7},{-16.7,3.3},{-13.3,-10},{-13.3,3.3},{-13.3,-16.7},{-13.3,
								43.3},{-10,-16.7},{-6.7,-6.7},{-6.7,-13.3},{-3.3,16.7},{-3.3,-3.3},{-3.3,
								3.3},{0,-10},{3.3,-13.3},{6.7,23.3},{10,6.7},{13.3,0},{16.7,
								-6.7},{16.7,-16.7},{16.7,-3.3},{20,-23.3},{23.3,-6.7},{23.3,-3.3},{33.3,
								-23.3},{33.3,6.7},{36.7,6.7},{40,10},{43.3,46.7},{40,-10},{40,
								-13.3},{43.3,0},{46.7,10},{50,-6.7},{50,3.3},{53.3,13.3}},
								color={0,0,0})}),
					experiment(
						StopTime=1,
						StartTime=0));
...
91C591BEB7F3423C85EE84795B5D0B8EDF4FB69EC7A23BF687CCBE2C6AC29EC8DCA12BC9BE6A7F9C7F53FE1F000000FFFF",
																				color={0,0,0})}),
				experiment(
					StopTime=1,
					StartTime=0));
