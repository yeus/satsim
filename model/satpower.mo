                ...
                annotation(
                        ...
                        Diagram(
                                coordinateSystem(
                                        ...
                                        extent={{-100,-100},{100,100}},
                                        grid={2,2}),
                                graphics={Line(points = {{0,80},{-8,80}}, color = {192,192,192}),Line(points = {{0,-80},{-8,-80}}, color = {192,192,192}),Line(points = {{0,-90},{0,84}}, color = {192,192,192}),Text(extent = {{9,100},{40,80}}, lineColor = {160,160,164}, textString = "y"),Polygon(points = {{0,100},{-6,84},{6,84},{0,100}}, lineColor = {192,192,192}, fillColor = {192,192,192}, fillPattern = FillPattern.Solid),Line(points = {{-100,-80.3976},{84,-80.3976}}, color = {192,192,192}),Polygon(points = {{100,-80.3976},{84,-74.3976},{84,-86.3976},{100,-80.3976}}, lineColor = {192,192,192}, fillColor = {192,192,192}, fillPattern = FillPattern.Solid),Line(points = {{-80,-80},{-31,-77.9},{-6.03,-74},{10.9,-68.4},{23.7,-61},{34.2,-51.6},{43,-40.3},{50.3,-27.8},{56.7,-13.5},{62.3,2.23},{67.1,18.6},{72,38.2},{76,57.6},{80,80}}, color = {0,0,0}),Text(extent = {{-31,72},{-11,88}}, textString = "20", lineColor = {0,0,255}),Text(extent = {{-92,-83},{-72,-103}}, textString = "-3", lineColor = {0,0,255}),Text(extent 
= {{70,-83},{90,-103}}, 
textString = "3", lineColor = {0,0,255}),Text(extent = {{-18,-53},{2,-73}}, textString = "1", lineColor = {0,0,255}),Text(extent = {{66,-52},{96,-72}}, lineColor = {160,160,164}, textString = "u")}));
        end Exprgenerator;
        ...
        model solarcell
                ...
                parameter Real A_cell(
                        quantity="Area",
                        unit="m2")=0.0026 "Active area of the solar cell in cmÂ²";
                ...
                equation
                        ...
                        //i=10.0-0.01*(exp(v)-1);
                annotation(
                        Icon(graphics={Ellipse(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-48.9392,47.8076},{46.6761,-50.0707}}),Line(points = {{-78.3593,89.1089},{-41.5842,46.6761},{-43.5644,60.5375},{-41.867,46.6761},{-53.7482,50.0707}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-56.5771,92.2207},{-26.8741,55.7284},{-37.9066,59.4059},{-27.4399,56.0113},{-27.7228,66.1952}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-89.6747,0.282885},{-19.5191,0.282885}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{89.6747,0.282885},{5.09194,0.282885}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-18.3876,-37.3409},{-18.3876,40.1697}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness 
= 0.25),Line(points = 
{{4.24328,-17.5389},{4.24328,18.6704}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{76.9449,-20.3678},{76.9449,-52.6167}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{63.3664,-35.6436},{90.2405,-35.6436}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-92.2207,-34.512},{-66.4781,-34.512}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25)}),
                        Diagram);
        end solarcell;
        model solarcell_simple_characteristic
                ...
                solar_power.solarcell_simple solarcell_simple2(
                        N_p=50,
                        Maxexp=16,
                        R_sh=10) annotation(Placement(transformation(
                        origin={-42.562,39.2562},
                        extent={{12,-12},{-12,12}},
                        rotation=90)));
                equation
                        ...
                        connect(solarcell_simple2.p,ground1.p) annotation(Line(points={{-42.562,27.2562},{11.9835,27.2562},{11.9835,25.6853},{11.7392,25.6853}}));
                        connect(variableresistor1.R,exprgenerator1.y) annotation(Line(points={{51.3913,52.3255},{51.3913,51.6529},{79.33880000000001,51.6529},{79.33880000000001,13.6364},{50.88,13.6364},{50.88,
                        13.9932}}));
        ...
        model solarcell_simple
                ...
                constant Real E0(
                        ...
                        extent={{-12,-12},{12,12}})));
                SIunits.CurrentDensity i_sc_actual annotation(Placement(transformation(
                        origin={65.7025,66.1157},
                        extent={{-12,-12},{12,12}})));
                ...
                SIunits.Current i_sc=A_cell * N_p * I_sc annotation(Placement(transformation(
                        origin={69.4215,67.76860000000001},
                        extent={{-12,-12},{12,12}})));
                Modelica.Electrical.Analog.Basic.Resistor R_series(R=0.00001) annotation(Placement(transformation(
                        origin={62,-2},
                        extent={{-12,-12},{12,12}})));
                ...
                parameter SIunits.Resistance R_sh=10000 annotation(Placement(transformation(
                        ...
                        extent={{-12,-12},{12,12}})));
                SIunits.Current i annotation(Placement(transformation(
                ...
                equation
                        connect(I_photonic.p,D_shunt.n) annotation(Line(
                                points={{-43,-9},{-43,-14},{-13,-14},{-13,-9}},
                                thickness=0.0625));
                        connect(D_shunt.n,R_shunt.n) annotation(Line(
                                points={{-13,-9},{-13,-14},{22,-14},{22,-9}},
                                thickness=0.0625));
                        connect(R_shunt.p,R_series.p) annotation(
                                Line(
                                        points={{22,15},{22,20},{45,20},{45,-2},{50,-2}},
                                        thickness=0.0625),
                                AutoRoute=false);
                        connect(R_series.n,n) annotation(Line(
                                points={{74,-2},{79,-2},{95,-2},{95,0},{100,0}},
                                thickness=0.0625));
                        connect(R_shunt.p,D_shunt.p) annotation(Line(
                                points={{22,15},{22,20},{-13,20},{-13,15}},
                                thickness=0.0625));
                        connect(D_shunt.p,I_photonic.n) annotation(Line(
                                points={{-13,15},{-13,20},{-43,20},{-43,15}},
                                thickness=0.0625));
                        connect(I_photonic.p,p) annotation(Line(
                                points={{-43,-9},{-43,-14},{-69,-14},{-69,0},{-95,0},{-100,
                                0}},
                                thickness=0.0625));
                annotation(
                        Icon(
                                ...
                                graphics={
                                                                        Ellipse(
                                                                                fillColor={0,0,255},
                                                                                extent={{-48.9392,47.8076},{46.6761,-50.0707}}),
                                                                        Line(
                                                                                points={{-78.35930000000001,89.10890000000001},{-41.5842,46.6761},{-43.5644,60.5375},{-41.867,46.6761},{-53.7482,50.0707}}),
                                                                        Line(
                                                                                points={{-56.5771,92.22069999999999},{-26.8741,55.7284},{-37.9066,59.4059},{-27.4399,56.0113},{-27.7228,66.1952}}),
                                                                        Line(
                                                                                points={{-89.6747,0.282885},{-19.5191,0.282885}}),
                                                                        Line(
                                                                                points={{89.6747,0.282885},{5.09194,0.282885}}),
                                                                        Line(
                                                                                points={{-18.3876,-37.3409},{-18.3876,40.1697}}),
                                                                        Line(
                                                                                points={{4.24328,-17.5389},{4.24328,18.6704}}),
                                                                        Line(
                                                                                points={{76.9449,-20.3678},{76.9449,-52.6167}}),
                                                                        Line(
                                                                                points={{63.3664,-35.6436},{90.2405,-35.6436}}),
                                                                        Line(
                                                                                points={{-92.22069999999999,-34.512},{-66.4781,-34.512}})}),
