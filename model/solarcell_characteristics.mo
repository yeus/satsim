model solarcell_characteristic
  ...
  Exprgenerator exprgenerator1(alpha = 0.00001) annotation(Placement(visible = true, transformation(origin = {-27.0451,4.34057}, extent = {{-12,-12},{12,12}}, rotation = 0)));
equation
  connect(exprgenerator1.y,variableresistor1.R) annotation(Line(points = {{-13.8451,4.34057},{10.6845,4.34057},{10.6845,8.28543},{11.8985,8.28543}}));
