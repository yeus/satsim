  ...
  package buildingblocks
    ...
    package examples
      ...
      equation
        ...
        annotation(timetable1(y(flags = 2)), vb(OBC(LossPower(flags = 2), T_heatPort(flags = 2), pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2))), imu(add1(y(flags = 2)), noise_ung2(y(flags = 2)), noise_ung1(y(flags = 2)), noise_ung3(y(flags = 2)), y(flags = 2)), heatcapacitor1(T(flags = 2), der_T(flags = 2), port(T(flags = 2), Q_flow(flags = 2))), fixedtemperature1(port(T(flags = 2), Q_flow(flags = 2))), bodyradiation1(Q_flow(flags = 2), dT(flags = 2), port_a(T(flags = 2), Q_flow(flags = 2)), port_b(T(flags = 2), Q_flow(flags = 2))), ground1(p(v(flags = 2), i(flags = 2))), dcdc_ideal_simple1(v1(flags = 2), v2(flags = 2), i1(flags = 2), i2(flags = 2), p1(v(flags = 2), i(flags = 2)), n1(v(flags = 2), i(flags = 2)), p2(v(flags = 2), i(flags = 2)), n2(v(flags = 2), i(flags = 2))), thermometer_withnoise1(T(flags = 2), port(T(flags = 2), Q_flow(flags = 2)), add1(y(flags = 2)), temperaturesensor1(T(flags = 2), port(T(flags = 2), Q_flow(flags = 2))), noise_ung(y(flags = 2))), iXp(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), iXn(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), iYp(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), iYn(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), iZp(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), iZn(vcc_ext(v(flags = 2), i(flags = 2)), gnd_ext(v(flags = 2), i(flags = 2)), gnd_int(v(flags = 2), i(flags = 2)), vcc_int(v(flags = 2), i(flags = 2)), comm_out(mi_pos(flags = 2), v_ext(flags = 2), v_int(flags = 2), intf_current(flags = 2), tmp(flags = 2)), v_motor(v(flags = 2), i(flags = 2)), gnd_motor(v(flags = 2), i(flags = 2)), mi(pin_p(v(flags = 2), i(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pos_sens(flags = 2), bearingfriction1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), w_relfric(flags = 2), a_relfric(flags = 2), tau0(flags = 2), tau0_max(flags = 2), free(flags = 2), sa(flags = 2), startForward(flags = 2), startBackward(flags = 2), locked(flags = 2), mode(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2), phi(flags = 2), tau(flags = 2), w(flags = 2), a(flags = 2)), inertia1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), pos(flange(phi(flags = 2), tau(flags = 2)), phi(flags = 2)), onoffidlecontroller1(y(flags = 2)), lessthreshold1(y(flags = 2)), greaterthreshold1(y(flags = 2)), dcpm(phiMechanical(flags = 2), wMechanical(flags = 2), tauElectrical(flags = 2), tauShaft(flags = 2), flange(phi(flags = 2), tau(flags = 2)), inertiaRotor(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), support(phi(flags = 2), tau(flags = 2)), inertiaStator(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), phi(flags = 2), w(flags = 2), a(flags = 2)), fixed(flange(phi(flags = 2), tau(flags = 2))), friction(flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), va(flags = 2), ia(flags = 2), pin_ap(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), ra(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), la(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2))), brush(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2)), core(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2)), lossPower(flags = 2), Gc(flags = 2)), strayLoad(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi(flags = 2), tau(flags = 2), w(flags = 2), heatPort(T(flags = 2)), lossPower(flags = 2)), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), thermalAmbient(Q_flowArmature(flags = 2), Q_flowCore(flags = 2), Q_flowStrayLoad(flags = 2), Q_flowFriction(flags = 2), Q_flowBrush(flags = 2), thermalPort(heatPortArmature(T(flags = 2), Q_flow(flags = 2)), heatPortCore(T(flags = 2), Q_flow(flags = 2)), heatPortStrayLoad(T(flags = 2), Q_flow(flags = 2)), heatPortFriction(T(flags = 2), Q_flow(flags = 2)), heatPortBrush(T(flags = 2), Q_flow(flags = 2)), heatPortPermanentMagnet(T(flags = 2), Q_flow(flags = 2))), temperatureArmature(port(T(flags = 2), Q_flow(flags = 2))), temperatureCore(port(T(flags = 2), Q_flow(flags = 2))), temperatureStrayLoad(port(T(flags = 2), Q_flow(flags = 2))), temperatureFriction(port(T(flags = 2), Q_flow(flags = 2))), constTa(y(flags = 2)), temperatureBrush(port(T(flags = 2), Q_flow(flags = 2))), Q_flowPermanentMagnet(flags = 2), Q_flowTotal(flags = 2), temperaturePermanentMagnet(port(T(flags = 2), Q_flow(flags = 2))), constTpm(y(flags = 2))), airGapDC(w(flags = 2), vei(flags = 2), ie(flags = 2), psi_e(flags = 2), vai(flags = 2), ia(flags = 2), tauElectrical(flags = 2), flange(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), pin_ap(v(flags = 2), i(flags = 2)), pin_ep(v(flags = 2), i(flags = 2)), pin_an(v(flags = 2), i(flags = 2)), pin_en(v(flags = 2), i(flags = 2))), eGround(p(v(flags = 2), i(flags = 2))), ie(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)))), hbridge1(idealclosingswitch4(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch3(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), idealclosingswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), pin_n(v(flags = 2), i(flags = 2)), pin_p(v(flags = 2), i(flags = 2)), pin_p1(v(flags = 2), i(flags = 2)), pin_n1(v(flags = 2), i(flags = 2)), ground1(p(v(flags = 2), i(flags = 2))), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), or1(y(flags = 2)), idealopeningswitch2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2))), idealgear1(flange_a(phi(flags = 2), tau(flags = 2)), flange_b(phi(flags = 2), tau(flags = 2)), support(phi(flags = 2), tau(flags = 2)), phi_a(flags = 2), phi_b(flags = 2)), noise_ung1(y(flags = 2)), add1(y(flags = 2))), v_int(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), idealopeningswitch1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2)), resistor1(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), v_ext(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2)), resistor2(v(flags = 2), i(flags = 2), p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), heatPort(T(flags = 2), Q_flow(flags = 2)), LossPower(flags = 2), T_heatPort(flags = 2), R_actual(flags = 2)), intf_current(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), i(flags = 2))), sim_out(intf(mi_pos(flags = 2), v_ext(flags = 2)))), experiment(StopTime = 100, StartTime = 0));
      end verosim_block;
      ...
      equation
        ...
        annotation(iboss_vti_battery1(imu(noise_ung2(y(flags = 2)), noise_ung1(y(flags = 2)), noise_ung3(y(flags = 2))), thermometer_withnoise1(noise_ung(y(flags = 2))), iXp(mi(noise_ung1(y(flags = 2)))), iXn(mi(noise_ung1(y(flags = 2)))), iYp(mi(noise_ung1(y(flags = 2)))), iYn(mi(noise_ung1(y(flags = 2)))), iZp(mi(noise_ung1(y(flags = 2)))), iZn(mi(noise_ung1(y(flags = 2)))), vsource(v(flags = 2), soc(flags = 2))), experiment(StopTime = 100, StartTime = 0));
      end verosim_block_battery;

      model iboss_vti3 "iboss_vti3"
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[1]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 855.5}, {-80, 895.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[2]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 805.5}, {-80, 845.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[3]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 755.5}, {-80, 795.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[4]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 705.5}, {-80, 745.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[5]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 655.5}, {-80, 695.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'set_mi_pos[6]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 605.5}, {-80, 645.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[1]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 555.5}, {-80, 595.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[2]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 505.5}, {-80, 545.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[3]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 455.5}, {-80, 495.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[4]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 405.5}, {-80, 445.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[5]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 355.5}, {-80, 395.5}})));
        input Modelica.Blocks.Interfaces.BooleanInput 'set_ei_state[6]' "'input Boolean' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 305.5}, {-80, 345.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[1]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 255.5}, {-80, 295.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[2]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 205.5}, {-80, 245.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[3]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 155.5}, {-80, 195.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[4]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 105.5}, {-80, 145.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[5]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 55.5}, {-80, 95.5}})));
        input Modelica.Blocks.Interfaces.IntegerInput 'set_oci_state[6]' "'input Integer' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, 5.5}, {-80, 45.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'sim_ddr[1]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, -44.5}, {-80, -4.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'sim_ddr[2]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, -94.5}, {-80, -54.5}})));
        input Modelica.Blocks.Interfaces.RealInput 'sim_ddr[3]' "'input Real' as connector" annotation(Placement(transformation(extent = {{-20, -20}, {20, 20}}), iconTransformation(extent = {{-120, -144.5}, {-80, -104.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 865.5}, {110, 885.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 815.5}, {110, 835.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 765.5}, {110, 785.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 715.5}, {110, 735.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 665.5}, {110, 685.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 615.5}, {110, 635.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 565.5}, {110, 585.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 515.5}, {110, 535.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 465.5}, {110, 485.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 415.5}, {110, 435.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 365.5}, {110, 385.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 315.5}, {110, 335.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 265.5}, {110, 285.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 215.5}, {110, 235.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 165.5}, {110, 185.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 115.5}, {110, 135.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 65.5}, {110, 85.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, 15.5}, {110, 35.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -34.5}, {110, -14.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -84.5}, {110, -64.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -134.5}, {110, -114.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -184.5}, {110, -164.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -234.5}, {110, -214.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -284.5}, {110, -264.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -334.5}, {110, -314.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.comm_out.mi_pos' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -384.5}, {110, -364.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.comm_out.v_ext' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -434.5}, {110, -414.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.comm_out.v_int' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -484.5}, {110, -464.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.comm_out.intf_current' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -534.5}, {110, -514.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.comm_out.tmp' "'output Real' as connector" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -584.5}, {110, -564.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXp.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -634.5}, {110, -614.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iXn.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -684.5}, {110, -664.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYp.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -734.5}, {110, -714.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iYn.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -784.5}, {110, -764.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZp.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -834.5}, {110, -814.5}})));
        output Modelica.Blocks.Interfaces.RealOutput 'iZn.mi.inertia1.phi' "Absolute rotation angle of component" annotation(Placement(transformation(extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{90, -884.5}, {110, -864.5}})));
        ...
        parameter Real tc(quantity = "Basics.Time", displayUnit = "ms") = 0.01 "Communication Step Size";
        ...
        parameter Real timeout(quantity = "Basics.Time", displayUnit = "s") = 10 "FMU Timeout" annotation(Dialog(tab = "FMI"));
      ...
      protected
        ...
        function SetDebugLogging
          ...
          external "C" status = iboss_vti_fmiSetDebugLogging(fmu, loggingOn) annotation(Library = "iboss_vti");
        end SetDebugLogging;
        ...
        function SetReal
          ...
          external "C" status = iboss_vti_fmiSetReal(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end SetReal;
        ...
        function GetReal
          ...
          external "C" status = iboss_vti_fmiGetReal(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end GetReal;
        ...
        function SetInteger
          ...
          external "C" status = iboss_vti_fmiSetInteger(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end SetInteger;
        ...
        function GetInteger
          ...
          external "C" status = iboss_vti_fmiGetInteger(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end GetInteger;
        ...
        function SetBoolean
          ...
          external "C" status = iboss_vti_fmiSetBoolean(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end SetBoolean;
        ...
        function GetBoolean
          ...
          external "C" status = iboss_vti_fmiGetBoolean(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end GetBoolean;
        ...
        function SetString
          ...
          external "C" status = iboss_vti_fmiSetString(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end SetString;
        ...
        function GetString
          ...
          external "C" status = iboss_vti_fmiGetString(fmu, vr, nvr, value) annotation(Library = "iboss_vti");
        end GetString;
        ...
        function InitializeSlave
          ...
          external "C" status = iboss_vti_fmiInitializeSlave(fmu, tStart, StopTimeDefined, tStop) annotation(Library = "iboss_vti");
        end InitializeSlave;
        ...
        function TerminateSlave
          ...
          external "C" status = iboss_vti_fmiTerminateSlave(fmu) annotation(Library = "iboss_vti");
        end TerminateSlave;
        ...
        function DoStep
          ...
          external "C" status = iboss_vti_fmiDoStep(fmu, currentCommunicationPoint, communicationStepSize, newStep) annotation(Library = "iboss_vti");
        end DoStep;
      ...
      algorithm
        when initial() then
          ...
          if noEvent(initCalled < 1) then
            ...
            ret := SetReal(fmu, {1073741824}, 1, {'m'});
            ...
            ret := SetReal(fmu, {536870912, 536870913, 536870914, 536870915, 536870916, 536870917, 536870918, 536870919, 536870920}, 9, {'set_mi_pos[1]', 'set_mi_pos[2]', 'set_mi_pos[3]', 'set_mi_pos[4]', 'set_mi_pos[5]', 'set_mi_pos[6]', 'sim_ddr[1]', 'sim_ddr[2]', 'sim_ddr[3]'});
            ...
            ret := SetInteger(fmu, {536870918, 536870919, 536870920, 536870921, 536870922, 536870923}, 6, {'set_oci_state[1]', 'set_oci_state[2]', 'set_oci_state[3]', 'set_oci_state[4]', 'set_oci_state[5]', 'set_oci_state[6]'});
          ...
          real_in_l := {'set_mi_pos[1]', 'set_mi_pos[2]', 'set_mi_pos[3]', 'set_mi_pos[4]', 'set_mi_pos[5]', 'set_mi_pos[6]', 'sim_ddr[1]', 'sim_ddr[2]', 'sim_ddr[3]'};
          int_in_l := {'set_oci_state[1]', 'set_oci_state[2]', 'set_oci_state[3]', 'set_oci_state[4]', 'set_oci_state[5]', 'set_oci_state[6]'};
          boolean_in_l := {'set_ei_state[1]', 'set_ei_state[2]', 'set_ei_state[3]', 'set_ei_state[4]', 'set_ei_state[5]', 'set_ei_state[6]'};
        end when;
      ...
      equation
        real_out = {'iXp.comm_out.mi_pos', 'iXp.comm_out.v_ext', 'iXp.comm_out.v_int', 'iXp.comm_out.intf_current', 'iXp.comm_out.tmp', 'iXn.comm_out.mi_pos', 'iXn.comm_out.v_ext', 'iXn.comm_out.intf_current', 'iXn.comm_out.v_int', 'iXn.comm_out.tmp', 'iYp.comm_out.mi_pos', 'iYp.comm_out.v_ext', 'iYp.comm_out.v_int', 'iYp.comm_out.intf_current', 'iYp.comm_out.tmp', 'iYn.comm_out.mi_pos', 'iYn.comm_out.v_ext', 'iYn.comm_out.v_int', 'iYn.comm_out.intf_current', 'iYn.comm_out.tmp', 'iZp.comm_out.mi_pos', 'iZp.comm_out.v_ext', 'iZp.comm_out.v_int', 'iZp.comm_out.intf_current', 'iZp.comm_out.tmp', 'iZn.comm_out.mi_pos', 'iZn.comm_out.v_ext', 'iZn.comm_out.v_int', 'iZn.comm_out.intf_current', 'iZn.comm_out.tmp', 'iXp.mi.inertia1.phi', 'iXn.mi.inertia1.phi', 'iYp.mi.inertia1.phi', 'iYn.mi.inertia1.phi', 'iZp.mi.inertia1.phi', 'iZn.mi.inertia1.phi'};
        annotation(Icon(coordinateSystem(extent = {{-100, -925.5}, {100, 925.5}}), graphics = {Rectangle(lineColor = {0, 0, 0}, extent = {{-92, -917.5}, {92, 917.5}})}));
      end iboss_vti3;

      iboss_vti3 iboss_vti1;
      annotation(dateModified = "2015-07-10 12:25:34Z", experiment(StopTime = 1, StartTime = 0));
    end examples;
    ...
    equation
      ...
      annotation(imu(noise_ung2(y(flags = 2)), noise_ung1(y(flags = 2)), noise_ung3(y(flags = 2))), thermometer_withnoise1(noise_ung(y(flags = 2))), iXp(mi(noise_ung1(y(flags = 2)))), iXn(mi(noise_ung1(y(flags = 2)))), iYp(mi(noise_ung1(y(flags = 2)))), iYn(mi(noise_ung1(y(flags = 2)))), iZp(mi(noise_ung1(y(flags = 2)))), iZn(mi(noise_ung1(y(flags = 2)))), experiment(StopTime = 1, StartTime = 0));
    end iboss_vti;
    ...
    equation
      connect(vsource.p, dcdc_ideal_simple1.p1) annotation(Line(points = {{-75, -39}, {-70, -39}, {-27, -39}, {-27, -41}, {-22, -41}}, thickness = 0.0625));
      connect(vsource.n, ground1.p) annotation(Line(points = {{-75, -49}, {-70, -49}, {-44, -49}, {-44, -59}, {-44, -64}}, thickness = 0.0625));
      annotation(imu(noise_ung2(y(flags = 2)), noise_ung1(y(flags = 2)), noise_ung3(y(flags = 2))), thermometer_withnoise1(noise_ung(y(flags = 2))), iXp(mi(noise_ung1(y(flags = 2)))), iXn(mi(noise_ung1(y(flags = 2)))), iYp(mi(noise_ung1(y(flags = 2)))), iYn(mi(noise_ung1(y(flags = 2)))), iZp(mi(noise_ung1(y(flags = 2)))), iZn(mi(noise_ung1(y(flags = 2)))), experiment(StopTime = 100, StartTime = 0, Tolerance = 1e-012));
