package ibossmo
  package components
    ...
    model iboss_interface
      ...
      Intcomm comm annotation(Placement(visible = true, transformation(origin = {-100, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-102, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(v_int.v, comm.v_int) annotation(Line(points = {{-65, -31}, {-72, -31}, {-72, 70}, {-96, 70}, {-96, 70}}, color = {0, 0, 127}));
      connect(v_ext.v, comm.v_ext) annotation(Line(points = {{27, -31}, {34, -31}, {34, 70}, {-96, 70}, {-96, 70}}, color = {0, 0, 127}));
      connect(intf_current.i, comm.intf_current) annotation(Line(points = {{0, 38}, {0, 38}, {0, 70}, {-96, 70}, {-96, 70}}, color = {0, 0, 127}));
      connect(comm.set_pos, m_int1.target_pos) annotation(Line(points = {{-100, 70}, {-74, 70}, {-74, 50}, {-48, 50}}));
      connect(m_int1.pos_sens, comm.get_pos) annotation(Line(points = {{-48, 34}, {-72, 34}, {-72, 70}, {-100, 70}}, color = {0, 0, 127}));
      connect(comm.set_ess, idealopeningswitch1.control) annotation(Line(points = {{-100, 70}, {-72, 70}, {-72, 16}, {-28, 16}, {-28, 1}}));
  ...
  package buildingblocks
    ...
    model verosim_basic
      ...
      Modelica.Blocks.Interfaces.RealOutput mi_pos annotation(Placement(visible = true, transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {102, 42}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    model examples
      ...
      model verosim_block
        ...
        Modelica.Blocks.Sources.BooleanConstant booleanconstant1[6](k = false) annotation(Placement(visible = true, transformation(origin = {-80, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Blocks.Sources.TimeTable timetable1(table = [0, 0; 5, 0; 5.01, 0.3; 20, 0.3; 20.01, 1.0; 45, 1.0; 45.0, 0; 70, 0.0]) annotation(Placement(visible = true, transformation(origin = {-83, 41}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
        Modelica.Blocks.Sources.Constant const[6](each k = 0) annotation(Placement(visible = true, transformation(origin = {-82, 78}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      equation
        ...
        connect(booleanconstant1.y, verosim_basic1.comm.intfcomm.set_ess) annotation(Line(points = {{-69, 0}, {-24, 0}, {-24, 40}, {0, 40}, {0, 40}}, color = {255, 0, 255}));
