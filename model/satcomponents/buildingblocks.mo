...
package ibossmo
	package components
		model iboss_interface
			...
			m_int mi annotation(Placement(
				visible=true,
				transformation(
					origin={-34, 42},
					extent={{-14, -14}, {14, 14}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.PositivePin vcc_ext annotation(Placement(
				visible=true,
				transformation(
					origin={99.273, -14.1046},
					extent={{-12, -12}, {12, 12}},
					rotation=0),
				iconTransformation(
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.NegativePin gnd_ext annotation(Placement(
				visible=true,
				transformation(
					origin={99.556, -40.9194},
					extent={{-12, -12}, {12, 12}},
					rotation=0),
				iconTransformation(
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Sensors.VoltageSensor v_int annotation(Placement(
				visible=true,
				transformation(
					origin={-55, -31},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.001) annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.NegativePin gnd_int annotation(Placement(
				visible=true,
				transformation(
					origin={-100, -42},
					extent={{-12, -12}, {12, 12}},
				...
				iconTransformation(
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.PositivePin vcc_int annotation(Placement(
				visible=true,
				transformation(
					origin={-100, -14},
					extent={{-12, -12}, {12, 12}},
				...
				iconTransformation(
					...
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Sensors.VoltageSensor v_ext annotation(Placement(
				visible=true,
				transformation(
					origin={17, -31},
					extent={{-10, 10}, {10, -10}},
			...
			Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.02) annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
			Modelica.Electrical.Analog.Sensors.CurrentSensor intf_current annotation(Placement(
				visible=true,
				transformation(
					origin={0, 28},
					extent={{10, 10}, {-10, -10}},
			...
			Comm_in comm_in annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.PositivePin v_motor annotation(Placement(
				visible=true,
				transformation(
					origin={-100, 32},
					extent={{-12, -12}, {12, 12}},
				...
				iconTransformation(
					...
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.NegativePin gnd_motor annotation(Placement(
				visible=true,
				transformation(
					origin={-100, 10},
					extent={{-12, -12}, {12, 12}},
			...
			annotation(
				...
				Diagram(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Text(fillPattern = FillPattern.Solid, extent = {{-102.764, -102.343}, {97.2356, -162.343}}, textString = "%name"), Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.CrossDiag, lineThickness = 1, extent = {{-14.11, 15.38}, {12.53, -10.63}})}));
		end iboss_connector;
		expandable connector iboss_int "general iboss interface"
			satcomponents.AOCS.ctrl.sat_bus sat_bus;
			annotation(
				defaultComponentName="iBoss_connector",
				Icon(graphics={Rectangle(fillColor = {255, 220, 168}, fillPattern = FillPattern.Solid, lineThickness = 1, extent = {{-100, 100}, {100, -100}}, origin = {0.22, 0})}),
				Diagram(graphics={Text(textString = "%name", fillPattern = FillPattern.Solid, extent = {{-102.764, -102.343}, {97.23560000000001, -162.343}}), Rectangle(fillColor = {255, 220, 168}, fillPattern = FillPattern.Solid, extent = {{-91.81, 87.72}, {91.81, -87.72}}, origin = {-1.11, 1.88})}));
		end iboss_int;
		...
		model router "router"
			...
			annotation(
				Icon(
					...
					graphics={Rectangle(lineColor = {0, 0, 0}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-80, 83.3}, {86.7, -86.7}}), Text(textString = "ROUT", lineColor = {0, 0, 0}, extent = {{-50, 43.3}, {53.3, -46.7}})}),
				experiment(
					StopTime=1,
					StartTime=0));
		end router;
		model spring_connection "spring connection between iboss elements"
			...
			annotation(
				Icon(
					coordinateSystem(extent={{-101.7, -51.7}, {101.7, 51.7}}),
					graphics={Line(points = {{-50, 6.7}, {-33.3, 26.7}, {-23.3, 0}, {-10, 26.7}, {6.7, -6.7}, {13.3, 23.3}, {30, 0}, {40, 26.7}, {50, -3.3}, {70, 20}, {73.3, 23.3}}, color = {0, 0, 0})}),
				experiment(
					StopTime=1,
					StartTime=0));
		end spring_connection;
		model ESS_relay
			Modelica.Electrical.Analog.Semiconductors.HeatingPMOS heatingpmos1(
				useHeatPort=false,
				W=20.0e-5,
				L=6.0e-5) annotation(Placement(
				visible=true,
				transformation(
					origin={-20, 20},
					extent={{-10, -10}, {10, 10}},
					rotation=90)));
			Modelica.Electrical.Analog.Semiconductors.HeatingPMOS heatingpmos2(
				useHeatPort=false,
				W=20.0e-5,
				L=6.0e-5) annotation(Placement(
				visible=true,
		...
		package Examples
			model interface_with_dcdc
				Modelica.Blocks.Sources.TimeTable timetable1(table=[0, 0; 5, 0; 5.01, 0.3; 20, 0.3; 20.01, 1.0; 45, 1.0; 45.0, 0; 70, 0.0]) annotation(Placement(
					visible=true,
					transformation(
						origin={-61, 55},
						extent={{-13, -13}, {13, 13}},
				...
				Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=20) annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				satcomponents.power.dcmodel.dcdc_ideal_simple dcdc_ideal_simple1 annotation(Placement(
					visible=true,
					transformation(
						origin={-16, 0},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				m_int m_int1 annotation(Placement(
					visible=true,
					transformation(
						origin={38, 2},
						extent={{-10, -10}, {10, 10}},
			...
			model interfacecomplete_with_dcdc
				...
				satcomponents.power.dcmodel.dcdc_ideal_simple dcdc_ideal_simple1 annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				iboss_interface iboss_interface1 annotation(Placement(
					visible=true,
					transformation(
						origin={34, 6},
						extent={{-18, -18}, {18, 18}},
				...
				Modelica.Blocks.Sources.TimeTable timetable1(table=[0, 0; 5, 0; 5.01, 0.3; 20, 0.3; 20.01, 1.0; 45, 1.0; 45.0, 0; 70, 0.0]) annotation(Placement(
					...
					transformation(
						...
						extent={{-13, -13}, {13, 13}},
						rotation=0)));
				Modelica.Blocks.Sources.BooleanConstant booleanconstant1 annotation(Placement(
					visible=true,
					transformation(
						origin={-54, 34},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=25) annotation(Placement(
					visible=true,
					transformation(
						origin={-72, -2},
						extent={{-10, -10}, {10, 10}},
			...
			model interfacecomplete_with_battery
				...
				satcomponents.power.batteries.battery battery1(
					Vnominal=20,
					capacity_Ah=0.3) annotation(Placement(
					visible=true,
					transformation(
						origin={-60, -4},
						extent={{-10, -10}, {10, 10}},
			...
			annotation(
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Polygon(origin = {6.94, -7.97}, fillColor = {192, 192, 255}, fillPattern = FillPattern.Solid, points = {{-86.9387, 7.96559}, {-46.9387, -72.0344}, {33.0613, -72.0344}, {73.0613, 7.96559}, {33.0613, 87.9656}, {-46.9387, 87.9656}, {-86.9387, 7.96559}})}),
				Diagram(
					coordinateSystem(
						extent={{-100, -100}, {100, 100}},
						preserveAspectRatio=true,
						initialScale=0.1,
						grid={2, 2}),
					graphics={Polygon(fillColor = {192, 192, 255}, fillPattern = FillPattern.Solid, points = {{-40, 0}, {-20, 40}, {20, 40}, {40, 0}, {20, -40}, {-20, -40}, {-40, 0}})}));
		end Comm_in;
		connector Comm_out
			...
			annotation(
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Polygon(origin = {6.94, -7.97}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-86.9387, 7.96559}, {-46.9387, -72.0344}, {33.0613, -72.0344}, {73.0613, 7.96559}, {33.0613, 87.9656}, {-46.9387, 87.9656}, {-86.9387, 7.96559}})}),
				Diagram(
					coordinateSystem(
						extent={{-100, -100}, {100, 100}},
						preserveAspectRatio=true,
						initialScale=0.1,
						grid={2, 2}),
					graphics={Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-40, 0}, {-20, 40}, {20, 40}, {40, 0}, {20, -40}, {-20, -40}, {-40, 0}})}));
		end Comm_out;
	end components;
	package buildingblocks
		...
		model verosim_basic
			...
			satcomponents.power.verbraucher OBC(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			satcomponents.AOCS.Parts.IMU imu1 annotation(Placement(
				visible=true,
				transformation(
					origin={-48, 40},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Thermal.HeatTransfer.Components.HeatCapacitor heatcapacitor1(C=897.0 * m) annotation(Placement(
				visible=true,
				transformation(
					origin={-48, -2},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Thermal.HeatTransfer.Sources.FixedTemperature fixedtemperature1(T=100) annotation(Placement(
				visible=true,
				transformation(
					origin={-102, -10},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Thermal.HeatTransfer.Components.BodyRadiation bodyradiation1(Gr=0.02 * 6 * 0.4 * 0.4) annotation(Placement(
				visible=true,
				transformation(
					origin={-74, -10},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Electrical.Analog.Sources.RampVoltage rampvoltage1(
				V=40,
				duration=2) annotation(Placement(
				visible=true,
				transformation(
					origin={-72, -46},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
			satcomponents.thermal.thermometer_withnoise thermometer_withnoise1 annotation(Placement(
				visible=true,
				transformation(
					origin={-10, 28},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			input components.Comm_in comm_in annotation(Placement(
				visible=true,
				transformation(
					origin={-100, 80},
					extent={{-10, -10}, {10, 10}},
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Interfaces.RealInput ddr[3] annotation(Placement(
				visible=true,
				transformation(
					origin={-100, 20},
					extent={{-10, -10}, {10, 10}},
			...
			output components.Comm_out comm_out annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface intf[6] annotation(Placement(
				visible=true,
				transformation(
					origin={64, 8},
					extent={{-10, -10}, {10, 10}},
		...
		model versom_basic_battery
			...
			satcomponents.power.dcmodel.dcdc_ideal_simple dcdc_ideal_simple1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Sources.BooleanConstant booleanconstant1[6] annotation(Placement(
				visible=true,
				transformation(
					origin={-80, 0},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Blocks.Sources.TimeTable timetable1(table=[0, 0; 5, 0; 5.01, 0.3; 20, 0.3; 20.01, 1.0; 45, 1.0; 45.0, 0; 70, 0.0]) annotation(Placement(
				...
				transformation(
					...
					extent={{-13, -13}, {13, 13}},
					rotation=0)));
			components.comm_int comm_int1[6] annotation(Placement(
				visible=true,
				transformation(
					origin={-44, 78},
					extent={{-10, -10}, {10, 10}},
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Sources.Constant const[6](each k=0) annotation(Placement(
				visible=true,
				transformation(
					origin={-82, 78},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface xp annotation(Placement(
				visible=true,
				transformation(
					origin={64, 78},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface xn annotation(Placement(
				visible=true,
				transformation(
					origin={64, 52},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface yp annotation(Placement(
				visible=true,
				transformation(
					origin={64, 26},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface yn annotation(Placement(
				visible=true,
				transformation(
					origin={64, -2},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface zp annotation(Placement(
				visible=true,
				transformation(
					origin={64, -30},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			components.iboss_interface zn annotation(Placement(
				visible=true,
				transformation(
					origin={64, -58},
					extent={{-10, -10}, {10, 10}},
		...
		package examples
			...
			model verosim_block
				...
				Modelica.Blocks.Sources.BooleanConstant set_ess[6](k=false) annotation(Placement(
					visible=true,
					transformation(
						origin={-80, 0},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Blocks.Sources.Constant const[6](each k=0) annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				iboss_vti verosim_basic1(m=1) annotation(Placement(
					visible=true,
					transformation(
						origin={22, 24},
						extent={{-26, -26}, {26, 26}},
						rotation=0)));
				Modelica.Blocks.Sources.Constant acc[3](k=0) annotation(Placement(
					visible=true,
					transformation(
						origin={-42, -30},
						extent={{-10, -10}, {10, 10}},
