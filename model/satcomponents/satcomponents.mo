  ...
  package AOCS
    ...
    package Parts
      ...
      model RW3a_noelec_nobus
        ...
        Modelica.Mechanics.MultiBody.Joints.Revolute x_axis(animation = false, n = {1, 0, 0}) annotation(Placement(transformation(origin = {-30, 90}, extent = {{-10, -10}, {10, 10}})));
        Modelica.Mechanics.MultiBody.Parts.BodyShape wheel_x(animation = false, animateSphere = false) annotation(Placement(transformation(origin = {5, 90}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        Modelica.Mechanics.MultiBody.Forces.Torque torque_x(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-10, 66}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        ...
        Modelica.Mechanics.MultiBody.Parts.BodyShape wheel_y(animation = false, animateSphere = false) annotation(Placement(visible = true, transformation(origin = {5, 35}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
  Modelica.Mechanics.MultiBody.Forces.Torque torque_y(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-10, 11}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        ...
        Modelica.Mechanics.MultiBody.Parts.BodyShape wheel_z(animation = false, animateSphere = false) annotation(Placement(visible = true, transformation(origin = {5, -20}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        Modelica.Mechanics.MultiBody.Forces.Torque torque_z(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-10, -44}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        Modelica.Blocks.Interfaces.RealInput tx annotation(Placement(visible = true, transformation(origin = {-40, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 90), iconTransformation(origin = {-40, -114}, extent = {{-14, -14}, {14, 14}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput ty annotation(Placement(visible = true, transformation(origin = {0, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 90), iconTransformation(origin = {0, -114}, extent = {{-14, -14}, {14, 14}}, rotation = 90)));
  Modelica.Blocks.Interfaces.RealInput tz annotation(Placement(visible = true, transformation(origin = {40, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 90), iconTransformation(origin = {40, -114}, extent = {{-14, -14}, {14, 14}}, rotation = 90)));
      equation
        connect(torque_y.frame_b, y_axis.frame_a) annotation(Line(points = {{-20, 11}, {-45, 11}, {-45, 35}, {-40, 35}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(torque_y.frame_a, wheel_y.frame_a) annotation(Line(points = {{0, 11}, {20, 11}, {20, 35}, {15, 35}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(torque_z.frame_b, z_axis.frame_a) annotation(Line(points = {{-20, -44}, {-45, -44}, {-45, -20}, {-40, -20}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(torque_z.frame_a, wheel_z.frame_a) annotation(Line(points = {{0, -44}, {20, -44}, {20, -20}, {15, -20}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(wheel_z.frame_b, z_axis.frame_b) annotation(Line(points = {{-5, -20}, {-20, -20}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(z_axis.frame_a, frame_a) annotation(Line(points = {{-40, -20}, {-94.3, -20}, {-94.3, 5.3}, {-99.3, 5.3}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(torque_x.frame_a, wheel_x.frame_a) annotation(Line(points = {{0, 66}, {20, 66}, {20, 90}, {15, 90}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(torque_x.frame_b, x_axis.frame_a) annotation(Line(points = {{-20, 66}, {-45, 66}, {-45, 90}, {-40, 90}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(wheel_y.frame_b, y_axis.frame_b) annotation(Line(points = {{-5, 35}, {-20, 35}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(y_axis.frame_a, frame_a) annotation(Line(points = {{-40, 35}, {-94.3, 35}, {-94.3, 5.3}, {-99.3, 5.3}}, color = {95, 95, 95}, thickness = 0.0625));
        torque_x.torque[2:3] = {0, 0};
        torque_y.torque[1] = 0;
        torque_y.torque[3] = 0;
        torque_z.torque[1:2] = {0, 0};
  connect(torque_x.torque[1], tx);
  connect(torque_y.torque[2], ty);
  connect(torque_z.torque[3], tz);
        connect(wheel_x.frame_b, x_axis.frame_b) annotation(Line(points = {{-5, 90}, {-10, 90}, {-15, 90}, {-20, 90}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(x_axis.frame_a, frame_a) annotation(Line(points = {{-40, 90}, {-45, 90}, {-94.3, 90}, {-94.3, 5.3}, {-99.3, 5.3}}, color = {95, 95, 95}, thickness = 0.0625));
        annotation(wheel_x(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), frameTranslation(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2))), body(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), w_a(flags = 2), z_a(flags = 2), g_0(flags = 2))), wheel_y(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), frameTranslation(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2))), body(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), w_a(flags = 2), z_a(flags = 2), g_0(flags = 2))), wheel_z(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), frameTranslation(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2))), body(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), w_a(flags = 2), z_a(flags = 2), g_0(flags = 2))), Icon(graphics = {Rectangle(origin = {0.144508, 13.2948}, fillColor = {128, 128, 128}, fillPattern = FillPattern.Solid, extent = {{-90.0289, 54.3352}, {61.7052, -76.8786}}), Rectangle(origin = {2.16763, 20.2312}, fillColor = {88, 88, 88}, fillPattern = FillPattern.Solid, extent = {{-71.2428, -8.0925}, {5.6358, -80.0578}}), Rectangle(origin = {-0.144509, 13.2948}, fillColor = {88, 88, 88}, fillPattern = FillPattern.Solid, extent = {{35.6936, 25.7225}, {70.6647, -52.0231}}), Rectangle(origin = {-46.9653, 97.6879}, fillColor = {88, 88, 88}, fillPattern = FillPattern.Solid, extent = {{2.45662, -18.2081}, {85.9826, -50.8671}}), Rectangle(origin = {11.4162, -3.32367}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, extent = {{-16.0405, 25.8671}, {-12.8613, 5.92483}}), Polygon(origin = {-0.307609, 23.5614}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-2.87157, 16.034}, {1.46373, -3.90828}, {-6.91786, -3.61926}, {-2.87157, 16.034}}), Polygon(origin = {19.6924, 1.07585}, rotation = -90, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-2.87157, 16.034}, {1.46373, -3.90828}, {-6.91786, -3.61926}, {-2.87157, 16.034}}), Rectangle(origin = {-9.91328, -10.4913}, rotation = -90, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, extent = {{-16.0405, 25.8671}, {-12.8613, 5.92483}}), Polygon(origin = {-9.53757, -2.17522}, fillColor = {255, 0, 0}, fillPattern = FillPattern.Solid, points = {{-7.80347, -5.05026}, {5.49133, 7.08847}, {7.80347, 4.77633}, {-5.78035, -7.07338}, {-7.80347, -5.05026}}), Polygon(origin = {-14.9319, -12.1611}, rotation = -90, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-2.00451, 2.45016}, {5.22095, -9.68863}, {-6.91786, -3.61926}, {-2.00451, 2.45016}}), Text(origin = {-4.62427, 56.2139}, extent = {{-14.4509, 10.8382}, {14.4509, -10.8382}}, textString = "Z"), Text(origin = {47.4567, 3.38154}, extent = {{-14.4509, 10.8382}, {14.4509, -10.8382}}, textString = "Y"), Text(origin = {-31.9652, -24.5953}, extent = {{-14.4509, 10.8382}, {14.4509, -10.8382}}, textString = "X"), Text(origin = {-42, -93}, extent = {{-10, 13}, {14, -13}}, textString = "X"), Text(origin = {-2, -93}, extent = {{-10, 13}, {14, -13}}, textString = "Y"),  Text(origin = {38, -93}, extent = {{-10, 13}, {14, -13}}, textString = "Z")}, coordinateSystem(initialScale = 0.1)), experiment(StopTime = 30, StartTime = 0, Tolerance = 0.0001));
...
sensor model.
  ...
  satcomponents.satellites.Cubesat cubesat annotation(Placement(visible = true, transformation(origin = {14.1965, 30.2428}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        ...
        annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 50, StopTime = 300, Tolerance = 1e-05, Interval = 0.5));
