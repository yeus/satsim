  ...
  package AOCS
    ...
    package ctrl
      model ACS
        ...
        Real w_a[10, 3](each start = 0.0) = fill(0.0, 10, 3);
      equation
        connect(pulse1.y, acs_bus.w_a[1, :]) annotation(Line(points = {{16, -10}, {21, -10}, {85, -10}, {85, 15}, {90, 15}}, color = {0, 0, 127}, thickness = 0.0625));
        connect(w_a[2:end, :], acs_bus.w_a[2:end, :]);
