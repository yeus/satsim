...
//y = alpha * exp(beta * time);exp function
      ...
      model Akkuaufladung
        ...
        solar_power.solarcell solarcell1 annotation(Placement(visible = true, transformation(origin = {10, -8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation

        annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(initialScale = 0.1)), experiment(StartTime = 0.0, StopTime = 100.0, Tolerance = 0.0001));
      end Akkuaufladung;
...
//y = alpha * exp(beta * time);exp function
    ...
    model verbraucher
      ...
      Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(visible = true, transformation(origin = {-49.6667, -99.33329999999999}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-49.6667, -99.33329999999999}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(visible = true, transformation(origin = {47.3333, -99.33329999999999}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {47.3333, -99.33329999999999}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Electrical.Analog.Basic.Resistor resistor1(R = v_nominal * v_nominal / power_nominal, useHeatPort = useHeatPort) annotation(Placement(visible = true, transformation(origin = {0, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heatPort(T(start = T) = T_heatPort, Q_flow = -LossPower) annotation(Placement(visible = true, transformation(origin = {-100, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      ...
      annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 0.0, StopTime = 100.0, Tolerance = 1e-06), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics = {Rectangle(origin = {1.83333, -2.83333}, extent = {{-84.1667, -92.1667}, {84.1667, 92.1667}}), Text(origin = {1.66667, 63}, extent = {{-63.3333, 10.6667}, {63.3333, -10.6667}}, textString = "Verbraucher"), Text(origin = {3, -23}, extent = {{-61.3333, 35.3333}, {61.3333, -35.3333}}, textString = "%power_nominal W"), Text(origin = {-1, 21}, extent = {{-67, 21}, {67, -21}}, textString = "%name")}));
    end verbraucher;
    ...
    model HBridge
      ...
      Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(origin = {-88, -18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch1 annotation(Placement(visible = true, transformation(origin = {-66, 0}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
      Modelica.Blocks.Logical.Or or1 annotation(Placement(visible = true, transformation(origin = {-66, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch2 annotation(Placement(visible = true, transformation(origin = {4, 0}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    equation
    ...
    model dc_power
      ...
      Modelica.Electrical.Analog.Interfaces.NegativePin n annotation(Placement(transformation(origin = {100, -40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {100, -40}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Electrical.Analog.Interfaces.PositivePin p annotation(Placement(transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {100, 60}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Electrical.Analog.Sources.RampVoltage rampVoltage1(V = v) annotation(Placement(transformation(origin = {-40, 5}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    equation
      v_out = p.v - n.v;
    equation
      connect(rampVoltage1.p, p) annotation(Line(points = {{-40, 15}, {-40, 20}, {-40, 40}, {95, 40}, {100, 40}}, thickness = 0.0625));
      connect(rampVoltage1.n, n) annotation(Line(points = {{-40, -5}, {-40, -10}, {-40, -40}, {95, -40}, {100, -40}}, thickness = 0.0625));
      annotation(Icon(graphics = {Line(points = {{-38, 0}, {-10, 0}}, rotation = -90), Line(points = {{-10, 22}, {-10, -24}}, rotation = -90), Line(points = {{0, 12}, {0, -12}}, rotation = -90), Line(points = {{0, 0}, {28, 0}}, rotation = -90), Text(textString = "%name=%V", extent = {{18, -104}, {150, -72}}, origin = {-80, 2}), Text(textString = "+", extent = {{-166, 64}, {-124, 22}}, origin = {202, 20}), Text(textString = "-", extent = {{20, 50}, {66, 6}}, origin = {16, -76}), Rectangle(extent = {{-91, 78}, {91, -78}}, origin = {7, 10})}), experiment(StopTime = 1, StartTime = 0));
    end dc_power;
    ...
    model dc_power_realistic
      ...
      Modelica.SIunits.Voltage v_out(start = v);
      parameter Modelica.SIunits.Capacitance c_int = 1e-9 "internal capacitance";
      Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(transformation(origin = {100, -40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {100, -40}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(transformation(origin = {100, 40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {100, 60}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Electrical.Analog.Sources.RampVoltage rampVoltage1(V = v) annotation(Placement(transformation(origin = {-40, 5}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = c_int) annotation(Placement(transformation(origin = {20, 10}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    ...
    equation
      connect(rampVoltage1.p, resistor1.p) annotation(Line(points = {{-40, 15}, {-40, 20}, {-40, 35}, {-30, 35}, {-25, 35}}, thickness = 0.0625));
      connect(resistor1.n, capacitor1.p) annotation(Line(points = {{-5, 35}, {0, 35}, {20, 35}, {20, 25}, {20, 20}}, thickness = 0.0625));
      connect(capacitor1.p, resistor2.p) annotation(Line(points = {{20, 20}, {20, 25}, {20, 35}, {40, 35}, {45, 35}}, thickness = 0.0625));
      connect(resistor2.n, pin_p) annotation(Line(points = {{65, 35}, {70, 35}, {95, 35}, {95, 40}, {100, 40}}, thickness = 0.0625));
      connect(rampVoltage1.n, capacitor1.n) annotation(Line(points = {{-40, -5}, {-40, -10}, {20, -10}, {20, -5}, {20, 0}}, thickness = 0.0625));
      connect(capacitor1.n, pin_n) annotation(Line(points = {{20, 0}, {20, -5}, {20, -40}, {95, -40}, {100, -40}}, thickness = 0.0625));
      annotation(Icon(graphics = {Line(points = {{-38, 0}, {-10, 0}}, rotation = -90), Line(points = {{-10, 22}, {-10, -24}}, rotation = -90), Line(points = {{0, 12}, {0, -12}}, rotation = -90), Line(points = {{0, 0}, {28, 0}}, rotation = -90), Text(textString = "%name=%V", extent = {{18, -104}, {150, -72}}, origin = {-80, 2}), Text(textString = "+", extent = {{-166, 64}, {-124, 22}}, origin = {202, 20}), Text(textString = "-", extent = {{20, 50}, {66, 6}}, origin = {16, -76}), Rectangle(extent = {{-91, 78}, {91, -78}}, origin = {7, 10})}), experiment(StopTime = 1, StartTime = 0));
  ...
  package AOCS
    model freerotatingcube
      extends Modelica.Icons.Example;
      inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-51.3333, 16.6667}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Parts.BodyBox bodybox1(r = {0, 0.1, 0.0}, r_shape = {0, 0, 0}, lengthDirection = {0, 1, 0}, widthDirection = {1, 0, 0}, length = 0.1, width = 0.2, height = 0.1, innerWidth = 0, innerHeight = 0, angles_fixed = true, w_0_fixed = true, w_0_start = {0.1, 0.2, 0.3}, z_0_fixed = false, useQuaternions = false) annotation(Placement(visible = true, transformation(origin = {28.3333, 15.6667}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ...
    package Parts
      ...
      equation
        ...
        connect(rotor1D1.frame_a, frame_a) annotation(Line(points = {{-4, -18}, {-4, -18}, {-4, 6}, {-100, 6}, {-100, 6}}, color = {95, 95, 95}));
...
//torque_x.torque = {T, 0, 0};
      ...
      model RW3a_noelec_nobus
        ...
        Modelica.Mechanics.MultiBody.Joints.Revolute x_axis(animation = false, n = {1, 0, 0}) annotation(Placement(visible = true, transformation(origin = {-30, 90}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Forces.Torque torque_x(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-30, 68}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
        Modelica.Mechanics.MultiBody.Joints.Revolute y_axis(animation = false, n = {0, 1, 0}) annotation(Placement(visible = true, transformation(origin = {-30, 35}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Forces.Torque torque_y(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-30, 13}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
      ...
      equation
        ...
        connect(x_axis.frame_b, torque_x.frame_a) annotation(Line(points = {{-20, 90}, {-12, 90}, {-12, 68}, {-20, 68}}, color = {95, 95, 95}));
        connect(x_axis.frame_a, frame_a) annotation(Line(points = {{-40, 90}, {-94.3, 90}, {-94.3, 5.3}, {-99.3, 5.3}}, color = {95, 95, 95}, thickness = 0.0625));
      ...
      model reactionwheel
        ...
        Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = 1e-9) annotation(Placement(visible = true, transformation(origin = {-7, -51}, extent = {{-7, -7}, {7, 7}}, rotation = 90)));
        Modelica.Electrical.Analog.Basic.Resistor resistor1(R = 2) annotation(Placement(visible = true, transformation(origin = {5, -43}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
      equation
        connect(rotor1D1.frame_a, frame_a) annotation(Line(points = {{-4, -18}, {-4, -18}, {-4, 4}, {-100, 4}, {-100, 4}}, color = {95, 95, 95}));
...
//signalVoltage1.v = 5.0;
      ...
      model RW3a_limited_torque
        extends RW3a_icon;
        Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(transformation(origin = {-99.422, 5.20231}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-99.422, 5.20231}, extent = {{-10, -10}, {10, 10}})));
        reactionwheelsimple_noelectricity X_wheel(axis = {1, 0, 0}) annotation(Placement(transformation(origin = {-23.8, 63.7}, extent = {{-16.2717, -16.2717}, {16.2717, 16.2717}}, rotation = -90)));
        reactionwheelsimple_noelectricity Z_wheel(axis = {0, 0, 1}) annotation(Placement(transformation(origin = {-23.7, -31.3}, extent = {{-16.2717, -16.2717}, {16.2717, 16.2717}}, rotation = -90)));
        reactionwheelsimple_noelectricity Y_wheel(axis = {0, 1, 0}) annotation(Placement(transformation(origin = {-23.8, 18.8}, extent = {{-16.2717, -16.2717}, {16.2717, 16.2717}}, rotation = -90)));
        input Modelica.Blocks.Interfaces.RealInput T[3] "Desired Torque" annotation(Placement(visible = true, transformation(origin = {100, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 180), iconTransformation(origin = {100, 2}, extent = {{-14, -14}, {14, 14}}, rotation = 180)));
      equation
        connect(Z_wheel.frame_a, frame_a) annotation(Line(points = {{-40, -32}, {-62, -32}, {-62, 4}, {-100, 4}, {-100, 6}}, color = {95, 95, 95}));
        connect(Y_wheel.frame_a, frame_a) annotation(Line(points = {{-40, 18}, {-66, 18}, {-66, 4}, {-100, 4}, {-100, 6}}, color = {95, 95, 95}));
        connect(X_wheel.frame_a, frame_a) annotation(Line(points = {{-40, 64}, {-72, 64}, {-72, 4}, {-100, 4}, {-100, 6}}, color = {95, 95, 95}));
        connect(Z_wheel.T, T[3]) annotation(Line(points = {{-24, -48}, {46, -48}, {46, 0}, {100, 0}, {100, 0}}, color = {0, 0, 127}));
        connect(Y_wheel.T, T[2]) annotation(Line(points = {{-24, 2}, {86, 2}, {86, 0}, {100, 0}}, color = {0, 0, 127}));
        connect(X_wheel.T, T[1]) annotation(Line(points = {{-24, 48}, {-24, 48}, {-24, 40}, {46, 40}, {46, 0}, {100, 0}, {100, 0}}, color = {0, 0, 127}));
        annotation(Icon(coordinateSystem(initialScale = 0.1)), experiment(StopTime = 30, StartTime = 0, Tolerance = 0.0001), uses(Modelica(version = "3.2.1")));
      end RW3a_limited_torque;

      model RW_icon
        annotation(bodyShape1(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), frameTranslation(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), frame_b(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2))), body(frame_a(r_0(flags = 2), R(T(flags = 2), w(flags = 2)), f(flags = 2), t(flags = 2)), r_0(flags = 2), v_0(flags = 2), a_0(flags = 2), w_a(flags = 2), z_a(flags = 2), g_0(flags = 2))), experiment(StopTime = 100, StartTime = 0), Icon(coordinateSystem(initialScale = 0.1), graphics = {Ellipse(origin = {3.7977, -22.6127}, fillColor = {192, 192, 255}, fillPattern = FillPattern.Solid, extent = {{-49.5665, 9.53757}, {49.5665, -9.53757}}, endAngle = 360), Rectangle(origin = {3.6532, -16.5434}, fillColor = {192, 192, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-48.8439, 6.93642}, {48.8439, -6.93642}}), Ellipse(origin = {3.2775, -11.2832}, fillPattern = FillPattern.Solid, extent = {{-49.5665, 9.53757}, {49.5665, -9.53757}}, endAngle = 360), Text(origin = {-10.3233, -0.18507}, extent = {{-38.1503, 29.0462}, {1.94049, -3.66549}}, textString = "1D"), Rectangle(origin = {2.0636, 24.3526}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, extent = {{-4.19075, 13.4393}, {5.34682, -34.5376}}), Polygon(origin = {3.0566, 48.6365}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-1.42648, 13.1438}, {11.0013, -12.5788}, {-10.9641, -12.5788}, {-1.42648, 13.1438}}), Rectangle(origin = {5.3873, -56.4277}, extent = {{-8.67052, 24.2775}, {2.31214, -25.7225}}), Rectangle(origin = {2.3526, -55.5607}, fillColor = {0, 64, 0}, fillPattern = FillPattern.VerticalCylinder, extent = {{-17.7746, 11.8497}, {17.7746, -11.8497}}), Text(origin = {-51.8536, 47.6233}, extent = {{-33.6717, 47.8849}, {133.164, 11.3368}}, textString = "%name"), Text(origin = {63, -68}, extent = {{-31, 14}, {31, -14}}, textString = "J = %inertia.J")}));
      end RW_icon;

      model frame_input
        Modelica.Blocks.Interfaces.RealInput T annotation(Placement(visible = true, transformation(origin = {-6, -110}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {100, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ...
    package ctrl
      ...
      model ACS_P
        ...
        Modelica.Blocks.Math.Gain gain1[3](each k = k) annotation(Placement(visible = true, transformation(extent = {{9, -11}, {29, 9}}, rotation = 0)));
        ...
        Modelica.Blocks.Math.Feedback feedback1[3] annotation(Placement(visible = true, transformation(origin = {-38, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ...
        Modelica.Blocks.Interfaces.RealInput a_measure[3] annotation(Placement(visible = true, transformation(origin = {-3, -99}, extent = {{-11, -11}, {11, 11}}, rotation = 90), iconTransformation(origin = {0, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 90)));
      ...
      equation
        connect(a_measure, feedback1.u2) annotation(Line(points = {{-2, -98}, {-4, -98}, {-4, -44}, {-38, -44}, {-38, -10}, {-38, -10}}, color = {0, 0, 127}));
        connect(gain1.y, y) annotation(Line(points = {{30, 0}, {94, 0}, {94, 0}, {100, 0}}, color = {0, 0, 127}));
        connect(feedback1.y, gain1.u) annotation(Line(points = {{-29, -2}, {7, -2}, {7, -1}}, color = {0, 0, 127}));
        connect(a_u, feedback1.u1) annotation(Line(points = {{-100, 0}, {-48, 0}, {-48, -2}, {-46, -2}}, color = {0, 0, 127}));
      ...
      model ACS_PID
        ...
        Modelica.Blocks.Interfaces.RealInput a_measure[3] annotation(Placement(visible = true, transformation(origin = {-3, -99}, extent = {{-11, -11}, {11, 11}}, rotation = 90), iconTransformation(origin = {0, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 90)));
        Modelica.Blocks.Interfaces.RealInput a_u[3] annotation(Placement(visible = true, transformation(origin = {-101, -1}, extent = {{-11, -11}, {11, 11}}, rotation = 0), iconTransformation(origin = {-98, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
        Modelica.Blocks.Continuous.LimPID PID[3](controllerType = Modelica.Blocks.Types.SimpleController.P, k = 0.001) annotation(Placement(visible = true, transformation(origin = {1, -1}, extent = {{-11, -11}, {11, 11}}, rotation = 0)));
      equation
        connect(a_measure, PID.u_m) annotation(Line(points = {{-2, -98}, {0, -98}, {0, -14}, {2, -14}}, color = {0, 0, 127}));
        connect(PID.y, y) annotation(Line(points = {{13, -1}, {92, -1}, {92, 0}, {100, 0}}, color = {0, 0, 127}));
        connect(a_u, PID.u_s) annotation(Line(points = {{-100, 0}, {-12, 0}, {-12, -1}}, color = {0, 0, 127}));
        annotation(error(y(flags = 2)), Icon(graphics = {Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-86.39, 85.40000000000001}, {93.6909, -86.0637}}, origin = {1.22, 1.55}), Text(textString = "ACS", extent = {{-80.75, 56.53}, {80.75, -56.53}}, origin = {0.44, 3.43})}), experiment(StopTime = 1, StartTime = 0));
      end ACS_PID;
...
//w = Frames.angularVelocity1(A);
      ...
      model ACS_IO
        ...
        Modelica.Blocks.Interfaces.RealInput q_u[4] "desired attitude" annotation(Placement(visible = true, transformation(origin = {-101, -1}, extent = {{-11, -11}, {11, 11}}, rotation = 0), iconTransformation(origin = {-98, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
...
//TODO:  anti-windup control
      ...
      model targetquat
        ...
        Modelica.Blocks.Interfaces.RealOutput y[4] annotation(Placement(visible = true, transformation(origin = {100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//y = Frames.axesRotationsAngles(R, sequence);
      ...
      model ACS_IO_Q
        ...
        Modelica.Blocks.Interfaces.RealInput w_u[3] "desired angular velocity" annotation(Placement(visible = true, transformation(origin = {-101, -33}, extent = {{-11, -11}, {11, 11}}, rotation = 0), iconTransformation(origin = {-98, -52}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
        Modelica.Blocks.Interfaces.RealInput a_measure[3] "measured attitude" annotation(Placement(visible = true, transformation(origin = {-3, -99}, extent = {{-11, -11}, {11, 11}}, rotation = 90), iconTransformation(origin = {-5, -95}, extent = {{-15, -15}, {15, 15}}, rotation = 90)));
        Modelica.Blocks.Interfaces.RealInput a_u[4] "desired attitude" annotation(Placement(visible = true, transformation(origin = {-101, -1}, extent = {{-11, -11}, {11, 11}}, rotation = 0), iconTransformation(origin = {-98, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
        Modelica.Blocks.Interfaces.RealInput w_measure[3] "measured angular velocity" annotation(Placement(visible = true, transformation(origin = {43, -99}, extent = {{-11, -11}, {11, 11}}, rotation = 90), iconTransformation(origin = {55, -95}, extent = {{-15, -15}, {15, 15}}, rotation = 90)));
        Modelica.Blocks.Interfaces.BooleanInput on_off(start = false) annotation(Placement(visible = true, transformation(origin = {-1, 99}, extent = {{11, -11}, {-11, 11}}, rotation = 90), iconTransformation(origin = {1, 85}, extent = {{15, -15}, {-15, 15}}, rotation = 90)));
      equation
    ...
    package examples
      ...
      model cubesat_acs_simple
        inner Modelica.Mechanics.MultiBody.World world annotation(Placement(visible = true, transformation(origin = {-58, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body body1(m = 10, useQuaternions = true) annotation(Placement(visible = true, transformation(origin = {16, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Parts.IMU_simple imu_simple1 annotation(Placement(visible = true, transformation(origin = {14, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Parts.reactionwheel3axis_noelectricity reactionwheel3axis_noelectricity1 annotation(Placement(visible = true, transformation(origin = {-3, -13}, extent = {{-17, -17}, {17, 17}}, rotation = 0)));
      equation
        connect(body1.frame_a, imu_simple1.frame_a) annotation(Line(points = {{6, 54}, {-2, 54}, {-2, 32}, {4, 32}}, color = {95, 95, 95}));
        connect(world.frame_b, body1.frame_a) annotation(Line(points = {{-48, 54}, {6, 54}, {6, 54}, {6, 54}}, color = {95, 95, 95}));
        annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})));
      end cubesat_acs_simple;

      model basic_pid_q_control
        import Modelica.Mechanics.MultiBody.Types;
        import Modelica.Mechanics.MultiBody.Frames;
        import Modelica.Mechanics.MultiBody.Frames.Quaternions;
        import Modelica.SIunits.Conversions.to_unit1;
      ...
      model rotating_rigid_body
        ...
        Modelica.Mechanics.MultiBody.Parts.Body quaternions(I_11 = 0.5, I_21 = 0.2, I_22 = 0.1, I_31 = 0.1, I_33 = 0.333, angles_fixed = true, angles_start = {0, 0, 0}, enforceStates = true, m = 5.0, r_0(start = {6500e3, 0.1, 0.1}), r_CM = {0, 0, 0}, useQuaternions = true, v_0(start = {0, 7.8e3, 0}), w_0_fixed = true, w_0_start = {0.01, 0.02, 0.03}) annotation(Placement(visible = true, transformation(origin = {22, 44}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles1 annotation(Placement(visible = true, transformation(origin = {22, 16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body euler_angles(I_11 = 0.5, I_21 = 0.2, I_22 = 0.1, I_31 = 0.1, I_33 = 0.333, angles_fixed = true, angles_start = {0, 0, 0}, enforceStates = true, m = 5.0, r_0(start = {6500e3, 0.1, 0.1}), r_CM = {0, 0, 0}, useQuaternions = false, v_0(start = {0, 7.8e3, 0}), w_0_fixed = true, w_0_start = {0.01, 0.02, 0.03}) annotation(Placement(visible = true, transformation(origin = {-32, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles2 annotation(Placement(visible = true, transformation(origin = {-32, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(euler_angles.frame_a, absoluteAngles2.frame_a) annotation(Line(points = {{-42, 0}, {-56, 0}, {-56, -28}, {-42, -28}, {-42, -28}}, color = {95, 95, 95}));
        connect(quaternions.frame_a, absoluteAngles1.frame_a) annotation(Line(points = {{12, 44}, {-4, 44}, {-4, 16}, {12, 16}}, color = {95, 95, 95}));
        annotation(Icon, Diagram, experiment(StartTime = 0, StopTime = 100, Tolerance = 1e-6, Interval = 0.002));
      end rotating_rigid_body;

      model basic_p_control
        inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.PointGravity) annotation(Placement(visible = true, transformation(origin = {-86, 82}, extent = {{-6, -6}, {6, 6}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body body1(I_11 = 0.5, I_21 = 0.2, I_22 = 0.1, I_31 = 0.1, I_33 = 0.333, m = 5.0, r_0(start = {6500e3, 0, 0}), useQuaternions = true, v_0(start = {0, 7.8e3, 0}), w_0_fixed = true, w_0_start = {0.01, 0.002, 0.0001}) annotation(Placement(visible = true, transformation(origin = {-40, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles1 annotation(Placement(visible = true, transformation(origin = {-44, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity absoluteAngularVelocity1(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.frame_a) annotation(Placement(visible = true, transformation(origin = {-44, -16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        satcomponents.AOCS.Parts.RW3a_noelec_nobus rW3a_noelec_nobus1 annotation(Placement(visible = true, transformation(origin = {-36, 78}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        satcomponents.blocks.timed_switch timed_switch1[3](switchTime = 100) annotation(Placement(visible = true, transformation(origin = {37, 59}, extent = {{-7, -7}, {7, 7}}, rotation = 180)));
        satcomponents.AOCS.ctrl.ACS_P aCS_P1(k = 0.00001) annotation(Placement(visible = true, transformation(origin = {34, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Blocks.Sources.Constant const[3](k = {1, 0, 0}) annotation(Placement(visible = true, transformation(origin = {-5, 33}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
        Modelica.Blocks.Routing.DeMultiplex3 deMultiplex31 annotation(Placement(visible = true, transformation(origin = {-9, 59}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
      equation
        connect(const.y, aCS_P1.a_u) annotation(Line(points = {{3, 33}, {12, 33}, {12, 26}, {24, 26}}, color = {0, 0, 127}));
        connect(absoluteAngularVelocity1.w, aCS_P1.w_u) annotation(Line(points = {{-32, -16}, {14, -16}, {14, 20}, {24, 20}, {24, 20}}, color = {0, 0, 127}));
        connect(deMultiplex31.y3[1], rW3a_noelec_nobus1.tz) annotation(Line(points = {{-14, 56}, {-32, 56}, {-32, 66}, {-32, 66}}, color = {0, 0, 127}));
        connect(deMultiplex31.y2[1], rW3a_noelec_nobus1.ty) annotation(Line(points = {{-14, 60}, {-36, 60}, {-36, 66}, {-36, 66}}, color = {0, 0, 127}));
        connect(deMultiplex31.y1[1], rW3a_noelec_nobus1.tx) annotation(Line(points = {{-14, 62}, {-40, 62}, {-40, 66}, {-40, 66}}, color = {0, 0, 127}));
        connect(timed_switch1.y, deMultiplex31.u) annotation(Line(points = {{30, 60}, {-2, 60}, {-2, 60}, {-2, 60}}, color = {0, 0, 127}));
        connect(body1.frame_a, rW3a_noelec_nobus1.frame_a) annotation(Line(points = {{-50, 40}, {-54, 40}, {-54, 79}, {-46, 79}}, color = {95, 95, 95}));
        connect(aCS_P1.y, timed_switch1.u) annotation(Line(points = {{44, 26}, {62, 26}, {62, 58}, {46, 58}, {46, 60}}, color = {0, 0, 127}));
        connect(absoluteAngles1.angles, aCS_P1.a_measure) annotation(Line(points = {{-32, 12}, {-14, 12}, {-14, -8}, {34, -8}, {34, 16}}, color = {0, 0, 127}));
        connect(body1.frame_a, absoluteAngularVelocity1.frame_a) annotation(Line(points = {{-50, 40}, {-70, 40}, {-70, -16}, {-54, -16}}, color = {95, 95, 95}));
        connect(body1.frame_a, absoluteAngles1.frame_a) annotation(Line(points = {{-50, 40}, {-70, 40}, {-70, 12}, {-54, 12}}, color = {95, 95, 95}));
        annotation(Icon, Diagram, experiment(StartTime = 0, StopTime = 500, Tolerance = 1e-06, Interval = 0.5));
      end basic_p_control;

      model q_ontrol_withmotors
        import Modelica.Mechanics.MultiBody.Types;
        import Modelica.Mechanics.MultiBody.Frames;
        import Modelica.Mechanics.MultiBody.Frames.Quaternions;
        import Modelica.SIunits.Conversions.to_unit1;
        ...
        satcomponents.blocks.timed_switch timed_switch[3](switchTime = 1) annotation(Placement(visible = true, transformation(origin = {37, 59}, extent = {{-7, -7}, {7, 7}}, rotation = 180)));
        satcomponents.AOCS.ctrl.ACS_Q_PI_contr ACS(K_q = 10, T_level = {1, 1, 1}, ifac = 1.0, kw = 1) annotation(Placement(visible = true, transformation(origin = {30, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Quaternions.Orientation Q;
      equation
        connect(timed_switch.y, rW3a_noelec_nobus1.T) annotation(Line(points = {{30, 60}, {-2, 60}, {-2, 78}, {-26, 78}, {-26, 78}}, color = {0, 0, 127}));
      ...
      equation
        ...
        connect(mounting1D1.frame_a, quaternions.frame_a) annotation(Line(points = {{-78, -44}, {0, -44}, {0, 44}, {12, 44}}, color = {95, 95, 95}));
      ...
      model mission_simulation_ideal
        ...
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles1 annotation(Placement(visible = true, transformation(origin = {-44, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity w(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.frame_a) annotation(Placement(visible = true, transformation(origin = {-44, -16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        satcomponents.AOCS.ctrl.ACS_Q_PI_contr ACS(K_q = 1.0, T_level = {1, 1, 1}, ifac = 0.0, kw = 10.0) annotation(Placement(visible = true, transformation(origin = {32, 18}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Quaternions.Orientation Q;
      ...
      equation
        connect(const.y, ACS.a_u) annotation(Line(points = {{-54, -52}, {0, -52}, {0, 18}, {22, 18}, {22, 18}}, color = {0, 0, 127}));
...
signal <b>u</b> exceeds the <b>reference</b> signal plus half of the bandwidth.</p>
  ...
  package thermal
    model thermometer_withnoise "Absolute temperature sensor in Kelvin"
      Modelica.Blocks.Interfaces.RealOutput T(unit = "K") "Absolute temperature as output signal" annotation(Placement(transformation(extent = {{90, -10}, {110, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a port annotation(Placement(transformation(extent = {{-110, -10}, {-90, 10}}, rotation = 0)));
      Modelica.Blocks.Math.Add add1 annotation(Placement(visible = true, transformation(origin = {66, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperaturesensor1 annotation(Placement(visible = true, transformation(origin = {30, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      blocks.noise_ung noise_ung(amplitude = 0.1, seed = 34) annotation(Placement(visible = true, transformation(origin = {30, 32}, extent = {{-10.17, -5.17}, {10.17, 5.17}}, rotation = 0)));
    equation
      ...
      annotation(Diagram(coordinateSystem(preserveAspectRatio = true, extent = {{-100, -100}, {100, 100}}), graphics = {Ellipse(extent = {{-20, -98}, {20, -60}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-12, 40}, {12, -68}}, lineColor = {191, 0, 0}, fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid), Line(points = {{12, 0}, {90, 0}}, color = {0, 0, 255}), Line(points = {{-94, 0}, {-14, 0}}, color = {191, 0, 0}), Polygon(points = {{-12, 40}, {-12, 80}, {-10, 86}, {-6, 88}, {0, 90}, {6, 88}, {10, 86}, {12, 80}, {12, 40}, {-12, 40}}, lineColor = {0, 0, 0}, lineThickness = 0.5), Line(points = {{-12, 40}, {-12, -64}}, color = {0, 0, 0}, thickness = 0.5), Line(points = {{12, 40}, {12, -64}}, color = {0, 0, 0}, thickness = 0.5), Line(points = {{-40, -20}, {-12, -20}}, color = {0, 0, 0}), Line(points = {{-40, 20}, {-12, 20}}, color = {0, 0, 0}), Line(points = {{-40, 60}, {-12, 60}}, color = {0, 0, 0}), Text(extent = {{102, -28}, {60, -78}}, lineColor = {0, 0, 0}, textString = "K")}), Documentation(info = "<HTML>
<p>
...
sensor model.
  ...
  package satellites
    model satellite_basic
      ...
      satcomponents.AOCS.ctrl.ACS acs1 annotation(Placement(visible = true, transformation(origin = {68, 64}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    equation
      connect(reactionwheel3axis_noelectricity1.acs_bus, acs1.acs_bus) annotation(Line(points = {{33, 63}, {58, 63}, {58, 64}}));
    ...
    model Cubesat
      Modelica.Blocks.Sources.Constant const[3](k = {1, 0.5, 0.3}) annotation(Placement(visible = true, transformation(origin = {-15, 17}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles1 annotation(Placement(visible = true, transformation(origin = {-48, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity w(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.frame_a) annotation(Placement(visible = true, transformation(origin = {-48, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      satcomponents.blocks.timed_switch timed_switch[3](each switchTime = 100) annotation(Placement(visible = true, transformation(origin = {37, 59}, extent = {{-7, -7}, {7, 7}}, rotation = 180)));
      satcomponents.AOCS.ctrl.ACS_Q_P_cont aCS_Q_P_cont1(K_q = 300.0, kw = 30.0) annotation(Placement(visible = true, transformation(origin = {36, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(visible = true, transformation(origin = {-99.711, 0.289017}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-99.711, 0.289017}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      satcomponents.AOCS.Parts.Struktur struktur1 annotation(Placement(visible = true, transformation(origin = {-62.711, 0.086705}, extent = {{-24.6532, -24.6532}, {24.6532, 24.6532}}, rotation = 0)));
      Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode1 annotation(Placement(visible = true, transformation(origin = {-0.843931, -68.1985}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode2 annotation(Placement(visible = true, transformation(origin = {-0.984619, -41.1638}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      satcomponents.power.solar_power.solarcell_simple solarcell_simple1 annotation(Placement(visible = true, transformation(origin = {23.9884, -78.6127}, extent = {{10, 10}, {-10, -10}}, rotation = 0)));
      Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(origin = {54.6243, -88.7283}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      satcomponents.power.batteries.battery battery1 annotation(Placement(visible = true, transformation(origin = {25.7225, -20.5202}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Interfaces.RealInput u annotation(Placement(visible = true, transformation(origin = {2.02312, -101.445}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {-0.867052, -96.5318}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
      satcomponents.data.OBC obc1 annotation(Placement(visible = true, transformation(origin = {24.8555, -0.5665}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r = {0, 0.04, 0.03}) annotation(Placement(visible = true, transformation(origin = {-34, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      satcomponents.AOCS.Parts.RW3a_noelec_nobus reactionwheel3axis1 annotation(Placement(visible = true, transformation(origin = {6, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(aCS_Q_P_cont1.y, timed_switch.u) annotation(Line(points = {{46, 36}, {56, 36}, {56, 60}, {46, 60}, {46, 60}}, color = {0, 0, 127}));
      connect(reactionwheel3axis1.T, timed_switch.y) annotation(Line(points = {{16, 84}, {18, 84}, {18, 60}, {30, 60}, {30, 60}}, color = {0, 0, 127}));
      connect(fixedtranslation1.frame_b, reactionwheel3axis1.frame_a) annotation(Line(points = {{-24, 84}, {-4, 84}, {-4, 84}, {-4, 84}}, color = {95, 95, 95}));
      connect(const.y, aCS_Q_P_cont1.w_u) annotation(Line(points = {{-8, 18}, {6, 18}, {6, 30}, {26, 30}, {26, 30}}, color = {0, 0, 127}));
      connect(w.w, aCS_Q_P_cont1.w_measure) annotation(Line(points = {{-36, 40}, {-14, 40}, {-14, 32}, {20, 32}, {20, 16}, {42, 16}, {42, 26}, {42, 26}, {42, 26}}, color = {0, 0, 127}));
      connect(absoluteAngles1.angles, aCS_Q_P_cont1.a_measure) annotation(Line(points = {{-36, 62}, {-22, 62}, {-22, 46}, {14, 46}, {14, 18}, {36, 18}, {36, 26}, {36, 26}}, color = {0, 0, 127}));
      connect(const.y, aCS_Q_P_cont1.a_u) annotation(Line(points = {{-8, 18}, {6, 18}, {6, 36}, {26, 36}, {26, 36}}, color = {0, 0, 127}));
      connect(struktur1.frame_a, absoluteAngles1.frame_a) annotation(Line(points = {{-62, 0}, {-62, 0}, {-62, 62}, {-58, 62}, {-58, 62}}, color = {95, 95, 95}));
      connect(struktur1.frame_a, w.frame_a) annotation(Line(points = {{-62, 0}, {-58, 0}, {-58, 40}, {-58, 40}}, color = {95, 95, 95}));
      connect(frame_a, struktur1.frame_a) annotation(Line(points = {{-99.711, 0.289017}, {-62, 0.289017}, {-62, 1}}));
      connect(fixedtranslation1.frame_a, struktur1.frame_a) annotation(Line(points = {{-44, 84}, {-62, 84}, {-62, 1}}));
      connect(obc1.pin_p, battery1.p) annotation(Line(points = {{21, -10}, {15.0289, -10}, {15.0289, -20.5202}}));
      connect(obc1.pin_n, battery1.n) annotation(Line(points = {{25, -10}, {35.8382, -10}, {35.8382, -20.8092}}));
    ...
    package Examples
      ...
      model cubesat_in_orbit
        extends Modelica.Icons.Example;
        inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-52.9845, 29.4769}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(r_rel_a(start = {6500e3, 0, 0}), useQuaternions = true, v_rel_a(start = {0, 7.8e3, 0}), w_rel_a_fixed = true, w_rel_a_start = {0.5, 0.2, 0.1}) annotation(Placement(visible = true, transformation(origin = {-20.2197, 29.3757}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Blocks.Sources.Trapezoid sun(rising = 20, width = 1000, falling = 20, startTime = 2000, period = 5000, nperiod = -1, amplitude = 1367) annotation(Placement(visible = true, transformation(origin = {-7.8712, -26.2364}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        satcomponents.satellites.Cubesat cubesat annotation(Placement(visible = true, transformation(origin = {14.1965, 30.2428}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(cubesat.u, sun.y) annotation(Line(points = {{14, 21}, {14.7746, 21}, {14.7746, -26}, {3, -26}}));
        connect(freemotion1.frame_b, cubesat.frame_a) annotation(Line(points = {{-10, 29}, {4, 29}, {4, 30}}));
        connect(world.frame_b, freemotion1.frame_a) annotation(Line(points = {{-43, 29}, {-32.6243, 29}, {-32.6243, 29.6647}, {-30, 29.6647}, {-30, 29}}));
        annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 50, StopTime = 300, Tolerance = 1e-05, Interval = 0.05));
    ...
    model Cubesatsimple
      ...
      Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngles absoluteAngles1 annotation(Placement(visible = true, transformation(origin = {-48, 62}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity w(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.frame_a) annotation(Placement(visible = true, transformation(origin = {-48, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      satcomponents.AOCS.Parts.RW3a_noelec_nobus rW3a_noelec_nobus1 annotation(Placement(visible = true, transformation(origin = {-4, 84}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      satcomponents.blocks.timed_switch timed_switch[3](each switchTime = 100) annotation(Placement(visible = true, transformation(origin = {37, 59}, extent = {{-7, -7}, {7, 7}}, rotation = 180)));
      Modelica.Blocks.Routing.DeMultiplex3 deMultiplex31 annotation(Placement(visible = true, transformation(origin = {11, 59}, extent = {{5, -5}, {-5, 5}}, rotation = 0)));
      satcomponents.AOCS.ctrl.ACS_Q_P_cont aCS_Q_P_cont1(K_q = 300.0, kw = 30.0) annotation(Placement(visible = true, transformation(origin = {36, 36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(visible = true, transformation(origin = {-99.711, 0.289017}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-99.711, 0.289017}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      satcomponents.AOCS.Parts.Struktur struktur1 annotation(Placement(visible = true, transformation(origin = {-62.711, 0.086705}, extent = {{-24.6532, -24.6532}, {24.6532, 24.6532}}, rotation = 0)));
      Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode1 annotation(Placement(visible = true, transformation(origin = {-0.843931, -68.1985}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
    ...
    equation
      connect(const.y, aCS_Q_P_cont1.w_u) annotation(Line(points = {{-8, 18}, {6, 18}, {6, 30}, {26, 30}, {26, 30}}, color = {0, 0, 127}));
      connect(aCS_Q_P_cont1.y, timed_switch.u) annotation(Line(points = {{46, 36}, {58, 36}, {58, 60}, {46, 60}, {46, 60}}, color = {0, 0, 127}));
      connect(w.w, aCS_Q_P_cont1.w_measure) annotation(Line(points = {{-36, 40}, {-14, 40}, {-14, 32}, {20, 32}, {20, 16}, {42, 16}, {42, 26}, {42, 26}, {42, 26}}, color = {0, 0, 127}));
      connect(absoluteAngles1.angles, aCS_Q_P_cont1.a_measure) annotation(Line(points = {{-36, 62}, {-22, 62}, {-22, 46}, {14, 46}, {14, 18}, {36, 18}, {36, 26}, {36, 26}}, color = {0, 0, 127}));
      connect(const.y, aCS_Q_P_cont1.a_u) annotation(Line(points = {{-8, 18}, {6, 18}, {6, 36}, {26, 36}, {26, 36}}, color = {0, 0, 127}));
      connect(struktur1.frame_a, absoluteAngles1.frame_a) annotation(Line(points = {{-62, 0}, {-62, 0}, {-62, 62}, {-58, 62}, {-58, 62}}, color = {95, 95, 95}));
      ...
      connect(frame_a, struktur1.frame_a) annotation(Line(points = {{-99.711, 0.289017}, {-62, 0.289017}, {-62, 1}}));
      connect(fixedtranslation1.frame_a, struktur1.frame_a) annotation(Line(points = {{-44, 84}, {-62, 84}, {-62, 1}}));
      connect(rW3a_noelec_nobus1.frame_a, fixedtranslation1.frame_b) annotation(Line(points = {{-14, 84}, {-24, 84}, {-24, 84}, {-24, 84}}, color = {95, 95, 95}));
      connect(timed_switch.y, deMultiplex31.u) annotation(Line(points = {{30, 60}, {18, 60}, {18, 60}, {18, 60}}, color = {0, 0, 127}));
      connect(deMultiplex31.y3[1], rW3a_noelec_nobus1.tz) annotation(Line(points = {{6, 56}, {0, 56}, {0, 72}, {0, 72}}, color = {0, 0, 127}));
      connect(deMultiplex31.y2[1], rW3a_noelec_nobus1.ty) annotation(Line(points = {{6, 60}, {-4, 60}, {-4, 72}, {-4, 72}}, color = {0, 0, 127}));
      connect(deMultiplex31.y1[1], rW3a_noelec_nobus1.tx) annotation(Line(points = {{6, 62}, {-8, 62}, {-8, 72}, {-8, 72}}, color = {0, 0, 127}));
      connect(obc1.pin_p, battery1.p) annotation(Line(points = {{21, -10}, {15.0289, -10}, {15.0289, -20.5202}}));
      connect(obc1.pin_n, battery1.n) annotation(Line(points = {{25, -10}, {35.8382, -10}, {35.8382, -20.8092}}));
      connect(zdiode1.heatPort, heatCapacitor1.port) annotation(Line(points = {{24, -44}, {74, -44}, {74, 0}}, color = {191, 0, 0}));
      connect(u, solarcell_simple1.E_s) annotation(Line(points = {{2.02312, -101.445}, {2.02312, -89.8844}, {23.9884, -89.8844}, {23.9884, -86.4162}, {23.9884, -86.4162}}));
