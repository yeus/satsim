package satcomponents
  ...
  package AOCS
    ...
    package Parts
      ...
      model reactionwheelsimple3axis
      ...
      model RW3a_noelec_nobus
        ...
        Modelica.Mechanics.MultiBody.Joints.Revolute z_axis(useAxisFlange = false, animation = false, n = {0, 0, 1}) annotation(Placement(visible = true, transformation(origin = {-30, -20}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
        ...
        Modelica.Mechanics.MultiBody.Parts.Body body1 annotation(Placement(visible = true, transformation(origin = {6, 90}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body body2 annotation(Placement(visible = true, transformation(origin = {4, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body body3(I_11 = 1, I_22 = 1, I_33 = 1, m = 1)  annotation(Placement(visible = true, transformation(origin = {4, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Mechanics.MultiBody.Forces.Torque torque_z annotation(Placement(visible = true, transformation(origin = {-30, -47}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
      equation
        connect(z_axis.frame_b, torque_z.frame_a) annotation(Line(points = {{-20, -20}, {-16, -20}, {-16, -48}, {-20, -48}, {-20, -46}}, color = {95, 95, 95}));
        connect(z_axis.frame_a, torque_z.frame_b) annotation(Line(points = {{-40, -20}, {-44, -20}, {-44, -46}, {-40, -46}, {-40, -46}}, color = {95, 95, 95}));
        connect(z_axis.frame_a, frame_a) annotation(Line(points = {{-40, -20}, {-94.3, -20}, {-94.3, 5.3}, {-99.3, 5.3}}, color = {95, 95, 95}, thickness = 0.0625));
        connect(z_axis.frame_b, body3.frame_a) annotation(Line(points = {{-20, -20}, {-6, -20}}, color = {95, 95, 95}));
        ...
        torque_y.torque[1] = 0;
        torque_y.torque[3] = 0;
        torque_x.torque[1] = T[1];
        torque_y.torque[2] = T[2];
      ...
      model reactionwheel
        Modelica.Mechanics.MultiBody.Joints.Revolute Gelenk(n = {0, 0, 1}, useAxisFlange = true) annotation(Placement(visible = true, transformation(origin = {-0.859602, -18.5064}, extent = {{10, -10}, {-10, 10}}, rotation = 270)));
  Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(visible = true, transformation(origin = {-0.924801, -86.9942}, extent = {{-10, -10}, {10, 10}}, rotation = 90), iconTransformation(origin = {19, -100}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        Modelica.Mechanics.MultiBody.Parts.Body Schwungmasse(r_CM = {0, 0, 0}, m = 0.02, I_11 = 1e-07, I_22 = 1e-07, I_33 = 1e-07) annotation(Placement(visible = true, transformation(origin = {-0.867052, 28.0347}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  ...
  Modelica.Electrical.Analog.Sources.SignalVoltage signalVoltage1 annotation(Placement(visible = true, transformation(origin = {64, -42}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      Modelica.Electrical.Machines.BasicMachines.QuasiStationaryDCMachines.DC_PermanentMagnet dcpm annotation(Placement(visible = true, transformation(origin = {34, -44}, extent = {{-10, 10}, {10, -10}}, rotation = 90)));
        Modelica.Blocks.Interfaces.RealInput T annotation(Placement(visible = true, transformation(origin = {100,0}, extent = {{-20, -20}, {20, 20}}, rotation = 180), iconTransformation(origin = {100, 2}, extent = {{-14, -14}, {14, 14}}, rotation = 180)));
      equation
        connect(T, signalVoltage1.v) annotation(Line(points = {{100, 0}, {78, 0}, {78, -42}, {72, -42}, {72, -42}}, color = {0, 0, 127}));
        ...
        connect(frame_a, Gelenk.frame_a) annotation(Line(points = {{-1, -87}, {-1, -54.0462}, {-1.15607, -54.0462}, {-1.15607, -28.9017}}));
        connect(Schwungmasse.frame_a, Gelenk.frame_b) annotation(Line(points = {{-0.867052, 18.0347}, {-0.867052, -8.67052}, {-0.578035, -8.67052}, {-0.578035, -8.67052}}));
        annotation(Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 0, StopTime = 30, Tolerance = 0.0001), Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2}), graphics = {Ellipse(origin = {19.7977, -28.6127}, fillColor = {192, 192, 255}, fillPattern = FillPattern.Solid, extent = {{-49.5665, 9.537570000000001}, {49.5665, -9.537570000000001}}, endAngle = 360), Rectangle(origin = {19.6532, -22.5434}, fillColor = {192, 192, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-48.8439, 6.93642}, {48.8439, -6.93642}}), Ellipse(origin = {19.2775, -17.2832}, fillPattern = FillPattern.Solid, extent = {{-49.5665, 9.537570000000001}, {49.5665, -9.537570000000001}}, endAngle = 360), Text(origin = {5.67671, -6.18507}, extent = {{-38.1503, 29.0462}, {1.94049, -3.66549}}, textString = "1D"), Rectangle(origin = {18.0636, 18.3526}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, extent = {{-4.19075, 13.4393}, {5.34682, -34.5376}}), Polygon(origin = {19.0566, 42.6365}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.VerticalCylinder, points = {{-1.42648, 13.1438}, {11.0013, -12.5788}, {-10.9641, -12.5788}, {-1.42648, 13.1438}}), Rectangle(origin = {21.3873, -62.4277}, extent = {{-8.67052, 24.2775}, {2.31214, -25.7225}}), Rectangle(origin = {18.3526, -61.5607}, fillColor = {0, 64, 0}, fillPattern = FillPattern.VerticalCylinder, extent = {{-17.7746, 11.8497}, {17.7746, -11.8497}}), Line(origin = {56.9364, -46.9653}, points = {{-30.9249, -8.81503}, {20.5202, -8.81503}, {20.5202, 8.81503}, {30.9249, 8.81503}}), Line(origin = {61.9942, -69.79770000000001}, points = {{26.1561, -3.90173}, {16.0405, -3.90173}, {16.0405, 3.90173}, {-26.1561, 3.90173}}), Text(origin = {82.6589, -11.5607}, extent = {{-15.896, 13.0058}, {15.896, -13.0058}}, textString = "+"), Text(origin = {80.20229999999999, -95.2312}, extent = {{-18.6416, 23.5549}, {18.9306, -18.3526}}, textString = "-"), Text(origin = {-47.8536, 39.6233}, extent = {{-33.6717, 47.8849}, {133.164, 11.3368}}, textString = "%name")}));
      end reactionwheel;
      ...
      model reactionwheel3axis
        ...
        Modelica.Electrical.Analog.Sources.SignalVoltage signalvoltageZ annotation(Placement(transformation(origin = {20.0578, -53.9306}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        Modelica.Mechanics.MultiBody.Parts.FixedRotation X_axis annotation(Placement(transformation(origin = {-59.9, 60.1}, extent = {{-10, -10}, {10, 10}})));
        Modelica.Mechanics.MultiBody.Parts.FixedRotation Y_axis(angles = {-90, 0, 0}, rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.PlanarRotationSequence) annotation(Placement(transformation(origin = {-60.1, 15.1}, extent = {{-10, -10}, {10, 10}})));
        Modelica.Mechanics.MultiBody.Parts.FixedRotation Z_axis(angles = {0, -90, 0}, rotationType = Modelica.Mechanics.MultiBody.Types.RotationTypes.PlanarRotationSequence) annotation(Placement(transformation(origin = {-59.9, -35.2}, extent = {{-10, -10}, {10, 10}})));
        Modelica.Electrical.Analog.Sources.SignalVoltage signalvoltageX annotation(Placement(transformation(origin = {19.9422, 52.8902}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
        Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(extent = {{25, 10}, {45, 30}}, rotation = 0)));
        Modelica.Electrical.Analog.Basic.Ground ground2 annotation(Placement(visible = true, transformation(extent = {{25, -35}, {45, -15}}, rotation = 0)));
        Modelica.Electrical.Analog.Basic.Ground ground3 annotation(Placement(visible = true, transformation(extent = {{36, -87}, {56, -67}}, rotation = 0)));
      ...
      equation
        connect(T[3], signalvoltageZ.v) annotation(Line(points = {{100, 0}, {66, 0}, {66, -54}, {28, -54}, {28, -54}}, color = {0, 0, 127}));
        connect(T[2], signalvoltageY.v) annotation(Line(points = {{100, 0}, {26, 0}, {26, -2}, {26, -2}}, color = {0, 0, 127}));
        connect(T[1], signalvoltageX.v) annotation(Line(points = {{100, 0}, {68, 0}, {68, 52}, {26, 52}, {26, 52}}, color = {0, 0, 127}));
        connect(signalvoltageZ.n, ground3.p) annotation(Line(points = {{20, -64}, {20, -69}, {35, -69}, {35, -60}, {46, -60}, {46, -67}}, thickness = 0.0625));
        connect(signalvoltageY.n, ground2.p) annotation(Line(points = {{18.7, -11.7}, {18.7, -16.7}, {26.7, -16.7}, {26.7, -10}, {35, -10}, {35, -15}}, thickness = 0.0625));
        connect(ground1.p, signalvoltageX.n) annotation(Line(points = {{35, 30}, {35, 35}, {35, 38}, {20, 38}, {20, 43}}, thickness = 0.0625));
        connect(Z_axis.frame_b, Z_wheel.frame_a) annotation(Line(points = {{-50, -35.3}, {-45, -35.3}, {-45, -34.3}, {-40, -34.3}}));
        connect(Y_axis.frame_b, Y_wheel.frame_a) annotation(Line(points = {{-50, 15}, {-45, 15}, {-45, 15.7}, {-40, 15.7}}));
