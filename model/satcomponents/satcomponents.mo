		...
		package Parts
			...
			model IMU_nonoise
				...
				equation
					...
					connect(fixedDelay1.y, acs_bus.w[id,:]) annotation(Line(points = {{66, 0}, {71, 0}, {95, 0}, {100, 0}}, color = {0, 0, 127}, thickness = 0.0625));
					connect(absoluteangularvelocity1.w[:],fixedDelay1.u) annotation(Line(
						points={{-9,0},{-4,0},{53,0},{58,0}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					Icon(graphics={
		...
		package ctrl
			...
			model ACS_P
				...
				equation
					...
					connect(gain1.y,product1.u2) annotation(Line(
						...
						color={0,0,127},
						thickness=0.0625));
					connect(product1.y,acs_bus.w_a) annotation(Line(
					...
					connect(step1.y,product1.u1) annotation(Line(
						...
						color={0,0,127},
						thickness=0.0625));
					connect(step3.y,error.u1) annotation(Line(
						points={{-54,20},{-49,20},{-27,20},{-27,21},{-22,21}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					error(y(flags=2)),
			...
			model ACS_PID
				...
				equation
					...
					connect(PID.y,acs_bus.w_a) annotation(Line(
						points={{36,15},{41,15},{85,15},{90,15}},
						color={0,0,127},
						thickness=0.0625));
					connect(combiTimeTable1.y[:],PID.u_s) annotation(Line(
						points={{-9,15},{-4,15},{8,15},{13,15}},
						color={0,0,127},
						thickness=0.0625));
				annotation(
					viewinfo[0](
...
F5B33CA88BBE80137EAC2FBAD3B04FD4A1F902E6FB15F3278C7EC2DDF1BEF6D63778D5BB4BED1E787A0FCE711CFE8FDAFA05E6FFAB319EBE000000FFFF",
																				color={0,0,0})}),
				experiment(
					StopTime=1,
					StartTime=0));
		...
		model noise_sampled
			Modelica.Blocks.Math.Add add1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Sources.Constant const(k=0.0) annotation(Placement(
				visible=true,
				transformation(
					origin={-40, -20},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Blocks.Interfaces.RealOutput y annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Discrete.ZeroOrderHold zeroorderhold1(samplePeriod=1.0) annotation(Placement(
				visible=true,
				transformation(
					origin={60, 0},
					extent={{-10, -10}, {10, 10}},
