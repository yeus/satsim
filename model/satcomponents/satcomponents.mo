...
package satcomponents
	model Cubesat
		Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(
			...
			iconTransformation(
				...
				extent={{-10, -10}, {10, 10}},
				rotation=0)));
		satcomponents.AOCS.Parts.Struktur struktur1 annotation(Placement(
			visible=true,
			transformation(
				origin={-54.711, 0.086705},
				extent={{-24.6532, -24.6532}, {24.6532, 24.6532}},
				rotation=0)));
		Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode1 annotation(Placement(
			visible=true,
			transformation(
				origin={-0.843931, -68.1985},
				extent={{-10, -10}, {10, 10}},
				rotation=90)));
		Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode2 annotation(Placement(
			visible=true,
			transformation(
				origin={-0.984619, -41.1638},
				extent={{-10, -10}, {10, 10}},
				rotation=90)));
		satcomponents.power.solar_power.solarcell_simple solarcell_simple1 annotation(Placement(
			visible=true,
			transformation(
				origin={23.9884, -78.6127},
				extent={{10, 10}, {-10, -10}},
				rotation=0)));
		Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
			visible=true,
			transformation(
				origin={54.6243, -88.7283},
				extent={{-10, -10}, {10, 10}},
				rotation=0)));
		Modelica.Electrical.Analog.Semiconductors.ZDiode zdiode1(Bv=39) annotation(Placement(
			visible=true,
			transformation(
				origin={23.998, -54.422},
				extent={{-10, -10}, {10, 10}},
				rotation=180)));
		satcomponents.power.batteries.battery battery1 annotation(Placement(
			visible=true,
			transformation(
				origin={25.7225, -20.5202},
				extent={{-10, -10}, {10, 10}},
				rotation=0)));
		Modelica.Blocks.Interfaces.RealInput u annotation(Placement(
			visible=true,
			transformation(
				origin={2.02312, -101.445},
				extent={{-10, -10}, {10, 10}},
				rotation=90),
			iconTransformation(
				origin={-0.867052, -96.5318},
				extent={{-10, -10}, {10, 10}},
				rotation=90)));
		satcomponents.data.OBC obc1 annotation(Placement(
			visible=true,
			transformation(
				origin={24.8555, 25.4335},
				extent={{-10, -10}, {10, 10}},
				rotation=0)));
		Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r={0, 0.04, 0.03}) annotation(Placement(
			visible=true,
			transformation(
				origin={-20, 60},
				extent={{-10, -10}, {10, 10}},
				rotation=0)));
		satcomponents.AOCS.Parts.reactionwheel3axis_noelectricity reactionwheel3axis_noelectricity1(id=1) annotation(Placement(
			visible=true,
			transformation(
				origin={20, 60},
				extent={{-15, -15}, {15, 15}},
				rotation=0)));
		satcomponents.AOCS.ctrl.ACS acs1 annotation(Placement(
			visible=true,
			transformation(
				origin={60, 40},
				extent={{-10, -10}, {10, 10}},
	...
	package data
		model OBC
			Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(
				visible=true,
				transformation(
					origin={-42.7157, -98.16119999999999},
					extent={{-12, -12}, {12, 12}},
					rotation=0),
				iconTransformation(
					origin={-42.7157, -98.16119999999999},
			...
			Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(
				visible=true,
				transformation(
					origin={-22.0651, -36.7751},
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			Modelica.Blocks.Sources.Constant const(k=6.25) annotation(Placement(
				visible=true,
				transformation(
					origin={-51.4851, -2.26308},
					extent={{-12, -12}, {12, 12}},
					rotation=0)));
			equation
			...
			annotation(
				Diagram,
				Icon(graphics={Rectangle(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-80.90519999999999, 86.5629}, {86.2801, -87.12869999999999}}), Text(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-69.3069, 56.0113}, {69.024, -52.3338}}, textString = "OBC")}));
		end OBC;
	end data;
	package power
		model PCU
			...
			Modelica.Electrical.Analog.Interfaces.PositivePin VCC annotation(Placement(
				transformation(
					origin={-100.707, 7.92079},
					extent={{-12, -12}, {12, 12}}),
				iconTransformation(
					origin={-100.707, 7.92079},
					extent={{-12, -12}, {12, 12}})));
			Modelica.Electrical.Analog.Interfaces.PositivePin VCC3 annotation(Placement(
				transformation(
					origin={100.141, -23.1966},
					extent={{-12, -12}, {12, 12}}),
				iconTransformation(
					origin={100.141, -23.1966},
					extent={{-12, -12}, {12, 12}})));
			Modelica.Electrical.Analog.Interfaces.PositivePin VCC5 annotation(Placement(
				transformation(
					origin={99.8586, 8.769450000000001},
					extent={{-12, -12}, {12, 12}}),
				iconTransformation(
					origin={99.8586, 8.769450000000001},
					extent={{-12, -12}, {12, 12}})));
			Modelica.Electrical.Analog.Interfaces.PositivePin VCC12 annotation(Placement(
				transformation(
					origin={99.2928, 44.6959},
					extent={{-12, -12}, {12, 12}}),
				iconTransformation(
					origin={99.2928, 44.6959},
					extent={{-12, -12}, {12, 12}})));
			satcomponents.power.dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved1(
				V_out=3.3,
				V_in_min=5) annotation(Placement(transformation(
				origin={56.9364, -28.6127},
				extent={{-10, -10}, {10, 10}})));
			satcomponents.power.dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved2 annotation(Placement(transformation(
				origin={57.5145, 3.75723},
				extent={{-10, -10}, {10, 10}})));
			satcomponents.power.dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved3(
				V_out=12,
				V_in_min=15) annotation(Placement(transformation(
				origin={57.2254, 41.0405},
				extent={{-10, -10}, {10, 10}})));
			Modelica.Electrical.Analog.Basic.Capacitor C1(C(displayUnit="nF")=1e-07) annotation(Placement(transformation(
				origin={-30, -15},
				extent={{-10, -10}, {10, 10}},
				rotation=-90)));
			...
			annotation(
				Icon(
					...
					graphics={Text(textString = "PCU", fillColor = {0, 0, 255}, extent = {{-72.4187, 45.5445}, {24.894, -36.4922}}), Text(textString = "GND", fillColor = {0, 0, 255}, extent = {{22.9137, -45.8274}, {83.7341, -80.0566}}), Text(textString = "3.3V", fillColor = {0, 0, 255}, extent = {{34.2291, -11.3154}, {78.07640000000001, -40.4526}}), Text(textString = "5V", fillColor = {0, 0, 255}, extent = {{31.1174, 21.7822}, {78.6421, -8.769450000000001}}), Text(textString = "12V", fillColor = {0, 0, 255}, extent = {{31.6832, 60.8204}, {76.66200000000001, 26.3083}}), Rectangle(fillColor = {0, 0, 255}, extent = {{-88.82599999999999, 94.4837}, {88.2603, -94.7666}})}),
		...
		package batteries
				...
				annotation(
					...
					Icon(
						coordinateSystem(
							extent={{-100, -100}, {100, 100}},
							grid={1, 1}),
						graphics={Line(points = {{-90, 0}, {-10, 0}}), Line(points = {{-10, 60}, {-10, -60}}), Line(points = {{0, 30}, {0, -30}}), Line(points = {{0, 0}, {90, 0}}), Text(textString = "%capacity_Ah Ah", extent = {{-150, -112}, {150, -72}}), Text(textString = "+", extent = {{-120, 50}, {-20, 0}}), Text(textString = "-", extent = {{20, 50}, {120, 0}})}),
					experiment(
						StopTime=10000,
						StartTime=0,
						Tolerance=0.0001));
			...
			model batteriekennlinie
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-16.0598, -43.6034},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={24.4165, -5.74506},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				batteries.battery battery1(
					Vnominal=100.0,
					startSOC=1.0) annotation(Placement(
					visible=true,
					transformation(
						origin={-59.605, -3.68024},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Blocks.Sources.Constant const(k=5) annotation(Placement(
					visible=true,
					transformation(
						origin={45.8043, 45.7362},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				equation
			...
			model Akkuaufladung
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-11.3919, -34.9858},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				batteries.battery battery1(soc(start=0.5)) annotation(Placement(
					visible=true,
					transformation(
						origin={-54.9371, 4.93735},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=6) annotation(Placement(
					visible=true,
					transformation(
						origin={30.5206, 5.02693},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				equation
			...
			model Pulsverhalten
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				batteries.battery battery1(capacity_Ah=2) annotation(Placement(
					visible=true,
					transformation(
						origin={-54.9371, 4.93735},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.5) annotation(Placement(
					visible=true,
					transformation(
						origin={24.4165, 2.51346},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Ideal.IdealClosingSwitch idealclosingswitch1 annotation(Placement(
					visible=true,
					transformation(
						origin={-10.4129, 32.675},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Blocks.Sources.BooleanPulse booleanpulse1(
					period=200,
					width=80) annotation(Placement(
					visible=true,
					transformation(
						origin={-56.7325, 72.1724},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				equation
			...
			package examples
				model battery_cross_flow
					satcomponents.power.batteries.battery battery1 annotation(Placement(
						visible=true,
						transformation(
							origin={-47.0405, -13.0841},
							extent={{10, -10}, {-10, 10}},
							rotation=90)));
					satcomponents.power.batteries.battery battery2(
						startSOC=0.9,
						Vnominal=3.9) annotation(Placement(
						visible=true,
						transformation(
							origin={-15.8255, -12.0872},
							extent={{10, -10}, {-10, 10}},
							rotation=90)));
					satcomponents.power.batteries.battery battery3(
						startSOC=0.3,
						Vnominal=4.1) annotation(Placement(
						visible=true,
						transformation(
							origin={14.7664, -12.0249},
							extent={{10, -10}, {-10, 10}},
							rotation=90)));
					Modelica.Electrical.Analog.Basic.Resistor resistor1(R=1) annotation(Placement(
						visible=true,
						transformation(
							origin={38.9408, 25.2336},
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
						visible=true,
						transformation(
							origin={28.0374, -40.81},
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					equation
				...
				model Batterycontrollertest
					Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
						visible=true,
						transformation(
							origin={-47.117, -31.9605},
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					Modelica.Electrical.Analog.Basic.Resistor resistor1(R=2) annotation(Placement(
						visible=true,
						transformation(
							origin={-41.5271, 49.1044},
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					...
					Modelica.Electrical.Analog.Sensors.VoltageSensor voltagesensor2 annotation(Placement(
						visible=true,
						transformation(
							origin={15.4408, -3.64869},
							extent={{-10, -10}, {10, 10}},
							rotation=-90)));
					Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch1(
						control(start=false),
						Ron=1e-05,
						Goff=1e-05) annotation(Placement(
						visible=true,
						transformation(
							origin={-7.08738, 47.8045},
							extent={{10, 10}, {-10, -10}},
							rotation=0)));
					Modelica.Blocks.Logical.OnOffController onoffcontroller2(
						bandwidth=0.1,
						pre_y_start=false) annotation(Placement(
						visible=true,
						transformation(
							origin={-14.6604, 16.2939},
							extent={{10, -10}, {-10, 10}},
							rotation=0)));
					Modelica.Blocks.Sources.Constant constant1(k=2.9) annotation(Placement(
						visible=true,
						transformation(
							origin={73.13079999999999, 23.1997},
							extent={{10, -10}, {-10, 10}},
							rotation=0)));
					Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.02) annotation(Placement(
						visible=true,
						transformation(
							origin={25.8717, 48.2952},
							extent={{10, -10}, {-10, 10}},
							rotation=0)));
					satcomponents.power.batteries.battery battery1(startSOC=0.8) annotation(Placement(
						visible=true,
						transformation(
							origin={49.1329, -9.537570000000001},
							extent={{-10, -10}, {10, 10}},
							rotation=-90)));
					Modelica.Electrical.Analog.Sources.ConstantCurrent constantcurrent1(I=0.3) annotation(Placement(
						visible=true,
						transformation(
							origin={77.45659999999999, -10.1156},
							extent={{-10, -10}, {10, 10}},
							rotation=90)));
					equation
				...
				model Batterycontrollertest2
					Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
						...
						transformation(
							...
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					Modelica.Electrical.Analog.Basic.Resistor resistor1(R=4) annotation(Placement(
						visible=true,
						transformation(
							origin={-41.5271, 49.1044},
							extent={{-10, -10}, {10, 10}},
					...
					satcomponents.power.batteries.battery battery1(
						startSOC=0.8,
						capacity_Ah=0.5) annotation(Placement(
						visible=true,
						transformation(
							origin={47.9768, 15.3179},
							extent={{-10, -10}, {10, 10}},
							rotation=-90)));
					satcomponents.power.batteries.BDR bdr1 annotation(Placement(
						visible=true,
						transformation(
							origin={10.1156, 48.5549},
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					Modelica.Electrical.Analog.Sources.ConstantCurrent constantcurrent1(I=0.2) annotation(Placement(
						visible=true,
						transformation(
							origin={78.6127, 15.0289},
							extent={{-10, -10}, {10, 10}},
							rotation=90)));
					equation
				...
				model battery_with_dcmotor
					...
					Modelica.Mechanics.Rotational.Components.Fixed fixed1 annotation(Placement(
						...
						transformation(
							...
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					battery battery1(capacity_Ah=0.1) annotation(Placement(
						visible=true,
						transformation(
							origin={-28, 52},
							extent={{-10, -10}, {10, 10}},
					...
					Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
						...
						transformation(
							...
							extent={{-10, -10}, {10, 10}},
							rotation=0)));
					Modelica.Mechanics.Rotational.Components.BearingFriction bearingfriction1 annotation(Placement(
						visible=true,
						transformation(
							origin={52, 12},
							extent={{-10, -10}, {10, 10}},
			...
			model BDR
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
					visible=true,
					transformation(
						origin={-8.411210000000001, -93.76949999999999},
						extent={{-10, -10}, {10, 10}},
						rotation=0),
					iconTransformation(
						origin={-8.411210000000001, -93.76949999999999},
				...
				Modelica.Electrical.Analog.Basic.Resistor RS_on(R=0.001) annotation(Placement(
					visible=true,
					transformation(
						origin={48.2283, 0.857694},
						extent={{-9.431319999999999, -9.431319999999999}, {9.431319999999999, 9.431319999999999}},
						rotation=0)));
				Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch1(control(start=false)) annotation(Placement(
					visible=true,
					transformation(
						origin={-20.3, 0.454327},
						extent={{10, 10}, {-10, -10}},
						rotation=0)));
				equation
			...
			model BCR "BCR"
				...
				annotation(
					Icon(
						coordinateSystem(extent={{-100, -100}, {100, 100}}),
						graphics={Rectangle(extent = {{-95.5202, 78.90170000000001}, {95.5202, -78.90170000000001}}, origin = {-1.01156, 2.89017}), Text(textString = "Battery \\n Charge \\n Regulator", lineColor = {0, 0, 0}, extent = {{-80, 63}, {67, -37}})}),
					experiment(
						StopTime=1,
						StartTime=0));
			end BCR;
		...
		package solar_power
			model solarcell_simple_characteristic_lightconditions
				...
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					...
					width=1000,
					falling=5,
					period=3000) annotation(Placement(
					visible=true,
					transformation(
						origin={-84.29989999999999, 38.4724},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				solar_power.solarcell_simple solarcell_simple2(
					Maxexp=16,
					R_sh=10) annotation(Placement(
					visible=true,
					transformation(
						origin={-42.562, 39.2562},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={29.375, 41.875},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				equation
			...
			model diode_characteristic
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-27.5819, -19.9781},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Semiconductors.Diode diode1(Vt=2.25) annotation(Placement(
					visible=true,
					transformation(
						origin={-31.4003, 42.1499},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Sources.RampVoltage rampvoltage1(
					...
					visible=true,
					transformation(
						origin={-71.56999999999999, 17.5389},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.001) annotation(Placement(
					visible=true,
					transformation(
						origin={3.11174, 22.3479},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				equation
			...
			model solarcell_characteristic
				extends Modelica.Icons.Example;
				Exprgenerator exprgenerator1(alpha=10) annotation(Placement(
					visible=true,
					transformation(
						origin={58.3863, -42.6184},
						extent={{-7.45106, -7.45106}, {7.45106, 7.45106}},
						rotatibe151982db6cf70df9edce98f7fde8aca304d663on=0)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={38.5987, -59.042},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Blocks.Sources.Constant const(k=1367) annotation(Placement(
					visible=true,
					transformation(
						origin={-72.8763, 52.0374},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={38.1913, 52.3255},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				solarcell solarcell1 annotation(Placement(
					visible=true,
					transformation(
						origin={-28.7743, 52.5267},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				equation
			...
			model solarcell_characteristicV
				...
				Modelica.Electrical.Analog.Sources.RampVoltage rampvoltage1(
					...
					visible=true,
					transformation(
						origin={59.5041, 54.9587},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				solar_power.solarcell_simple solarcell_simple1 annotation(Placement(
					visible=true,
					transformation(
						origin={-37.6033, 52.8926},
						extent={{12, -12}, {-12, 12}},
						rotation=-270)));
				equation
				...
				annotation(
					experimbe151982db6cf70df9edce98f7fde8aca304d663ent(StopTime=1),
					Diagram,
					Icon);
			end solarcell_characteristicV;
			model solarcell_charactristic2
				extends Modelica.Icons.Example;
				Modelica.Blocks.Sources.Constant const(k=20) annotation(Placement(
					visible=true,
					transformation(
						origin={54.2395, 64.74769999999999},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={14.5514, -18.3734},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				dcmodel.dcdc_ideal_simple dcdc_ideal_simple1(
					eff=0.85,
					V_out=5,
					V_in_min=6.5,
					V_in_max=100) annotation(Placement(
					visible=true,
					transformation(
						origin={15.2695, 21.2575},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-23.9521, 27.8443},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					amplitude=1367,
					...
					visible=true,
					transformation(
						origin={-82.3197, -20.3677},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				solarcell solarcell1 annotation(Placement(
					visible=true,
					transformation(
						origin={-50.3989, 7.63791},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={55.2928, 6.2722},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-25.1497, -7.48503},
						extent={{12, 12}, {-12, -12}},
						rotation=-180)));
				equation
			...
			model solarcell_dcdccharactristic3
				...
				solar_power.solarcell_simple solarcell_simple1 annotation(Placement(
					visible=true,
					transformation(
						origin={-66.52889999999999, 11.5702},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					amplitude=1367,
					...
					visible=true,
					transformation(
						origin={-107.333, 11.6667},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={7.3041, -27.5606},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				equation
			...
			model solarcell
				...
				parameter Real A_cell(
					quantity="Area",
					unit="m2")=0.0026 "Active area of the solar cell in cmÃ‚Â²";
				...
				constant Real E0(
					...
					final unit="W")=1367.0 "Solarkonstante";
				extends Modelica.Electrical.Analog.Interfaces.OnePort;
				Modelica.Blocks.Interfaces.RealInput E_s(
					start=1367.0,
					final quantity="Power",
					final unit="W") "Solarkonstante" annotation(Placement(
					visible=true,
					transformation(
						origin={-1.26783, 70.9984},
						extent={{-12, 12}, {12, -12}},
						rotation=-90),
					iconTransformation(
						origin={-1.26783, 70.9984},
			...
			model solarcell_simple_characteristic
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(
					origin={11.7392, 13.6853},
					extent={{-12, -12}, {12, 12}})));
				Exprgenerator exprgenerator1(alpha=10) annotation(Placement(transformation(
					origin={42.6838, 13.9932},
					extent={{-7.45106, -7.45106}, {7.45106, 7.45106}})));
				Modelica.Blocks.Sources.Constant const(k=1367) annotation(Placement(transformation(
					origin={-81.875, 39.0625},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(transformation(
					origin={38.1913, 52.3255},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				solar_power.solarcell_simple solarcell_simple2(
			...
			model solarcell_simple
				...
				import Modelica.Blocks.*;
				extends Modelica.Electrical.Analog.Interfaces.TwoPin;
				parameter Real N_p=100.0 "Numper of parallel solar cells per string" annotation(Placement(transformation(
					origin={68.595, 65.2893},
					extent={{-12, -12}, {12, 12}})));
				parameter Real A_cell(
					quantity="Area",
					unit="m2")=0.0026 "Active area of the solar cell in cm2" annotation(Placement(transformation(
					origin={71.4876, 69.42149999999999},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.CurrentDensity I_mp=160 "[A/m2] Maximum Powerpoint Current" annotation(Placement(transformation(
					origin={65.7025, 64.4628},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.Voltage V_mp=2.277 "Maxium Powerpoint Voltage" annotation(Placement(transformation(
					origin={65.2893, 57.0248},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.CurrentDensity I_sc=168 "[A/m2] Short Circuit Current on Earth using solar Constant of " annotation(Placement(transformation(
					origin={63.6364, 58.2645},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.Voltage V_oc=2.565 "open circuit voltage" annotation(Placement(transformation(
					origin={69.00830000000001, 71.9008},
					extent={{-12, -12}, {12, 12}})));
				constant Real E0(
					final quantity="Power",
					final unit="W")=1367.0 "Solarkonstante" annotation(Placement(transformation(
					origin={65.7025, 66.1157},
					extent={{-12, -12}, {12, 12}})));
				SIunits.CurrentDensity i_sc_actual(start=0) annotation(Placement(transformation(
					origin={65.7025, 66.1157},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.Angle phi=0.0 "Angle between the vector normal to the active PVA (Photovoltaic Solar Array) surface and the plane of the incident solar radiation." annotation(Placement(transformation(
					origin={68.1818, 62.3967},
					extent={{-12, -12}, {12, 12}})));
				parameter Real N_s=25.0 "Number of series-connected solar cells per string" annotation(Placement(transformation(
					origin={69.8347, 63.2231},
					extent={{-12, -12}, {12, 12}})));
				SIunits.Current i_sc=A_cell * N_p * I_sc annotation(Placement(transformation(
					origin={69.42149999999999, 67.76860000000001},
					extent={{-12, -12}, {12, 12}})));
				parameter Real Maxexp=17 "Maximum exponent" annotation(Placement(transformation(
					origin={61.3861, 65.9123},
					extent={{-12, -12}, {12, 12}})));
				parameter SIunits.Resistance R_sh=10000 annotation(Placement(transformation(
					origin={62.5177, 58.2744},
					extent={{-12, -12}, {12, 12}})));
				SIunits.Current i(start=0) annotation(Placement(transformation(
					origin={65.6294, 64.4979},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Sources.SignalCurrent I_photonic annotation(Placement(transformation(
					origin={-43, 3},
					extent={{12, -12}, {-12, 12}},
					rotation=-90)));
				Modelica.Electrical.Analog.Semiconductors.Diode D_shunt(
					Vt=N_s * V_oc / log(I_sc / Ids + 1),
					Maxexp=Maxexp) annotation(Placement(transformation(
					origin={-13, 3},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor R_shunt(R=R_sh) annotation(Placement(transformation(
					origin={22, 3},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				input Modelica.Blocks.Interfaces.RealInput E_s(
					start=1367.0,
					final quantity="Power",
					final unit="W") "Solarkonstante" annotation(Placement(
					transformation(
					...
					iconTransformation(
						...
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor R_series(R=1e-05) annotation(Placement(
					visible=true,
					transformation(
						origin={57.422, -1.93449},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				protected
					parameter SIunits.CurrentDensity Ids=1e-06 "Diode Saturation Current" annotation(Placement(transformation(
						origin={66.1952, 63.0834},
						extent={{-12, -12}, {12, 12}})));
				equation
					i = n.i;
					i_sc_actual = i_sc * E_s / E0;
			...
			model EVS4
				Modelica.Blocks.Sources.Sine sine1(
					...
					freqHz=0.001,
					phase=-90,
					offset=500) annotation(Placement(
					visible=true,
					transformation(
						origin={-74.8314, -3.05553},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-9.9095, -43.1523},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				solar_power.solarcell_simple solarcell_simple1 annotation(Placement(
					visible=true,
					transformation(
						origin={-31.0897, -2.88462},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=25) annotation(Placement(
					visible=true,
					transformation(
						origin={59.9359, -6.41026},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				equation
			...
			model SA_Regulator
				...
				Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode2 annotation(Placement(
					visible=true,
					transformation(
						origin={21.0715, 4.47616},
						extent={{10, -10}, {-10, 10}},
						rotation=180)));
				Modelica.Electrical.Analog.Ideal.IdealDiode idealdiode1 annotation(Placement(
					visible=true,
					transformation(
						origin={-21.8513, 4.60906},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Semiconductors.ZDiode zdiode1(Bv=Vmax) annotation(Placement(
					visible=true,
					transformation(
						origin={0.100457, -27.8571},
						extent={{-10, -10}, {10, 10}},
						rotation=90)));
				Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
					visible=true,
					transformation(
						origin={-2.10526, -97.1429},
						extent={{-10, -10}, {10, 10}},
						rotation=0),
					iconTransformation(
						origin={-2.10526, -97.1429},
				...
				annotation(
					...
					Icon(
						coordinateSystem(
							...
							initialScale=0.1,
							grid={2, 2}),
						graphics={Rectangle(origin = {0.9022559999999999, -1.50376}, extent = {{-96.2406, 88.4211}, {96.2406, -88.4211}}), Text(origin = {-20.0009, -4.96504}, extent = {{-81.66, 72.03}, {113.237, -64.5123}}, textString = "SA \n regulator")}));
			end SA_Regulator;
		end solar_power;
		package dcmodel
			model dcdc_characteristic
				...
				dcmodel.dcdc_ideal_simple dcdc_ideal_simple1(
					...
					visible=true,
					transformation(
						origin={-38.1895, 14.1442},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={50.0707, -6.50636},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=20) annotation(Placement(
					visible=true,
					transformation(
						origin={-78.5311, -4.30002},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.1) annotation(Placement(
					visible=true,
					transformation(
						origin={12.447, -24.8939},
						extent={{12, 12}, {-12, -12}},
						rotation=-180)));
				equation
				...
				annotation(
					Diagram(graphics={Line(points = {{25.7426, 63.3663}}, rotation = 0, color = {0, 0, 255}, pattern = LinePattern.Solid, thickness = 0.25)}),
					experiment(
						StartTime=0.0,
						StopTime=1.0,
						Tolerance=1e-06));
			...
			model dc_limiter_test
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-55.7285, -43.5643},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-16.2777, 18.9533},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				dcmodel.dcdc_ideal_simple dcdc_ideal_simple1(
					eff=0.85,
					...
					V_in_min=10,
					V_in_max=100,
					slope=5) annotation(Placement(
					visible=true,
					transformation(
						origin={16.4074, 3.9604},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=100) annotation(Placement(
					visible=true,
					transformation(
						origin={57.1428, 5.9406},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor3(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-36.2726, -13.0493},
						extent={{12, 12}, {-12, -12}},
						rotation=-180)));
				Modelica.Electrical.Analog.Sources.RampVoltage rampvoltage1(
					V=100,
			...
			model DCtoDCModel "DC/DC Converter Model nach Torrey, D., & Selamogullari, U. (2002). A Behavioral Model for DC-DC Converters using Modelica. modelica.org"
				model SignalCurrent "Generic current source using the input signal asource current"
					...
					annotation(
						Diagram,
						Icon(graphics={Line(points = {{-88.2603, -0.282885}, {-52.6167, -0.282885}, {-48.3734, -0.282885}}, rotation = 0, color = {0, 0, 255}, pattern = LinePattern.Solid, thickness = 0.25), Ellipse(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-42.7157, 46.6761}, {47.8076, -49.505}}), Line(points = {{51.4851, 0.282885}, {89.10890000000001, 0.565771}}, rotation = 0, color = {0, 0, 255}, pattern = LinePattern.Solid, thickness = 0.25)}));
				end SignalCurrent;
				model CCS
				...
				class LimPICont
					...
					Modelica.Blocks.Interfaces.RealInput u annotation(Placement(
						...
						iconTransformation(
							...
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					Modelica.Blocks.Math.Gain Gain1(k=10) annotation(Placement(
						visible=true,
						transformation(
							origin={-22.3479, 40.4526},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					Modelica.Blocks.Math.Add Add1 annotation(Placement(
						visible=true,
						transformation(
							origin={31.4003, 5.09194},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin n annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Ideal.IdealDiode Din annotation(Placement(
					visible=true,
					transformation(
						origin={-82.9539, 32.7429},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Sensors.CurrentSensor Amp annotation(Placement(
					visible=true,
					transformation(
						origin={82.72029999999999, 25.0863},
						extent={{12, -12}, {-12, 12}},
						rotation=-270)));
				Modelica.Electrical.Analog.Basic.Resistor Rhk(R=10000000) annotation(Placement(
					visible=true,
					transformation(
						origin={-47.5463, -2.79786},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Ideal.IdealDiode Dout annotation(Placement(
					visible=true,
					transformation(
						origin={95.9451, -7.11907},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.Capacitor Cin(C=5e-05) annotation(Placement(
					visible=true,
					transformation(
						origin={-76.77549999999999, -2.72419},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				SignalCurrent SignalCurrent1 annotation(Placement(
					visible=true,
					transformation(
						origin={18.5897, -5.33737},
						extent={{12, -12}, {-12, 12}},
						rotation=-270)));
				Modelica.Electrical.Analog.Sensors.VoltageSensor Volt annotation(Placement(
					visible=true,
					transformation(
						origin={61.2614, -6.05931},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Capacitor Cout(C=5e-05) annotation(Placement(
					visible=true,
					transformation(
						origin={38.7774, -6.20137},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				LimPICont LimPI(
					Pout=Pout,
					Vref=Vref) annotation(Placement(
					visible=true,
					transformation(
						origin={-20, 80},
						extent={{-12, -12}, {12, 12}},
				...
				annotation(
					Diagram,
					Icon(graphics={Rectangle(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-87.69450000000001, 78.6421}, {88.5431, -74.6818}}), Text(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{10.4668, 68.1754}, {76.37909999999999, 30.2687}}, textString = "%Vref V"), Text(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-63.6492, 18.9533}, {57.9915, -33.0976}}, textString = "DCDC")}));
			end DCtoDCModel;
			model dcdc_ideal "DC/DC Converter Model nach Torrey, D., & Selamogullari, U. (2002). A Behavioral Model for DC-DC Converters using Modelica. modelica.org"
				...
				class LimPICont
					...
					Modelica.Blocks.Interfaces.RealInput u annotation(Placement(
						...
						iconTransformation(
							...
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					Modelica.Blocks.Math.Gain Gain1(k=gain) annotation(Placement(
						visible=true,
						transformation(
							origin={-22.3479, 40.4526},
							extent={{-12, -12}, {12, 12}},
				...
				LimPICont LimPI(
					...
					Vref=Vref,
					gain=10,
					gainI=1) annotation(Placement(
					visible=true,
					transformation(
						origin={-16.2708, 79.1807},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Interfaces.NegativePin n1 annotation(Placement(
					visible=true,
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin n annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Blocks.Logical.GreaterThreshold greaterthreshold1(threshold=Vinmin) annotation(Placement(
					visible=true,
					transformation(
						origin={-27.7228, 35.9264},
						extent={{-6.1579, -6.1579}, {6.1579, 6.1579}},
						rotation=0)));
				Modelica.Blocks.Logical.LessThreshold lessthreshold1(threshold=Vinmax) annotation(Placement(
					visible=true,
					transformation(
						origin={-27.7228, 20.6506},
						extent={{-6.1579, -6.1579}, {6.1579, 6.1579}},
						rotation=0)));
				Modelica.Blocks.Sources.Constant const(k=0) annotation(Placement(
					visible=true,
					transformation(
						origin={6.78922, 52.3338},
						extent={{-7.45106, -7.45106}, {7.45106, 7.45106}},
						rotation=0)));
				Modelica.Blocks.Logical.Nand nand1 annotation(Placement(
					visible=true,
					transformation(
						origin={0, 31.1174},
						extent={{-5.59809, -5.59809}, {5.59809, 5.59809}},
						rotation=0)));
				Modelica.Blocks.Sources.Constant Constant1(k=Vref) annotation(Placement(
					visible=true,
					transformation(
						origin={-85.20950000000001, 79.2957},
						extent={{-6.77369, -6.77369}, {6.77369, 6.77369}},
						rotation=0)));
				CCS CCS1 annotation(Placement(
					visible=true,
					transformation(
						origin={-13.4794, -12.1858},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Sensors.CurrentSensor Amp annotation(Placement(
					visible=true,
				...
				Modelica.Electrical.Analog.Sensors.VoltageSensor Volt annotation(Placement(
					visible=true,
					transformation(
						origin={63.2416, -6.90797},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Ideal.IdealDiode Dout annotation(Placement(
					visible=true,
					transformation(
						origin={41.0653, -5.98753},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Sensors.VoltageSensor voltagesensor1 annotation(Placement(
					visible=true,
					transformation(
						origin={-61.1033, -1.41443},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Sources.SignalCurrent signalcurrent1 annotation(Placement(
					visible=true,
					transformation(
						origin={23.4795, -5.9406},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Ideal.IdealDiode Din annotation(Placement(
					visible=true,
					transformation(
						origin={-84.9341, 27.0852},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Blocks.Logical.Switch switch1 annotation(Placement(
					visible=true,
					transformation(
						origin={22.9137, 28.8543},
						extent={{-6.1579, 6.1579}, {6.1579, -6.1579}},
						rotation=-90)));
				equation
			...
			connector Powerconnector_out
				...
				annotation(
					Icon(graphics={Polygon(points = {{-38.7553, 84.29989999999999}, {34.7949, 84.5827}, {89.10890000000001, 3.9604}, {40.4526, -86.2801}, {-41.5842, -87.41160000000001}, {-88.82599999999999, 6.78925}, {-38.7553, 84.29989999999999}}, rotation = 0, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.Solid, lineThickness = 0.25)}),
					Diagram(graphics={Polygon(points = {{-20.3678, 42.7157}, {22.0651, 42.4328}, {41.867, 9.33522}, {22.6308, -31.4003}, {-24.0453, -31.1174}, {-44.6959, 5.37482}, {-45.5446, 7.63791}, {-20.3678, 42.7157}}, rotation = 0, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.Solid, lineThickness = 0.25), Text(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-58.8402, 74.9646}, {61.1033, 49.7878}}, textString = "Power Connector")}));
			end Powerconnector_out;
			connector Powerconnector_in
				input Modelica.SIunits.Power power;
				annotation(
					Icon(graphics={Polygon(points = {{-38.7553, 84.29989999999999}, {34.7949, 84.5827}, {89.10890000000001, 3.9604}, {40.4526, -86.2801}, {-41.5842, -87.41160000000001}, {-88.82599999999999, 6.78925}, {-38.7553, 84.29989999999999}}, rotation = 0, lineColor = {0, 0, 255}, fillColor = {255, 255, 0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25)}),
			...
			model DCtoPower "generic ideal DC/DC Converter with Power Output"
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin n annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				dcmodel.Powerconnector_out power_out[m] annotation(Placement(
					visible=true,
					transformation(
						origin={100.99, -0.848656},
						extent={{-12, -12}, {12, 12}},
						rotation=0),
					iconTransformation(
						origin={100.99, -0.848656},
				...
				annotation(
					Diagram,
					Icon(graphics={Rectangle(rotation = 0, lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-87.9774, 80.3395}, {98.16119999999999, -79.77370000000001}})}));
			end DCtoPower;
			model dcdc_ideal_simple
				import Modelica.Constants.pi;
				extends Modelica.Electrical.Analog.Interfaces.TwoPort;
				parameter Real eff=0.85 annotation(Placement(transformation(
					origin={71.521, -76.3754},
					extent={{-12, -12}, {12, 12}})));
				...
				annotation(
					Icon(
						coordinateSystem(extent={{-100, -100}, {100, 100}}),
						graphics={Rectangle(fillColor = {0, 0, 255}, extent = {{-87.69450000000001, 78.6421}, {88.5431, -74.6818}}), Text(textString = "%V_out", fillColor = {0, 0, 255}, extent = {{10.4668, 68.1754}, {76.37909999999999, 30.2687}}), Text(textString = "DCDC", fillColor = {0, 0, 255}, extent = {{-63.6492, 18.9533}, {57.9915, -33.0976}})}),
					experiment(
						StopTime=1,
						StartTime=0));
			...
			model dcdc_ideal_simple_improved
				parameter Real eff=0.85 annotation(Placement(transformation(
					origin={60.2546, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				parameter Modelica.SIunits.Voltage V_out=5 annotation(Placement(transformation(
					origin={60.2546, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				parameter Modelica.SIunits.Voltage V_in_min=6.5 annotation(Placement(transformation(
					origin={60.2546, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				parameter Modelica.SIunits.Voltage V_in_max=100 annotation(Placement(transformation(
					origin={60.2546, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				Modelica.SIunits.Voltage v1 "Voltage drop over the left port" annotation(Placement(transformation(
					origin={60.5375, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				Modelica.SIunits.Voltage v2 "Voltage drop over the right port" annotation(Placement(transformation(
					origin={60.5375, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				Modelica.SIunits.Current i1 "Current flowing from pos. to neg. pin of the left port" annotation(Placement(transformation(
					origin={60.5375, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				Modelica.SIunits.Current i2 "Current flowing from pos. to neg. pin of the right port" annotation(Placement(transformation(
					origin={60.5375, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				dcmodel.dcdc_ideal_simple dcdc_ideal_simple1(
					eff=eff,
					V_out=V_out,
					V_in_min=V_in_min,
					V_in_max=V_in_max) annotation(Placement(transformation(
					origin={-3.67751, 6.78922},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C=1e-9) annotation(Placement(
					visible=true,
					transformation(
						origin={-52, 4},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.1) annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor4(R=0.1) annotation(Placement(
					visible=true,
					transformation(
						origin={-36, -50},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.1) annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor3(R=0.1) annotation(Placement(
					visible=true,
					transformation(
						origin={-38, 54},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Electrical.Analog.Interfaces.PositivePin p2 annotation(Placement(
					visible=true,
					transformation(
						origin={100.504, 40.4328},
						extent={{-12, -12}, {12, 12}},
						rotation=0),
					iconTransformation(
						origin={92.5035, 42.4328},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Interfaces.NegativePin n1 annotation(Placement(
					visible=true,
				...
				annotation(
					Icon(
						coordinateSystem(extent={{-100, -100}, {100, 100}}),
						graphics={Rectangle(fillColor = {0, 0, 255}, extent = {{-87.69450000000001, 78.6421}, {88.5431, -74.6818}}), Text(textString = "%V_out", fillColor = {0, 0, 255}, extent = {{-8.486520000000001, 67.6096}, {57.4258, 29.7029}}), Text(textString = "DCDC", fillColor = {0, 0, 255}, extent = {{-63.6492, 18.9533}, {57.9915, -33.0976}}), Text(textString = "V", fillColor = {0, 0, 255}, extent = {{54.314, 63.3663}, {75.8133, 32.8147}})}),
					Diagram(coordinateSystem(extent={{-100, -100}, {100, 100}})),
					experiment(
						StopTime=1,
						StartTime=0));
			...
			package examples
				model powerdctest
					...
					Modelica.Electrical.Analog.Sources.SineVoltage sinevoltage1(
						V=35,
						phase=90,
						freqHz=0.0002) annotation(Placement(
						visible=true,
						transformation(
							origin={-78.3593, -1.69731},
							extent={{-12, 12}, {12, -12}},
							rotation=-90)));
					dcmodel.DCtoPower dctopower1(
						m=1,
						V_in_max=100,
						V_in_min=5) annotation(Placement(
						visible=true,
						transformation(
							origin={24.373, 6.47989},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=10) annotation(Placement(
						visible=true,
						transformation(
							origin={-48.6014, 20.979},
							extent={{12, 12}, {-12, -12}},
							rotation=-180)));
					Modelica.Electrical.Analog.Basic.Resistor resistor2(R=0.0001) annotation(Placement(
						visible=true,
						transformation(
							origin={-7.34162, 21.0003},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					iboss_power_consumption.OBCpower obcpower1 annotation(Placement(
						visible=true,
						transformation(
							origin={72.7273, 23.4266},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					equation
				...
				model dcdc_pid_characteristic
					...
					Modelica.Blocks.Sources.Ramp ramp1(
						...
						origin={7, 83},
						extent={{-12, -12}, {12, 12}})));
					Modelica.Blocks.Sources.Constant const(k=10) annotation(Placement(transformation(
						origin={7, 48},
						extent={{-12, -12}, {12, 12}})));
					Modelica.Electrical.Analog.Basic.VariableResistor variableresistor1 annotation(Placement(transformation(
						origin={50.0707, -6.50636},
					...
					Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1(V=20) annotation(Placement(transformation(
						...
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
					Modelica.Electrical.Analog.Basic.Resistor resistor1(R=0.1) annotation(Placement(transformation(
						origin={12.447, -24.8939},
						extent={{-12, 12}, {12, -12}},
						rotation=-180)));
				...
				model dc_sin_test
					...
					Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
						visible=true,
						transformation(
							origin={-25.7285, -35.5643},
							extent={{-12, -12}, {12, 12}},
							rotation=0)));
					Modelica.Electrical.Analog.Sources.CosineVoltage cosinevoltage1(
						V=20,
						freqHz=0.1,
						offset=0,
						startTime=2) annotation(Placement(
						visible=true,
						transformation(
							origin={-58, 4},
							extent={{-10, -10}, {10, 10}},
							rotation=-90)));
					dcdc_ideal_simple_improved dcdc_ideal_simple_improved1 annotation(Placement(
						visible=true,
						transformation(
							origin={20, 10},
							extent={{-10, -10}, {10, 10}},
			...
			model dcdc_pid
				...
				Modelica.Electrical.Analog.Interfaces.PositivePin p1 annotation(Placement(
					transformation(
						origin={-92.22069999999999, 41.867},
						extent={{-12, -12}, {12, 12}}),
					iconTransformation(
						origin={-92.22069999999999, 41.867},
						extent={{-12, -12}, {12, 12}})));
				...
				Modelica.SIunits.Current i2 "Current flowing from pos. to neg. pin of the right port" annotation(Placement(transformation(
					origin={60.5375, -80.6223},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Sensors.VoltageSensor voltagesens annotation(Placement(transformation(
					origin={70, 0},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
				Modelica.Electrical.Analog.Sources.SignalCurrent I1 annotation(Placement(transformation(
					origin={-55, 0},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
				Modelica.Electrical.Analog.Sources.SignalCurrent I2 annotation(Placement(transformation(
					origin={50, 0},
					extent={{-10, -10}, {10, 10}},
					rotation=90)));
				Modelica.Blocks.Continuous.LimPID pID(
					...
					yMax=P_out / V_out,
					yMin=0,
					initType=Modelica.Blocks.Types.InitPID.NoInit) annotation(Placement(transformation(extent={{-25, 45}, {-5, 65}})));
				...
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C(displayUnit="nF")=1e-07) annotation(Placement(transformation(
					origin={-75, 0},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
		...
		package examples
			...
			model PID_verbraucher
				...
				Modelica.Electrical.Analog.Sources.SineVoltage sinevoltage1(
					V=10,
					freqHz=0.1,
					offset=20) annotation(Placement(
					visible=true,
					transformation(
						origin={-29.6667, -60.3333},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				satpower.verbraucher verbraucher1 annotation(Placement(
					visible=true,
					transformation(
						origin={-15.3333, 27},
						extent={{-10, -10}, {10, 10}},
			...
			model EVS3
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=25) annotation(Placement(transformation(
					origin={59.9359, -6.41026},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved1(
					V_out=12,
					V_in_min=15) annotation(Placement(transformation(
					origin={24.611, 3.39463},
					extent={{-12, -12}, {12, 12}})));
				dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved2(
					V_out=5,
					V_in_min=8) annotation(Placement(transformation(
					origin={24.611, 33.3805},
					extent={{-12, -12}, {12, 12}})));
				dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved3(
					V_out=3.3,
					V_in_min=5) annotation(Placement(transformation(
					origin={23.4795, 66.4781},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=25) annotation(Placement(transformation(
					origin={59.6888, 34.512},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor3(R=25) annotation(Placement(transformation(
					origin={60.2546, 67.0438},
					extent={{-12, 12}, {12, -12}},
					rotation=-90)));
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					amplitude=1000,
					...
					origin={-77.5106, -1.41443},
					extent={{-12, -12}, {12, 12}})));
				solar_power.solarcell_simple solarcell_simple1(R_sh=100) annotation(Placement(transformation(
					origin={-44.9511, -2.60173},
					extent={{12, -12}, {-12, 12}},
					rotation=90)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(
					origin={-28.0029, -43.6886},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Basic.Resistor resistor5 annotation(Placement(transformation(
					origin={-14.4272, 25.1768},
					extent={{-12, -12}, {12, 12}})));
				Modelica.Electrical.Analog.Basic.Resistor resistor4 annotation(Placement(transformation(
					origin={-13.5785, -1.69731},
					extent={{-12, -12}, {12, 12}})));
				equation
			...
			model EVS5
				dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved1(
					V_out=12,
					V_in_min=15) annotation(Placement(
					visible=true,
					transformation(
						origin={24.611, 3.39463},
						extent={{-12, -12}, {12, 12}},
				...
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					...
					falling=60,
					period=3000,
					width=1000) annotation(Placement(
					visible=true,
					transformation(
						origin={-77.5106, -1.41443},
						extent={{-12, -12}, {12, 12}},
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					...
					transformation(
						...
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor4(R=0.001) annotation(Placement(
					visible=true,
					transformation(
						origin={-13.5785, -1.69731},
						extent={{-12, -12}, {12, 12}},
				...
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=25) annotation(Placement(
					...
					transformation(
						...
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				solar_power.solarcell_simple solarcell_simple1(R_sh=100) annotation(Placement(
					visible=true,
					transformation(
						origin={-44.9511, -2.60173},
						extent={{12, -12}, {-12, 12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor5(R=0.001) annotation(Placement(
					visible=true,
					transformation(
						origin={-14.1443, 17.5389},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved2 annotation(Placement(
					visible=true,
					transformation(
						origin={25.4597, 32.2489},
						extent={{-12, -12}, {12, 12}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=25) annotation(Placement(
					visible=true,
					transformation(
						origin={59.6888, 29.703},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1 annotation(Placement(
					visible=true,
					transformation(
						origin={6.22348, -22.6308},
						extent={{-12, 12}, {12, -12}},
						rotation=-90)));
				equation
			...
			model PCU_example
				...
				satcomponents.power.batteries.battery battery1(
					Vnominal=20,
					soc(start=0.9)) annotation(Placement(
					visible=true,
					transformation(
						origin={-86.1272, -5.49133},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				satcomponents.power.PCU pcu1(C1.v(start=20)) annotation(Placement(
					visible=true,
					transformation(
						origin={-37.2832, 4.04624},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=100) annotation(Placement(
					visible=true,
					transformation(
						origin={23.9884, 22.2543},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor2(R=100) annotation(Placement(
					visible=true,
					transformation(
						origin={24.2775, 1.15607},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor3(R=100) annotation(Placement(
					visible=true,
					transformation(
						origin={24.5665, -21.3873},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={-63.2948, -24.2775},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				equation
			...
			model solarpowerwithbattery
				...
				power.batteries.battery battery1(
					...
					visible=true,
					transformation(
						origin={13.0976, -21.9474},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				satcomponents.power.batteries.BDR bdr1(Vmin=27) annotation(Placement(
					visible=true,
					transformation(
						origin={3.60902, 30.9774},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=40) annotation(Placement(
					visible=true,
					transformation(
						origin={-22.2511, -1.29973},
						extent={{-9.62429, -9.62429}, {9.62429, 9.62429}},
						rotation=-90)));
				equation
			...
			model EPS_without_GND
				satcomponents.power.solar_power.solarcell_simple solarcell_simple1 annotation(Placement(
					visible=true,
					transformation(
						origin={-34.3931, -37.2832},
						extent={{10, -10}, {-10, 10}},
						rotation=0)));
				satcomponents.power.batteries.battery battery1(Vnominal=40.0) annotation(Placement(
					visible=true,
					transformation(
						origin={-33.815, 8.381500000000001},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					amplitude=1367,
					...
					visible=true,
					transformation(
						origin={-82.94799999999999, -17.341},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor Kontaktwiederstand(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-13.5838, 29.1908},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor Kontaktwiderstand2(R=0.0001) annotation(Placement(
					visible=true,
					transformation(
						origin={-13.8728, -15.6069},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					visible=true,
					transformation(
						origin={51.7341, -19.9422},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C=1e-10) annotation(Placement(
					visible=true,
					transformation(
						origin={11.5607, -36.4162},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor2(C=1e-10) annotation(Placement(
					visible=true,
					transformation(
						origin={13.2948, 47.3988},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=100) annotation(Placement(
					visible=true,
					transformation(
						origin={-33.237, 48.5549},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				equation
			...
			model PCU_pid_example
				...
				batteries.battery battery1(
					soc(start=0.9),
					Vnominal=20) annotation(Placement(transformation(
					origin={-86.1272, -5.49133},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
				PCU_pid pcu1(C1(v(start=20))) annotation(Placement(transformation(
					origin={-37.2832, 4.04624},
					extent={{-10, -10}, {10, 10}})));
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=100) annotation(Placement(transformation(
					origin={23.9884, 22.2543},
					extent={{-10, -10}, {10, 10}})));
		...
		model verbraucher_pid
			...
			Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(
				visible=true,
				transformation(
					origin={-49.6667, -99.33329999999999},
					extent={{-10, -10}, {10, 10}},
					rotation=0),
				iconTransformation(
					origin={-49.6667, -99.33329999999999},
			...
			Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
				visible=true,
				transformation(
					origin={47.3333, -99.33329999999999},
					extent={{-10, -10}, {10, 10}},
					rotation=0),
				iconTransformation(
					origin={47.3333, -99.33329999999999},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Sensors.CurrentSensor currentsensor1 annotation(Placement(
				visible=true,
				transformation(
					origin={-49, -53},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Blocks.Continuous.LimPID PID(
				...
				Td=0.1,
				yMin=1,
				y_start=1000) annotation(Placement(
				visible=true,
				transformation(
					origin={-27, 65.33329999999999},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Sources.Constant const(k=power_nominal) annotation(Placement(
				visible=true,
				transformation(
					origin={-74, 65},
					extent={{-10, -10}, {10, 10}},
			...
			annotation(
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Rectangle(origin = {1.83333, -2.83333}, extent = {{-84.16670000000001, -92.16670000000001}, {84.16670000000001, 92.16670000000001}}), Text(origin = {1.66667, 63}, extent = {{-63.3333, 10.6667}, {63.3333, -10.6667}}, textString = "Verbraucher"), Text(origin = {3, -23}, extent = {{-61.3333, 35.3333}, {61.3333, -35.3333}}, textString = "%power_nominal W")}),
				experiment(
					StartTime=0.0,
					StopTime=100.0,
					Tolerance=1e-06));
		...
		model verbraucher
			parameter Modelica.SIunits.Power power_nominal=10.0;
			parameter Modelica.SIunits.Voltage v_nominal=12.0;
			...
			Modelica.Electrical.Analog.Basic.Resistor resistor1(
				R=v_nominal * v_nominal / power_nominal,
				useHeatPort=useHeatPort) annotation(Placement(
				visible=true,
				transformation(
					origin={0, 40},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_a heatPort(
				...
				Q_flow=-LossPower) annotation(Placement(
				visible=true,
				transformation(
					origin={-100, -18},
					extent={{-10, -10}, {10, 10}},
				...
				iconTransformation(
					...
					rotation=0)));
			equation
				connect(heatPort, resistor1.heatPort) annotation(Line(points = {{-100, -18}, {0, -18}, {0, 30}, {0, 30}}, color = {191, 0, 0}));
				connect(resistor1.n, pin_n) annotation(Line(points = {{10, 40}, {48, 40}, {48, -98}}, color = {0, 0, 255}));
				connect(pin_p, resistor1.p) annotation(Line(points = {{-50, -99}, {-50, 40}, {-10, 40}}, color = {0, 0, 255}));
			...
			annotation(
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Rectangle(origin = {1.83333, -2.83333}, extent = {{-84.1667, -92.1667}, {84.1667, 92.1667}}), Text(origin = {1.66667, 63}, extent = {{-63.3333, 10.6667}, {63.3333, -10.6667}}, textString = "Verbraucher"), Text(origin = {3, -23}, extent = {{-61.3333, 35.3333}, {61.3333, -35.3333}}, textString = "%power_nominal W"), Text(origin = {-1, 21}, extent = {{-67, 21}, {67, -21}}, textString = "%name")}));
		end verbraucher;
		model PCU_pid
			...
			Modelica.Electrical.Analog.Interfaces.PositivePin VCC12 annotation(Placement(
				...
				iconTransformation(
					origin={99.2928, 44.6959},
					extent={{-12, -12}, {12, 12}})));
			dcmodel.dcdc_ideal_simple_improved dcdc_pid3(
				V_out=3.3,
				V_in_min=5) annotation(Placement(transformation(
				origin={57, -29},
				extent={{-10, -10}, {10, 10}})));
			dcmodel.dcdc_ideal_simple_improved dcdc_pid5 annotation(Placement(transformation(
				origin={57.5145, 3.75723},
				extent={{-10, -10}, {10, 10}})));
			dcmodel.dcdc_ideal_simple_improved dcdc_pid12(
				V_out=12,
				V_in_min=15) annotation(Placement(transformation(
				origin={57.2254, 41.0405},
				extent={{-10, -10}, {10, 10}})));
		...
		model HBridge
			...
			Modelica.Electrical.Analog.Ideal.IdealClosingSwitch idealclosingswitch4 annotation(Placement(
				visible=true,
				transformation(
					origin={-34, -40},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
			Modelica.Electrical.Analog.Ideal.IdealClosingSwitch idealclosingswitch3 annotation(Placement(
				visible=true,
				transformation(
					origin={36, -40},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Electrical.Analog.Ideal.IdealClosingSwitch idealclosingswitch1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
			Modelica.Electrical.Analog.Ideal.IdealClosingSwitch idealclosingswitch2 annotation(Placement(
				visible=true,
				transformation(
					origin={34, 38},
					extent={{-10, -10}, {10, 10}},
					rotation=-90)));
			Modelica.Blocks.Interfaces.BooleanInput forward annotation(Placement(
				visible=true,
				transformation(
					origin={-34, -102},
					extent={{-10, -10}, {10, 10}},
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=90)));
			Modelica.Blocks.Interfaces.BooleanInput reverse annotation(Placement(
				visible=true,
				transformation(
					origin={30, -102},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.PositivePin pin_p1 annotation(Placement(
				visible=true,
				transformation(
					origin={100, 60},
					extent={{-10, -10}, {10, 10}},
				...
				iconTransformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Interfaces.NegativePin pin_n1 annotation(Placement(
				visible=true,
				transformation(
					origin={100, -60},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch1 annotation(Placement(
				visible=true,
				transformation(
					origin={-66, 0},
					extent={{-10, 10}, {10, -10}},
					rotation=0)));
			Modelica.Blocks.Logical.Or or1 annotation(Placement(
				visible=true,
				transformation(
					origin={-66, -36},
					extent={{-10, -10}, {10, 10}},
					rotation=90)));
			Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch2 annotation(Placement(
				visible=true,
				transformation(
					origin={4, 0},
					extent={{-10, 10}, {10, -10}},
					rotation=0)));
			equation
				connect(or1.y, idealopeningswitch2.control) annotation(Line(points = {{-66, -25}, {-66, -25}, {-66, -18}, {4, -18}, {4, -8}, {4, -8}}, color = {255, 0, 255}));
				connect(idealopeningswitch2.n, idealclosingswitch3.p) annotation(Line(points = {{14, 0}, {36, 0}, {36, -30}, {36, -30}}, color = {0, 0, 255}));
				connect(idealopeningswitch2.p, idealclosingswitch4.p) annotation(Line(points = {{-6, 0}, {-34, 0}, {-34, -30}, {-34, -30}}, color = {0, 0, 255}));
				connect(or1.u2, reverse) annotation(Line(points = {{-58, -48}, {-58, -62}, {30, -62}, {30, -102}}, color = {255, 0, 255}));
				connect(or1.u1, forward) annotation(Line(points = {{-66, -48}, {-66, -48}, {-66, -72}, {-34, -72}, {-34, -100}, {-34, -100}}, color = {255, 0, 255}));
				connect(idealopeningswitch1.control, or1.y) annotation(Line(points = {{-66, -7}, {-66, -7}, {-66, -26}, {-66, -26}}, color = {255, 0, 255}));
				connect(idealopeningswitch1.n, idealclosingswitch4.p) annotation(Line(points = {{-56, 0}, {-34, 0}, {-34, -30}, {-34, -30}}, color = {0, 0, 255}));
				connect(ground1.p, idealopeningswitch1.p) annotation(Line(points = {{-88, -8}, {-88, 0}, {-76, 0}}, color = {0, 0, 255}));
			...
			annotation(
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Text(origin = {-49, 13}, extent = {{-27, 11}, {13, -39}}, textString = "IN"), Text(origin = {45, 41}, extent = {{-37, -19}, {45, -65}}, textString = "OUT"), Text(origin = {-11, -49}, extent = {{-47, -5}, {-1, -41}}, textString = "FW"), Text(origin = {55, -49}, extent = {{-47, -5}, {-1, -41}}, textString = "RV")}));
		end HBridge;
		model dc_power
			parameter Modelica.SIunits.Resistance r_internal=0.1;
			parameter Modelica.SIunits.Voltage v=25;
			Modelica.SIunits.Voltage v_out(start=v);
			...
			Modelica.Electrical.Analog.Interfaces.PositivePin p annotation(Placement(
				...
				iconTransformation(
					origin={100,60},
					extent={{-10,-10},{10,10}})));
			Modelica.Electrical.Analog.Sources.RampVoltage rampVoltage1(V=v) annotation(Placement(transformation(
				origin={-40,5},
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			equation
				v_out = p.v - n.v;
			equation
				connect(rampVoltage1.p,p) annotation(Line(
					points={{-40,15},{-40,20},{-40,40},{95,40},{100,40}},
					thickness=0.0625));
				connect(rampVoltage1.n,n) annotation(Line(
					points={{-40,-5},{-40,-10},{-40,-40},{95,-40},{100,-40}},
					thickness=0.0625));
			annotation(
				viewinfo[0](
				...
				Icon(graphics={
							...
							Text(
								textString="%name=%V",
								extent={{18,-104},{150,-72}},
								origin={-80,2}),
							Text(
								textString="+",
								extent={{-166,64},{-124,22}},
								origin={202,20}),
							Text(
								textString="-",
								extent={{20,50},{66,6}},
		...
		model dc_power_realistic
			...
			Modelica.Electrical.Analog.Sources.RampVoltage rampVoltage1(V=v) annotation(Placement(transformation(
				...
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C=c_int) annotation(Placement(transformation(
				origin={20,10},
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			Modelica.Electrical.Analog.Basic.Resistor resistor1(R=r_internal*0.5) annotation(Placement(transformation(extent={{-25,25},{-5,45}})));
			Modelica.Electrical.Analog.Basic.Resistor resistor2(R=r_internal*0.5) annotation(Placement(transformation(extent={{45,25},{65,45}})));
			equation
				v_out = pin_p.v - pin_n.v;
			equation
				connect(rampVoltage1.p,resistor1.p) annotation(Line(
					points={{-40,15},{-40,20},{-40,35},{-30,35},{-25,35}},
					thickness=0.0625));
				connect(resistor1.n,capacitor1.p) annotation(Line(
					points={{-5,35},{0,35},{20,35},{20,25},{20,20}},
					thickness=0.0625));
				connect(capacitor1.p,resistor2.p) annotation(Line(
					points={{20,20},{20,25},{20,35},{40,35},{45,35}},
					thickness=0.0625));
				connect(resistor2.n,pin_p) annotation(Line(
					points={{65,35},{70,35},{95,35},{95,40},{100,40}},
					thickness=0.0625));
				connect(rampVoltage1.n,capacitor1.n) annotation(Line(
					points={{-40,-5},{-40,-10},{20,-10},{20,-5},{20,0}},
					thickness=0.0625));
				connect(capacitor1.n,pin_n) annotation(Line(
					points={{20,0},{20,-5},{20,-40},{95,-40},{100,-40}},
					thickness=0.0625));
			annotation(
				Icon(graphics={
					Line(
	...
	package AOCS
		model freerotatingcube
			...
			Modelica.Mechanics.MultiBody.Parts.BodyBox bodybox1(
				...
				angles_fixed=true,
				w_0_fixed=true,
				w_0_start={0.1, 0.2, 0.3},
				z_0_fixed=false,
				useQuaternions=false,
				mo=1) annotation(Placement(transformation(
				origin={10.3333, 17.6667},
				extent={{-10, -10}, {10, 10}})));
			Parts.IMU iMU1(
				id=1,
				noise_ung(
					amplitude=0.1,
					seed={1, 2, 3})) annotation(Placement(transformation(extent={{45, 5}, {65, 25}})));
			equation
		...
		model gyroeffects
			...
			inner Modelica.Mechanics.MultiBody.World world(gravityType=Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(
				visible=true,
				transformation(
					origin={-74.9845, 45.4769},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r={0, 0.03, 0.02}) annotation(Placement(
				visible=true,
				transformation(
					origin={-34.688, 0.5999409999999999},
					extent={{10, -10}, {-10, 10}},
					rotation=180)));
			Modelica.Mechanics.MultiBody.Parts.BodyCylinder Reaktionsrad(
				r={0, 0, 0.01},
				diameter=0.03) annotation(Placement(
				visible=true,
				transformation(
					origin={43.8322, -0.369059},
					extent={{10, -10}, {-10, 10}},
					rotation=180)));
			Modelica.Mechanics.MultiBody.Parts.Body Struktur(
				...
				I_33=0.0016,
				r_CM={0, 0, 0.05},
				useQuaternions=false) annotation(Placement(
				visible=true,
				transformation(
					origin={-65.7255, 0.291741},
					extent={{-10, -10}, {10, 10}},
					rotation=180)));
			...
			Modelica.Blocks.Sources.Trapezoid trapezoid1(
				...
				visible=true,
				transformation(
					origin={-57.9059, -33.6468},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(useQuaternions=false) annotation(Placement(
				visible=true,
				transformation(
					origin={-44.2197, 45.3757},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			equation
		...
		model cubesatwith3axisreactionwheel
			...
			Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(
				useQuaternions=false,
				w_rel_a_start={0.0, 0, 0}) annotation(Placement(
				visible=true,
				transformation(
					origin={-44.2197, 45.3757},
					extent={{-10, -10}, {10, 10}},
			...
			Modelica.Blocks.Sources.Trapezoid trapezoid1(
				...
				period=5000,
				nperiod=-1,
				amplitude=1367) annotation(Placement(
				visible=true,
				transformation(
					origin={-29.8712, -10.2364},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			satcomponents.Cubesat cubesat1 annotation(Placement(
				visible=true,
				transformation(
					origin={-7.80347, 46.2428},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			equation
		...
		model reactionwheelexample
			...
			Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r={0, 0.03, 0.02}) annotation(Placement(
				visible=true,
				transformation(
					origin={12.1328, -11.8278},
					extent={{10, -10}, {-10, 10}},
					rotation=180)));
			satcomponents.AOCS.Parts.reactionwheelsimple reactionwheel1 annotation(Placement(
				visible=true,
				transformation(
					origin={46.3006, -7.86127},
					extent={{-19.0173, -19.0173}, {19.0173, 19.0173}},
					rotation=-90)));
			Modelica.Electrical.Analog.Sources.PulseVoltage pulsevoltage1(
				V=0.5,
				width=0.5,
				period=7.5,
				startTime=10) annotation(Placement(
				visible=true,
				transformation(
					origin={36.7052, -58.9595},
					extent={{10, -10}, {-10, 10}},
					rotation=0)));
			Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
				visible=true,
				transformation(
					origin={8.670500000000001, -69.36409999999999},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(useQuaternions=false) annotation(Placement(
				visible=true,
				transformation(
					origin={-40.7515, 41.3295},
					extent={{10, -10}, {-10, 10}},
					rotation=90)));
			inner Modelica.Mechanics.MultiBody.World world(gravityType=Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(
				visible=true,
				transformation(
					origin={1.02706, 61.3729},
					extent={{-10, -10}, {10, 10}},
					rotation=180)));
			satcomponents.AOCS.Parts.Struktur struktur1 annotation(Placement(
				visible=true,
				transformation(
					origin={-42.8613, -15.5202},
					extent={{-31.3006, -31.3006}, {31.3006, 31.3006}},
					rotation=0)));
			equation
		...
		package Parts
			...
			model reactionwheelsimple
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
					visible=true,
					transformation(
						origin={99.711, -67.6301},
						extent={{-10, -10}, {10, 10}},
						rotation=0),
					iconTransformation(
						origin={98.2659, -73.4104},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Electrical.Analog.Sensors.PowerSensor powersensor1 annotation(Placement(
					visible=true,
					transformation(
						origin={71.3873, -23.9884},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor resistor1 annotation(Placement(
					visible=true,
					transformation(
						origin={71.3873, -55.4913},
						extent={{-10, -10}, {10, 10}},
						rotation=-90)));
				Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(
					visible=true,
					transformation(
						...
						rotation=0),
					iconTransformation(
						origin={98.2659, -37.8613},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Mechanics.MultiBody.Parts.Body Schwungmasse(
					r_CM={0, 0, 0},
					m=0.02,
					I_11=1e-07,
					I_22=1e-07,
					I_33=1e-07) annotation(Placement(
					visible=true,
					transformation(
						origin={-0.867052, 28.0347},
						extent={{-10, -10}, {10, 10}},
						rotation=90)));
				equation
			...
			model IMU
				...
				satcomponents.blocks.noise_ung noise_ung2(
					amplitude=noiseamp,
					seed=2) annotation(Placement(transformation(extent={{-40, 14}, {-19, 25}})));
				satcomponents.blocks.noise_ung noise_ung1(
					amplitude=noiseamp,
					seed=1) annotation(Placement(transformation(extent={{-40, 29}, {-19, 40}})));
				satcomponents.blocks.noise_ung noise_ung3(
					amplitude=noiseamp,
					seed=30) annotation(Placement(transformation(extent={{-40, 44}, {-20, 55}})));
				Modelica.Blocks.Interfaces.RealOutput y[3] annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Blocks.Interfaces.RealInput ang_vel[3] annotation(Placement(
					visible=true,
					transformation(
						origin={-110, 0},
						extent={{-10, -10}, {10, 10}},
					...
					iconTransformation(
						...
						rotation=0)));
				equation
					connect(add1.y, y) annotation(Line(points = {{21, 0}, {98, 0}, {98, 0}, {98, 0}}, color = {0, 0, 127}));
				...
				annotation(
					...
					Icon(graphics={Rectangle(fillColor = {128, 128, 128}, fillPattern = FillPattern.Sphere, extent = {{-90.11, 86.91}, {90.11, -86.91}}, origin = {4.04682, -1.67855}), Rectangle(fillColor = {88, 88, 88}, fillPattern = FillPattern.Solid, extent = {{-75.20999999999999, 71.87}, {75.20999999999999, -71.87}}, origin = {0.00144847, -2.21986}), Text(textString = "IMU", lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, extent = {{-68.11, 50.28}, {68.11, -50.28}}, origin = {0.42, -4.6})}),
					experiment(
						StopTime=1,
						StartTime=0));
			end IMU;
			model reactionwheelsimple_noelectricity "reactionwheelsimple_noelectricity"
				Modelica.Blocks.Interfaces.RealInput pseudo_torque annotation(Placement(
					visible=true,
					transformation(
						origin={-110, 18},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Blocks.Interfaces.RealOutput torque annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Blocks.Interfaces.RealOutput ang_mom annotation(Placement(
					visible=true,
					transformation(
						origin={110, -22},
						extent={{-10, -10}, {10, 10}},
					...
					iconTransformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Blocks.Interfaces.RealInput ctrl_torque annotation(Placement(
					visible=true,
					transformation(
						origin={-6, -110},
						extent={{-10, -10}, {10, 10}},
				...
				Modelica.Blocks.Nonlinear.Limiter limiter1(
					uMax=1e-1,
					strict=true) annotation(Placement(
					visible=true,
					transformation(
						origin={6, -66},
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				Modelica.Mechanics.Rotational.Sources.Torque torque2(useSupport=false) annotation(Placement(
					visible=true,
					transformation(
						origin={46, 16},
						extent={{10, -10}, {-10, 10}},
						rotation=360)));
				Modelica.Mechanics.Rotational.Sensors.TorqueSensor torquesensor1 annotation(Placement(
					visible=true,
					transformation(
						origin={12, 16},
						extent={{-10, -10}, {10, 10}},
			...
			model IMU_simple "IMU_simple"
				...
				Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity absoluteangularvelocity1 annotation(Placement(transformation(
					origin={-30, -5},
					extent={{-10, -10}, {10, 10}})));
				Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(
					transformation(
				...
				satcomponents.blocks.noise_ung noise_ung3(
					amplitude=noiseamp,
					seed=3) annotation(Placement(transformation(extent={{-40, 44}, {-20, 55}})));
				Modelica.Blocks.Interfaces.RealOutput y[3] annotation(Placement(
					visible=true,
					transformation(
						origin={106, 0},
			...
			model IMU_no_sam_delay
				...
				Modelica.Mechanics.MultiBody.Interfaces.Frame_a frame_a annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-10, -10}, {10, 10}})));
				Modelica.Blocks.Math.Add add1[3] annotation(Placement(transformation(extent={{0, -10}, {20, 10}})));
				blocks.noise_ung noise_ung2(
					amplitude=noiseamp,
					seed=2 + id) annotation(Placement(transformation(extent={{-40, 14}, {-19, 25}})));
				blocks.noise_ung noise_ung1(
					amplitude=noiseamp,
					seed=1 + id) annotation(Placement(transformation(extent={{-40, 29}, {-19, 40}})));
				blocks.noise_ung noise_ung3(
					amplitude=noiseamp,
					seed=3 + id) annotation(Placement(transformation(extent={{-40, 44}, {-20, 55}})));
				equation
					connect(frame_a, absoluteangularvelocity1.frame_a) annotation(Line(points = {{-100, 0}, {-95, 0}, {-45, 0}, {-45, -5}, {-40, -5}}));
					connect(absoluteangularvelocity1.w, add1.u2) annotation(Line(points = {{-19, -5.3}, {-14, -5.3}, {-7, -5.3}, {-7, -6}, {-2, -6}}, color = {0, 0, 127}, thickness = 0.0625));
					connect(noise_ung2.y, add1[2].u1) annotation(Line(points = {{-18, 19.3}, {-13, 19.3}, {-7, 19.3}, {-7, 6}, {-2, 6}}, color = {0, 0, 127}, thickness = 0.015625));
		...
		package ctrl
			model ACS
				ACS_bus acs_bus annotation(Placement(
					...
					iconTransformation(
						origin={100, 0},
						extent={{-10, -10}, {10, 10}})));
				Modelica.Blocks.Sources.Pulse pulse1[3](
					each amplitude=0.0001,
					each period=10,
					each nperiod=3,
					each startTime=20.0) annotation(Placement(transformation(extent={{-5, -20}, {15, 0}})));
				equation
				...
				annotation(
					Icon(
						coordinateSystem(
							...
							initialScale=0.1,
							grid={2, 2}),
						graphics={Rectangle(origin = {0.44, 1}, fillColor = {220, 220, 220}, fillPattern = FillPattern.Solid, extent = {{-88.27, 88.61}, {88.27, -88.61}})}),
					Diagram(
						coordinateSystem(
							extent={{-100, -100}, {100, 100}},
							preserveAspectRatio=true,
							initialScale=0.1,
							grid={2, 2}),
						graphics={Rectangle(origin = {-0.674206, -1.50696}, fillColor = {220, 220, 220}, fillPattern = FillPattern.Solid, extent = {{-88.27, 88.61}, {88.27, -88.61}}), Text(origin = {0.28, -1.25206}, extent = {{-81.06, 67.83}, {81.06, -67.83}}, textString = "ACS\nbus")}));
			end sat_bus;
			expandable connector ACS_bus
				...
				Real w_a[3](
					...
					each final unit="rad/s2");
				annotation(
					Icon(graphics={Rectangle(fillColor = {220, 220, 220}, fillPattern = FillPattern.Solid, extent = {{-88.27, 88.61}, {88.27, -88.61}}, origin = {0.44, 1})}),
					Diagram(graphics={Rectangle(fillColor = {220, 220, 220}, fillPattern = FillPattern.Solid, extent = {{-88.27, 88.61}, {88.27, -88.61}}, origin = {-0.674206, -1.50696}), Text(textString = "ACS
			...
			model busexample
				satcomponents.AOCS.ctrl.ACS_bus acs_bus1 annotation(Placement(
					...
					iconTransformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				satcomponents.AOCS.ctrl.ACS_bus acs_bus2 annotation(Placement(
					visible=true,
					transformation(
						origin={40, 0},
						extent={{-10, -10}, {10, 10}},
			...
			model ACS_P
				...
				Modelica.Blocks.Sources.Step step1[3](
					offset=1,
					startTime=5) annotation(Placement(transformation(extent={{10, 40}, {30, 60}})));
				Modelica.Blocks.Sources.Step step3[3](
					height={-0.1, 0.02, 0.05},
					offset={0.1, 0.0, 0.0},
					startTime=10) annotation(Placement(transformation(extent={{-75, 10}, {-55, 30}})));
				equation
			...
			model ACS_PID
				...
				Modelica.Blocks.Continuous.LimPID PID[3](
					...
					Ti=0.1,
					yMax=2,
					strict=true) annotation(Placement(transformation(extent={{15, 5}, {35, 25}})));
				Modelica.Blocks.Sources.CombiTimeTable combiTimeTable1(
					table={{0, 0, 0, 0}, {5, 0.1, 0, 0}, {10, 0.05, 0.1, 0.1}},
					smoothness=Modelica.Blocks.Types.Smoothness.ConstantSegments,
					extrapolation=Modelica.Blocks.Types.Extrapolation.HoldLastPoint) annotation(Placement(transformation(extent={{-30, 5}, {-10, 25}})));
				equation
			...
			model ACS_bus_ctrl "ACS_bus_ctrl"
				...
				equation
					connect(w, acs_bus.w);
				annotation(
					Icon(graphics={Rectangle(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-86.39, 85.40000000000001}, {93.6909, -86.0637}}, origin = {1.22, 1.55}), Text(textString = "Bus\\nCtrl", extent = {{-80.75, 56.53}, {80.75, -56.53}}, origin = {0.44, 3.43})}),
					experiment(
						StopTime=1,
						StartTime=0));
			end ACS_bus_ctrl;
		...
		model momentum_add "momentum_add"
			...
			Modelica.Mechanics.MultiBody.Parts.BodyBox bodyBox1(
				...
				density=300000) annotation(Placement(transformation(extent={{25, 65}, {45, 85}})));
			Modelica.Mechanics.MultiBody.Parts.BodyBox bodyBox2(
				r={1.0, 0, 0},
				r_shape={-0.5, 0, 0},
				widthDirection={0, 0.5, 0},
				density=300000) annotation(Placement(transformation(extent={{30, -15}, {50, 5}})));
			...
			Modelica.Blocks.Sources.Pulse pulse1(
				...
				period=10.0,
				nperiod=1,
				startTime=10.0) annotation(Placement(transformation(extent={{165, 45}, {145, 65}})));
			equation
			...
			annotation(
				...
				reactionwheelsimple_noelectricity1(bodyShape1(
					...
					body(
						...
						z_a(flags=2),
						g_0(flags=2)))),
				reactionwheelsimple_noelectricity2(
					acs_bus(
						w(flags=2),
						w_a(flags=2),
						u(flags=2),
					...
					bodyShape1(
						...
						body(
							...
							z_a(flags=2),
							g_0(flags=2)))),
				reactionwheelsimple_noelectricity3(bodyShape1(
					frame_a(
						r_0(flags=2),
						R(
							T(flags=2),
	...
	package blocks "blocks"
		...
		model noise_sampled
			Modelica.Blocks.Math.Add add1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			satcomponents.blocks.noise_ung noise_ung1 annotation(Placement(
				visible=true,
				transformation(
					origin={-40, 20},
					extent={{-10.17, -5.17}, {10.17, 5.17}},
					rotation=0)));
			Modelica.Blocks.Discrete.ZeroOrderHold zeroorderhold1(samplePeriod=0.1) annotation(Placement(
				visible=true,
				transformation(
					origin={60, 0},
					extent={{-10, -10}, {10, 10}},
		...
		model noisetest
			noise_ung noise_ung1 annotation(Placement(
				visible=true,
				transformation(
					extent={{-9, -1}, {12, 10}},
					rotation=0)));
		...
		model sampled_noise_noevent
			noise_ung noise_ung1 annotation(Placement(
				...
				transformation(
					extent={{-43, -5}, {-22, 6}},
					rotation=0)));
			satcomponents.blocks.no_event_sampler no_event_sampler1 annotation(Placement(
				visible=true,
				transformation(
					origin={34, 0},
					extent={{-10, -10}, {10, 10}},
		...
		model sample_test
			Modelica.Blocks.Discrete.ZeroOrderHold zeroorderhold1(samplePeriod=0.1) annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Discrete.Sampler sampler1(samplePeriod=0.1) annotation(Placement(
				visible=true,
				transformation(
					origin={30, 32},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Blocks.Sources.Sine sine1(freqHz=2) annotation(Placement(
				visible=true,
				transformation(
					origin={-62, 0},
					extent={{-10, -10}, {10, 10}},
		...
		block OnOffIdleController "On-off controller"
			extends Modelica.Blocks.Icons.Block;
			Modelica.Blocks.Interfaces.RealInput reference "Connector of Real input signal used as reference signal" annotation(Placement(transformation(
				extent={{-140, 80}, {-100, 40}},
				rotation=0)));
			Modelica.Blocks.Interfaces.RealInput u "Connector of Real input signal used as measurement signal" annotation(Placement(transformation(
				extent={{-140, -40}, {-100, -80}},
				rotation=0)));
			Modelica.Blocks.Interfaces.RealOutput y "Connector of Real output signal used as actuator signal" annotation(Placement(transformation(
...
signal <b>u</b> exceeds the <b>reference</b> signal plus half of the bandwidth.</p>
			...
			model onoffidletest
				Modelica.Blocks.Sources.Sine sine1 annotation(Placement(
					...
					transformation(
						...
						extent={{-10, -10}, {10, 10}},
						rotation=0)));
				OnOffIdleController onoffidlecontroller1(bandwidth=0.05) annotation(Placement(
					visible=true,
					transformation(
						origin={-18, 36},
						extent={{-10, -10}, {10, 10}},
	...
	package thermal
		model thermometer_withnoise "Absolute temperature sensor in Kelvin"
			Modelica.Blocks.Interfaces.RealOutput T(unit="K") "Absolute temperature as output signal" annotation(Placement(transformation(
				extent={{90, -10}, {110, 10}},
				rotation=0)));
			...
			Modelica.Blocks.Math.Add add1 annotation(Placement(
				...
				transformation(
					...
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			Modelica.Thermal.HeatTransfer.Sensors.TemperatureSensor temperaturesensor1 annotation(Placement(
				visible=true,
				transformation(
					origin={30, 2},
					extent={{-10, -10}, {10, 10}},
					rotation=0)));
			blocks.noise_ung noise_ung(
				amplitude=0.1,
				seed=34) annotation(Placement(
				visible=true,
				transformation(
					origin={30, 32},
					extent={{-10.17, -5.17}, {10.17, 5.17}},
					rotation=0)));
			equation
				connect(port, temperaturesensor1.port) annotation(Line(points = {{-100, 0}, {20, 0}, {20, 2}, {20, 2}}, color = {191, 0, 0}));
				connect(add1.y, T) annotation(Line(points = {{77, 12}, {82, 12}, {82, 0}, {96, 0}, {96, 0}}, color = {0, 0, 127}));
				connect(noise_ung.y, add1.u1) annotation(Line(points = {{41, 32}, {52, 32}, {52, 18}, {52, 18}}, color = {0, 0, 127}));
				connect(temperaturesensor1.T, add1.u2) annotation(Line(points = {{40, 2}, {54, 2}, {54, 6}, {54, 6}}, color = {0, 0, 127}));
			annotation(
				Diagram(
					coordinateSystem(
						preserveAspectRatio=true,
						extent={{-100, -100}, {100, 100}}),
					graphics={Ellipse(extent = {{-20, -98}, {20, -60}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-12, 40}, {12, -68}}, lineColor = {191, 0, 0}, fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid), Line(points = {{12, 0}, {90, 0}}, color = {0, 0, 255}), Line(points = {{-94, 0}, {-14, 0}}, color = {191, 0, 0}), Polygon(points = {{-12, 40}, {-12, 80}, {-10, 86}, {-6, 88}, {0, 90}, {6, 88}, {10, 86}, {12, 80}, {12, 40}, {-12, 40}}, lineColor = {0, 0, 0}, lineThickness = 0.5), Line(points = {{-12, 40}, {-12, -64}}, color = {0, 0, 0}, thickness = 0.5), Line(points = {{12, 40}, {12, -64}}, color = {0, 0, 0}, thickness = 0.5), Line(points = {{-40, -20}, {-12, -20}}, color = {0, 0, 0}), Line(points = {{-40, 20}, {-12, 20}}, color = {0, 0, 0}), Line(points = {{-40, 60}, {-12, 60}}, color = {0, 0, 0}), Text(extent = {{102, -28}, {60, -78}}, lineColor = {0, 0, 0}, textString = "K")}),
				Documentation(info="<HTML>
<p>
This is an ideal absolute temperature sensor with noise which returns
...
sensor model.
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2, 2}),
					graphics={Ellipse(fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid, lineThickness = 0.5, extent = {{-20, -98}, {20, -60}}, endAngle = 360), Rectangle(lineColor = {191, 0, 0}, fillColor = {191, 0, 0}, fillPattern = FillPattern.Solid, extent = {{-12, 40}, {12, -68}}), Line(points = {{-90, 0}, {-12, 0}}, color = {191, 0, 0}), Polygon(lineThickness = 0.5, points = {{-12, 40}, {-12, 80}, {-10, 86}, {-6, 88}, {0, 90}, {6, 88}, {10, 86}, {12, 80}, {12, 40}, {-12, 40}}), Line(points = {{-12, 40}, {-12, -64}}, thickness = 0.5), Line(points = {{12, 40}, {12, -64}}, thickness = 0.5), Line(points = {{-40, -20}, {-12, -20}}), Line(points = {{-40, 20}, {-12, 20}}), Line(points = {{-40, 60}, {-12, 60}}), Text(extent = {{126, -20}, {26, -120}}, textString = "K"), Text(lineColor = {0, 0, 255}, extent = {{-150, 130}, {150, 90}}, textString = "%name"), Line(origin = {51.02, 4}, points = {{-39.0169, -12}, {-31.0169, 22}, {-25.0169, -18}, {-25.0169, 4}, {-19.0169, -10}, {-11.0169, 8}, {-9.01689, -10}, {-7.01689, 18}, {-1.01689, -24}, {2.98311, 2}, {4.98311, -20}, {8.98311, 26}, {14.9831, -26}, {16.9831, -2}, {28.9831, -14}, {30.9831, 8}, {34.9831, -18}, {38.9831, -4}}, color = {0, 0, 255})}));
		end thermometer_withnoise;
		annotation(
			Icon(coordinateSystem(
				extent={{-100, -100}, {100, 100}},
				preserveAspectRatio=true,
