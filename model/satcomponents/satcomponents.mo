  ...
  package power
    ...
    package dcmodel
      ...
      model dcdc_ideal_simple_improved
        ...
        Modelica.Electrical.Analog.Interfaces.PositivePin p1 annotation(Placement(visible = true, transformation(origin = {-100, 40}, extent = {{-12, -12}, {12, 12}}, rotation = 0), iconTransformation(origin = {94, 44}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
