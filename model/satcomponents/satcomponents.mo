package satcomponents
  ...
  Modelica.Mechanics.MultiBody.Forces.Torque torque_z(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameAB.frame_a) annotation(Placement(visible = true, transformation(origin = {-30, -42}, extent = {{-10, -10}, {10, 10}}, rotation = -180)));
  ...
  Modelica.Mechanics.MultiBody.Parts.Body body3 annotation(Placement(visible = true, transformation(origin = {4, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(z_axis.frame_b, body3.frame_a) annotation(Line(points = {{-20, -20}, {-6, -20}, {-6, -20}, {-6, -20}}, color = {95, 95, 95}));
        connect(y_axis.frame_b, body2.frame_a) annotation(Line(points = {{-20, 36}, {-6, 36}, {-6, 34}, {-6, 34}}, color = {95, 95, 95}));
        connect(z_axis.frame_b, torque_z.frame_a) annotation(Line(points = {{-20, -20}, {-12, -20}, {-12, -42}, {-20, -42}, {-20, -42}}, color = {95, 95, 95}));
        ...
        connect(torque_z.frame_b, z_axis.frame_a) annotation(Line(points = {{-40, -42}, {-45, -42}, {-45, -20}, {-40, -20}}, color = {95, 95, 95}, thickness = 0.0625));
      ...
      model reactionwheel
        ...
        Modelica.Electrical.Analog.Interfaces.PositivePin pin_p annotation(Placement(visible = true, transformation(origin = {100, -34.3931}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {98.2659, -37.8613}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Mechanics.MultiBody.Parts.Body Schwungmasse(r_CM = {0, 0, 0}, m = 0.02, I_11 = 1e-07, I_22 = 1e-07, I_33 = 1e-07) annotation(Placement(visible = true, transformation(origin = {-0.867052, 28.0347}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Electrical.Analog.Sensors.VoltageSensor voltageSensor1 annotation(Placement(visible = true, transformation(origin = {48, -54}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
      equation
        connect(voltageSensor1.v, Moment.tau) annotation(Line(points = {{38, -54}, {28, -54}, {28, -32}, {60, -32}, {60, -16}, {52, -16}, {52, -16}}, color = {0, 0, 127}));
        connect(voltageSensor1.n, resistor1.n) annotation(Line(points = {{48, -64}, {72, -64}, {72, -66}, {72, -66}}, color = {0, 0, 255}));
        connect(voltageSensor1.p, resistor1.p) annotation(Line(points = {{48, -44}, {72, -44}, {72, -46}, {72, -46}}, color = {0, 0, 255}));
        connect(pin_p, resistor1.p) annotation(Line(points = {{100, -34}, {70, -34}, {70, -46}, {72, -46}}, color = {0, 0, 255}));
        connect(Schwungmasse.frame_a, Gelenk.frame_b) annotation(Line(points = {{-0.867052, 18.0347}, {-0.867052, -8.67052}, {-0.578035, -8.67052}, {-0.578035, -8.67052}}));
        connect(resistor1.n, pin_n) annotation(Line(points = {{71.3873, -65.4913}, {71.3873, -67.6301}, {100, -67.6301}, {100, -67.6301}}));
        connect(frame_a, Gelenk.frame_a) annotation(Line(points = {{19.0752, -86.99420000000001}, {19.0752, -54.0462}, {-1.15607, -54.0462}, {-1.15607, -28.9017}, {-1.15607, -28.9017}}));
        connect(Moment.support, Gelenk.support) annotation(Line(points = {{39.3948, -26.4068}, {20.5202, -26.4068}, {20.5202, -24.8555}, {9.24855, -24.8555}, {9.24855, -24.8555}}));
  ...
  satcomponents.AOCS.ctrl.ACS_Q_P_cont aCS_Q_P_cont1 annotation(Placement(visible = true, transformation(origin = {30, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      ...
      equation
        ...
        connect(timed_switch.y, deMultiplex31.u) annotation(Line(points = {{30, 60}, {-2, 60}, {-2, 60}, {-2, 60}}, color = {0, 0, 127}));
...
sensor model.
  ...
  satcomponents.satellites.Cubesat cubesat annotation(Placement(visible = true, transformation(origin = {14.1965, 30.2428}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        ...
        annotation(Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), Diagram(coordinateSystem(extent = {{-100, -100}, {100, 100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2, 2})), experiment(StartTime = 50, StopTime = 300, Tolerance = 1e-08, Interval = 0.05));
