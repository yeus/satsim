package modelicatests
  ...
  model noise_sampled "noise_sampled"
    satcomponents.blocks.noise_ung noise_ung1[3](amplitude = 1.0, seed = {1, 2, 3}) annotation(Placement(transformation(extent = {{-25, 39}, {-4, 50}})));
  ...
  equation
    ...
    annotation(noise_ung1(y(flags = 2)), sampler1(y(flags = 2)), experiment(StopTime = 100, StartTime = 0));
  end noise_sampled;

  model simplependulum
    inner Modelica.Mechanics.MultiBody.World world annotation(Placement(transformation(origin = {-72.03619999999999, -1.67937}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.Rotational.Components.Damper damper2(d = 0.1) annotation(Placement(transformation(origin = {-31.9961, 35.4135}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute1(useAxisFlange = true, n = {0, 0, 1}, phi(start = 3.14159 / 2.0)) annotation(Placement(transformation(origin = {-28.3295, -1.25318}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Parts.Body body1(r_CM = {0, 0, 0}, m = 0.5) annotation(Placement(transformation(origin = {46.4644, -0.839688}, extent = {{-10, -10}, {10, 10}})));
    Modelica.Mechanics.MultiBody.Parts.FixedTranslation fixedtranslation1(r = {0, -0.2, 0}) annotation(Placement(transformation(origin = {11.1437, -0.879765}, extent = {{-10, -10}, {10, 10}})));
  equation
  ...
  package bus_simulation
    ...
    model signalbusarraytest
      ...
      Modelica.Blocks.Math.Cos cos1 annotation(Placement(transformation(origin = {115, -5}, extent = {{-10, -10}, {10, 10}})));
      modcom modcom3 annotation(Placement(transformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-20, -20}, extent = {{-10, -10}, {10, 10}})));
      modcom modcom4 annotation(Placement(transformation(origin = {20, -40}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {20, -40}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Blocks.Sources.Sine sine2(amplitude = 4.0, freqHz = 0.1) annotation(Placement(transformation(origin = {-80, -25}, extent = {{-10, -10}, {10, 10}})));
      Modelica.Blocks.Math.Gain gain1 annotation(Placement(transformation(origin = {15, 70}, extent = {{-10, -10}, {10, 10}})));
    ...
    equation
      ...
      annotation(modcom2(a(flags = 2)), experiment(StopTime = 100, StartTime = 0));
  ...
  model momentum_add "momentum_add"
    inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity, redeclare replaceable function gravityAcceleration = Modelica.Mechanics.MultiBody.Forces.Internal.standardGravityAcceleration) annotation(Placement(transformation(extent = {{-115, 70}, {-95, 90}})));
    Modelica.Mechanics.MultiBody.Parts.BodyBox bodyBox1(r = {1.0, 0, 0}, r_shape = {-0.5, 0, 0}, widthDirection = {0, 0.5, 0}, density = 300000) annotation(Placement(transformation(extent = {{10, 40}, {30, 60}})));
    Modelica.Mechanics.MultiBody.Parts.BodyBox bodyBox2(r = {1.0, 0, 0}, r_shape = {-0.5, 0, 0}, widthDirection = {0, 0.5, 0}, density = 300000) annotation(Placement(transformation(extent = {{10, -25}, {30, -5}})));
  ...
  model trajectory_with_pointmass
    inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-64, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body(useQuaternions = false) annotation(Placement(visible = true, transformation(origin = {16, -6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Constraints.Prismatic constraint(x_locked = false, y_locked = true, z_locked = true) annotation(Placement(visible = true, transformation(origin = {-26, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  model constraints_test
    inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-44, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Translational.Sources.Position position1(exact = false) annotation(Placement(visible = true, transformation(origin = {10, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.PointMass pointmass1(m = 10) annotation(Placement(visible = true, transformation(origin = {68, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Prismatic prismatic1(useAxisFlange = true, stateSelect = StateSelect.never) annotation(Placement(visible = true, transformation(origin = {8, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Sensors.CutForce cutforce1 annotation(Placement(visible = true, transformation(origin = {40, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Interfaces.RealInput u annotation(Placement(visible = true, transformation(origin = {-78, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-52, 26}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  model momentumexchange_test
    ...
    inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-66, 66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion2(w_rel_a_start = {pi / 10.0, pi / 20.0, pi / 10}, enforceStates = false, useQuaternions = true, w_rel_a_fixed = true, angles_start = {0.1, 0.1, 0}) annotation(Placement(visible = true, transformation(origin = {-22, 66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute2(useAxisFlange = false, w(start = 1.0), n = {0, 0, 1}, stateSelect = StateSelect.default) annotation(Placement(visible = true, transformation(origin = {-20, -56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body5(m = 10, I_11 = 1, I_22 = 1, I_33 = 1, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {62, -30}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(w_rel_a_start = {pi / 10.0, pi / 20.0, pi / 10}, enforceStates = false, useQuaternions = true, w_rel_a_fixed = true, angles_start = {0.1, 0.1, 0}) annotation(Placement(visible = true, transformation(origin = {-20, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body1(m = 10, I_11 = 1, I_22 = 1, I_33 = 1, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {64, -56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Forces.Torque t2 annotation(Placement(visible = true, transformation(origin = {-20, -82}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Forces.Torque t1 annotation(Placement(visible = true, transformation(origin = {-20, -20}, extent = {{-10, 10}, {10, -10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation1(n = {1, 0, 0}) annotation(Placement(visible = true, transformation(origin = {34, -12}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    Modelica.Mechanics.MultiBody.Parts.Body body4(m = 30, I_11 = 10.0, I_22 = 10.0, I_33 = 20.0, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {60, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation2(n = {1, 0, 0}, angle = 45) annotation(Placement(visible = true, transformation(origin = {2, 46}, extent = {{-10, -10}, {10, 10}}, rotation = -90)));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute1(useAxisFlange = false, w(start = 1.0), n = {0, 0, 1}, stateSelect = StateSelect.default) annotation(Placement(visible = true, transformation(origin = {36, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body3(m = 10, I_11 = 1, I_22 = 1, I_33 = 1, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {72, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body2(m = 30, I_11 = 10.0, I_22 = 10.0, I_33 = 20.0, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {26, 80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Components.Disc disc1 annotation(Placement(visible = true, transformation(origin = {32, 60}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  model rw_test
    Modelica.Mechanics.Rotational.Components.Inertia inertia1 annotation(Placement(visible = true, transformation(origin = {4, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Components.Fixed fixed1 annotation(Placement(visible = true, transformation(origin = {16, -4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Sources.Torque torque1(useSupport = true) annotation(Placement(visible = true, transformation(origin = {-34, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Sine sine1 annotation(Placement(visible = true, transformation(origin = {-76, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Sources.Torque torque2(useSupport = true) annotation(Placement(visible = true, transformation(origin = {44, 32}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Constant const(k = -0.1) annotation(Placement(visible = true, transformation(origin = {84, 32}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
  equation
  ...
  model rigidbody_with_joints
    ...
    SI.AngularMomentum LL2[3];
    inner Modelica.Mechanics.MultiBody.World world(gravityType = Modelica.Mechanics.MultiBody.Types.GravityTypes.NoGravity) annotation(Placement(visible = true, transformation(origin = {-66, 66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion1(w_rel_a_start = {pi / 10.0, pi / 20.0, pi / 10}, enforceStates = false, useQuaternions = true, w_rel_a_fixed = true, angles_start = {0.1, 0.1, 0}) annotation(Placement(visible = true, transformation(origin = {-20, 66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.FreeMotion freemotion2(w_rel_a_start = {pi / 10.0, pi / 20.0, pi / 10}, enforceStates = false, useQuaternions = true, w_rel_a_fixed = true, angles_start = {0.1, 0.1, 0}) annotation(Placement(visible = true, transformation(origin = {-22, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body2(m = 30, I_11 = 10.0, I_22 = 10.0, I_33 = 20.0, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {22, 40}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute1(useAxisFlange = false, w(start = 1.0), n = {0, 1, 1}, stateSelect = StateSelect.default) annotation(Placement(visible = true, transformation(origin = {22, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body3(m = 10, I_11 = 1, I_22 = 1, I_33 = 1, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {78, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body1(m = 30, I_11 = 10.0, I_22 = 10.0, I_33 = 20.0, enforceStates = false) annotation(Placement(visible = true, transformation(origin = {20, 66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body5(m = 30, I_11 = 10.0, I_22 = 10.0, I_33 = 20.0, enforceStates = false, w_0_start = {0, 0, 1.0}) annotation(Placement(visible = true, transformation(origin = {10, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute3(useAxisFlange = false, w(start = 1.0), n = {0, 0, 1}, stateSelect = StateSelect.prefer) annotation(Placement(visible = true, transformation(origin = {-20, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.Body body4(m = 10, I_11 = 1, I_22 = 1, I_33 = 1, enforceStates = false, w_0_start = {0, 1.0, 1.0}) annotation(Placement(visible = true, transformation(origin = {44, -66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Joints.Revolute revolute2(useAxisFlange = false, w(start = 1.0), n = {0, 1, 1}, stateSelect = StateSelect.prefer) annotation(Placement(visible = true, transformation(origin = {12, -66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Sensors.AbsoluteAngularVelocity absoluteangularvelocity1(resolveInFrame = Modelica.Mechanics.MultiBody.Types.ResolveInFrameA.frame_resolve) annotation(Placement(visible = true, transformation(origin = {48, -10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.MultiBody.Parts.FixedRotation fixedrotation1(n = {1, 0, 0}, angle = 45.0) annotation(Placement(visible = true, transformation(origin = {10, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  model motortest
    Modelica.Electrical.Machines.BasicMachines.QuasiStationaryDCMachines.DC_PermanentMagnet dcpm annotation(Placement(visible = true, transformation(origin = {-18, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Components.Fixed fixed1 annotation(Placement(visible = true, transformation(origin = {-6, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Electrical.Analog.Sources.ConstantVoltage constantvoltage1 annotation(Placement(visible = true, transformation(origin = {-18, 46}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(origin = {20, 34}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Mechanics.Rotational.Components.Inertia inertia1(J = 1) annotation(Placement(visible = true, transformation(origin = {32, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
  ...
  equation
    ...
    annotation(experiment(StopTime = 100, StartTime = 0, Tolerance = 1e-014, Interval = 0.01));
