package modelicatests
  ...
  algorithm
    ...
    annotation(x(flags = 2), experiment(StopTime = 20, StartTime = 0, Tolerance = 1e-06));
  end noise_sampled;
  ...
  algorithm
    ...
    x:=mod(a * y + c, m);
    annotation(x(flags = 2), y(flags = 2), experiment(StopTime = 20, StartTime = 0, Tolerance = 1e-06));
  end noise_ung;
end modelicatests;