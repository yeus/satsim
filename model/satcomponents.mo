package satcomponents
  ...
  package AOCS
    ...
    model reactionwheelexample
      ...
      Modelica.Electrical.Analog.Sources.PulseVoltage pulsevoltage1(V = 0.5, width = 0.5, period = 7.5, startTime = 10) annotation(Placement(visible = true, transformation(origin = {10.1156,-46.8208}, extent = {{10,-10},{-10,10}}, rotation = 0)));
      Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(visible = true, transformation(origin = {-17.9191,-57.2254}, extent = {{-10,-10},{10,10}}, rotation = 0)));
      satcomponents.AOCS.Struktur struktur1 annotation(Placement(visible = true, transformation(origin = {-55.578,-30.2601}, extent = {{-30.1445,-30.1445},{30.1445,30.1445}}, rotation = 0)));
    equation
      connect(freemotion1.frame_b,struktur1.frame_a) annotation(Line(points = {{-34.2197,45.3757},{-28.0347,45.3757},{-28.0347,15.3179},{-54.6243,15.3179},{-54.6243,-29.7688},{-54.6243,-29.7688}}));
      connect(fixedtranslation1.frame_a,struktur1.frame_a) annotation(Line(points = {{-44.688,0.599941},{-54.6243,0.599941},{-54.6243,-29.4798},{-54.6243,-29.4798}}));
      connect(reactionwheel1.pin_p,pulsevoltage1.p) annotation(Line(points = {{13.1154,-14.8498},{13.1154,-14.7399},{29.4798,-14.7399},{29.4798,-46.8208},{20.2312,-46.8208},{20.2312,-46.8208}}));
      connect(pulsevoltage1.n,reactionwheel1.pin_n) annotation(Line(points = {{0.115607,-46.8208},{-0.289017,-46.8208},{-0.289017,-14.4509},{6.35838,-14.4509},{6.35838,-14.4509}}));
      connect(pulsevoltage1.n,ground1.p) annotation(Line(points = {{0.115607,-46.8208},{-17.6301,-46.8208},{-17.6301,-47.3988},{-17.6301,-47.3988}}));
    ...
    model Struktur
      ...
      Modelica.Mechanics.MultiBody.Parts.Body Struktur(m = 1, I_11 = 0.0018, I_22 = 0.0017, I_33 = 0.0016, r_CM = {0,0,0.05}, useQuaternions = false) annotation(Placement(visible = true, transformation(origin = {-48.9625,4.04896}, extent = {{-10,-10},{10,10}}, rotation = 180)));
    protected
