package satcomponents
  ...
  package AOCS
    ...
    model reactionwheelexample
      ...
      satcomponents.AOCS.reactionwheel reactionwheel1 annotation(Placement(visible = true, transformation(origin = {46.3006,-7.86127}, extent = {{-19.0173,-19.0173},{19.0173,19.0173}}, rotation = -90)));
      ...
      satcomponents.AOCS.Struktur struktur1 annotation(Placement(visible = true, transformation(origin = {-42.8613,-15.5202}, extent = {{-31.3006,-31.3006},{31.3006,31.3006}}, rotation = 0)));
    equation
    ...
    model Struktur
      ...
      Modelica.Mechanics.MultiBody.Parts.Body Struktur(m = 1, I_11 = 0.0018, I_22 = 0.0017, I_33 = 0.0016, r_CM = {0,0,-0.001}, useQuaternions = false) annotation(Placement(visible = true, transformation(origin = {-48.9625,4.04896}, extent = {{-10,-10},{10,10}}, rotation = 180)));
    protected
