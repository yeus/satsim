package satcomponents
  ...
  package AOCS
    ...
    package ctrl
      ...
      equation
        connect(sine1.y,acs_bus.y) annotation(Line(points = {{20.75,27.5},{92.25660000000001,27.5},{92.25660000000001,2.87611},{92.25660000000001,2.87611}}));
      ...
      connector ACS_bus
        Real y;
        annotation(Diagram(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2}), graphics = {Rectangle(origin = {0.44,1}, fillColor = {220,220,220}, fillPattern = FillPattern.Solid, extent = {{-88.27,88.61},{88.27,-88.61}}),Text(origin = {2.77,0.55}, extent = {{-102.099,74.67270000000001},{99.4439,-77.10639999999999}}, textString = "ACS\nbus")}));
      end ACS_bus;
      model busexample
