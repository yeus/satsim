  ...
  package power
    ...
    package dcmodel
      ...
      model dcdc_ideal_simple_improved
        ...
        Modelica.Electrical.Analog.Interfaces.NegativePin n1 annotation(Placement(transformation(origin = {-93,-32}, extent = {{-12,-12},{12,12}}), iconTransformation(origin = {-92.7864,-40.4526}, extent = {{-12,-12},{12,12}})));
      ...
      package examples
        ...
        model dcdc_pid_jump
          extends Modelica.Icons.Example;
          Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(origin = {-36.7751,-39.8868}, extent = {{-12,-12},{12,12}})));
          Modelica.Electrical.Analog.Basic.Resistor resistor1(R = 2) annotation(Placement(transformation(origin = {12,-7}, extent = {{-12,12},{12,-12}}, rotation = -180)));
          dcdc_pid dcdc_pid1(P_out = 100, V_out = 20, V_in_min = 22) annotation(Placement(transformation(extent = {{-40,10},{-20,30}})));
          Modelica.Electrical.Analog.Sources.TrapezoidVoltage trapezoidVoltage1(V = 100, rising = 0.5, width = 3, falling = 0.5, period = 10, startTime = 2) annotation(Placement(transformation(origin = {-70,15}, extent = {{-10,-10},{10,10}}, rotation = -90)));
        equation
          ...
          annotation(resistor1(v(flags = 2), i(flags = 2), LossPower(flags = 2)), dcdc_pid1(v1(flags = 2), v2(flags = 2), onOffController1(y(flags = 2)), voltageSensor1(p(v(flags = 2), i(flags = 2)), n(v(flags = 2), i(flags = 2)), v(flags = 2))), Diagram(coordinateSystem(extent = {{-100,-100},{100,100}}), graphics = {Line(points = {{10,75}})}), experiment(StopTime = 100, StartTime = 0, Tolerance = 1e-06));
        end dcdc_pid_jump;
      end examples;
      model dcdc_pid
  ...
  package AOCS
    ...
    package Parts
      ...
      model reactionwheel3axis
        ...
        Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(visible = true, transformation(origin = {26.3006,-96.82080000000001}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {26.3006,-96.82080000000001}, extent = {{-10,-10},{10,10}}, rotation = 0)));
      ...
      equation
        ...
        annotation(Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2}), graphics = {Rectangle(origin = {4.04682,-1.67855}, fillColor = {128,128,128}, fillPattern = FillPattern.Sphere, extent = {{-90.11,86.91},{90.11,-86.91}}),Rectangle(origin = {0.00144847,-2.21986}, fillColor = {88,88,88}, fillPattern = FillPattern.Solid, extent = {{-75.20999999999999,71.87},{75.20999999999999,-71.87}}),Text(origin = {0.42,-4.6}, lineColor = {255,255,255}, fillColor = {255,255,255}, extent = {{-68.11,50.28},{68.11,-50.28}}, textString = "IMU")}));
      end IMU;
    end Parts;
    package ctrl
      model ACS
        satcomponents.AOCS.ctrl.ACS_bus acs_bus annotation(Placement(visible = true, transformation(origin = {100,0}, extent = {{-10,-10},{10,10}}, rotation = 0), iconTransformation(origin = {100,0}, extent = {{-10,-10},{10,10}}, rotation = 0)));
        Modelica.Blocks.Sources.Sine sine1 annotation(Placement(visible = true, transformation(origin = {12.5,27.5}, extent = {{-7.5,-7.5},{7.5,7.5}}, rotation = 0)));
      equation
        connect(sine1.y,acs_bus.u[0]) annotation(Line(points = {{20.75,27.5},{92.25660000000001,27.5},{92.25660000000001,2.87611},{92.25660000000001,2.87611}}));
        annotation(Diagram(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2})), Icon(coordinateSystem(extent = {{-100,-100},{100,100}}, preserveAspectRatio = true, initialScale = 0.1, grid = {2,2}), graphics = {Rectangle(origin = {1.22,1.55}, fillColor = {255,255,255}, fillPattern = FillPattern.Solid, extent = {{-86.39,85.40000000000001},{93.6909,-86.0637}}),Text(origin = {0.44,3.43}, extent = {{-80.75,56.53},{80.75,-56.53}}, textString = "ACS")}));
      end ACS;
