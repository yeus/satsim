...
package satcomponents
	...
	package data
		model OBC
			...
			annotation(
				Diagram,
				Icon(graphics={Rectangle(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-80.9052,86.5629},{86.2801,-87.1287}}),Text(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-69.3069,56.0113},{69.024,-52.3338}}, textString = "OBC")}));
		end OBC;
	end data;
	package power
		model PCU
			...
			satcomponents.power.dcmodel.dcdc_ideal_simple_improved dcdc_ideal_simple_improved3(
				...
				extent={{-10,-10},{10,10}})));
			Modelica.Electrical.Analog.Basic.Capacitor C1(C(displayUnit="nF")=1.0000000000000001e-007) annotation(Placement(transformation(
				origin={-30,-15},
				extent={{-10,-10},{10,10}},
				rotation=-90)));
			...
			equation
				connect(dcdc_ideal_simple_improved1.n2,gnd) annotation(Line(points={{66.24330000000001,-33.3086},{76.87860000000001,-33.3086},{76.87860000000001,-63.5838},{100,-63.5838},{100,-63.5838}}));
				...
				connect(dcdc_ideal_simple_improved3.p2,VCC12) annotation(Line(points={{66.47580000000001,45.2837},{98.84390000000001,45.2837},{98.84390000000001,45.0867},{98.84390000000001,45.0867}}));
				...
				connect(resistor2.p,VCC) annotation(Line(
					points={{-75,0},{-80,0},{-96,0},{-96,8},{-101,8}},
					thickness=0.0625));
				connect(resistor3.n,GND) annotation(Line(
					points={{-75,-35},{-80,-35},{-96,-35},{-96,-44},{-101,-44}},
					thickness=0.0625));
				connect(resistor3.p,resistor4.n) annotation(Line(
					points={{-55,-35},{-50,-35},{-15,-35},{-10,-35}},
					thickness=0.0625));
				connect(dcdc_ideal_simple_improved2.n1,resistor4.p) annotation(
					Line(
						points={{48,0},{43,0},{20,0},{20,-35},{10,-35}},
						thickness=0.0625),
					AutoRoute=false);
				connect(dcdc_ideal_simple_improved2.p1,resistor1.n) annotation(Line(
					points={{48,8},{43,8},{15,8},{15,0},{10,0}},
					thickness=0.0625));
				connect(resistor1.p,resistor2.n) annotation(Line(
					points={{-10,0},{-15,0},{-50,0},{-55,0}},
					thickness=0.0625));
				connect(resistor1.p,C1.p) annotation(Line(
					points={{-10,0},{-15,0},{-30,0},{-30,-5}},
					thickness=0.0625));
				connect(resistor4.n,C1.n) annotation(Line(
					points={{-10,-35},{-15,-35},{-30,-35},{-30,-30},{-30,-25}},
					thickness=0.0625));
			annotation(
				Icon(
			...
			package examples
				...
				model Batterycontrollertest
					...
					Modelica.Electrical.Analog.Ideal.IdealOpeningSwitch idealopeningswitch1(
						control(start=false),
						Ron=0.00001,
						Goff=0.00001) annotation(Placement(
						visible=true,
						transformation(
					...
					satcomponents.power.batteries.battery battery1(startSOC=0.8) annotation(Placement(
						visible=true,
						transformation(
							origin={49.1329,-9.53757},
							extent={{-10,-10},{10,10}},
							rotation=-90)));
					Modelica.Electrical.Analog.Sources.ConstantCurrent constantcurrent1(I=0.3) annotation(Placement(
						visible=true,
						transformation(
							origin={77.4566,-10.1156},
							extent={{-10,-10},{10,10}},
							rotation=90)));
					equation
						connect(constantcurrent1.p,battery1.n) annotation(Line(points = {{77.4566,-20.1156},{77.4566,-25.1445},{49.1329,-25.1445},{49.1329,-19.6532},{49.1329,-19.6532}}));
						connect(constantcurrent1.n,battery1.p) annotation(Line(points = {{77.4566,-0.115607},{77.4566,5.20231},{49.422,5.20231},{49.422,0.289017},{49.422,0.289017}}));
						...
						connect(voltagesensor2.p,battery1.p) annotation(Line(points = {{15.4408,6.35131},{15.4408,9.53757},{49.1329,9.53757},{49.1329,0},{49.1329,0}}));
				...
				model Batterycontrollertest2
					...
					equation
						...
						connect(bdr1.pin_n,battery1.n) annotation(Line(points = {{9.27448,39.178},{9.02256,39.178},{9.02256,5.41353},{48.1203,5.41353},{48.1203,5.41353}}));
			...
			model BDR
				...
				Modelica.Electrical.Analog.Basic.Resistor RS_on(R=0.001) annotation(Placement(
					...
					transformation(
						...
						extent={{-9.43132,-9.43132},{9.43132,9.43132}},
						rotation=0)));
				...
				equation
					...
					connect(voltagesensor2.n,pin_n) annotation(Line(points = {{50.4119,-53.8221},{50.4119,-93.8346},{-6.61654,-93.8346},{-6.61654,-93.8346}}));
		...
		package solar_power
			...
			model solarcell
				...
				equation
					...
					//i=10.0-0.01*(exp(v)-1);
				annotation(
					Icon(graphics={Ellipse(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-48.9392,47.8076},{46.6761,-50.0707}}),Line(points = {{-78.3593,89.1089},{-41.5842,46.6761},{-43.5644,60.5375},{-41.867,46.6761},{-53.7482,50.0707}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-56.5771,92.2207},{-26.8741,55.7284},{-37.9066,59.4059},{-27.4399,56.0113},{-27.7228,66.1952}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-89.6747,0.282885},{-19.5191,0.282885}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{89.6747,0.282885},{5.09194,0.282885}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-18.3876,-37.3409},{-18.3876,40.1697}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{4.24328,-17.5389},{4.24328,18.6704}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{76.9449,-20.3678},{76.9449,-52.6167}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{63.3664,-35.6436},{90.2405,-35.6436}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Line(points = {{-92.2207,-34.512},{-66.4781,-34.512}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25)}),
					Diagram);
			end solarcell;
			...
			model solarcell_simple
				...
				input Modelica.Blocks.Interfaces.RealInput E_s(
					...
					iconTransformation(
						...
						extent={{-12,12},{12,-12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Resistor R_series(R=0.00001) annotation(Placement(
					visible=true,
					transformation(
						...
						rotation=0)));
				protected
					parameter SIunits.CurrentDensity Ids=0.000001 "Diode Saturation Current" annotation(Placement(transformation(
				...
				annotation(
					Icon(
						coordinateSystem(extent={{-100,-100},{100,100}}),
						graphics={Ellipse(fillColor = {0,0,255}, extent = {{-48.9392,47.8076},{46.6761,-50.0707}}),Line(points = {{-78.3593,89.1089},{-41.5842,46.6761},{-43.5644,60.5375},{-41.867,46.6761},{-53.7482,50.0707}}),Line(points = {{-56.5771,92.2207},{-26.8741,55.7284},{-37.9066,59.4059},{-27.4399,56.0113},{-27.7228,66.1952}}),Line(points = {{-89.6747,0.282885},{-19.5191,0.282885}}),Line(points = {{89.6747,0.282885},{5.09194,0.282885}}),Line(points = {{-18.3876,-37.3409},{-18.3876,40.1697}}),Line(points = {{4.24328,-17.5389},{4.24328,18.6704}}),Line(points = {{76.9449,-20.3678},{76.9449,-52.6167}}),Line(points = {{63.3664,-35.6436},{90.2405,-35.6436}}),Line(points = {{-92.2207,-34.512},{-66.4781,-34.512}})}),
					Diagram(coordinateSystem(extent={{-100,-100},{100,100}})),
					experiment(
						StopTime=1,
						StartTime=0));
			...
			model SA_Regulator
				...
				Modelica.Electrical.Analog.Interfaces.NegativePin pin_n annotation(Placement(
					...
					iconTransformation(
						...
						rotation=0)));
				equation
					connect(idealdiode1.p,p) annotation(Line(points = {{-31.8513,4.60906},{-98.6466,4.60906},{-98.6466,1.20301},{-98.6466,1.20301}}));
				...
				annotation(
					...
					Icon(
						coordinateSystem(
							...
							initialScale=0.1,
							grid={2,2}),
						graphics={Rectangle(origin = {0.902256,-1.50376}, extent = {{-96.2406,88.4211},{96.2406,-88.4211}}),Text(origin = {-20.0009,-4.96504}, extent = {{-81.66,72.03},{113.237,-64.5123}}, textString = "SA \n regulator")}));
			end SA_Regulator;
		end solar_power;
		package dcmodel
			...
			model DCtoDCModel "DC/DC Converter Model nach Torrey, D., & Selamogullari, U. (2002). A Behavioral Model for DC-DC Converters using Modelica. modelica.org"
				model SignalCurrent "Generic current source using the input signal asource current"
					...
					annotation(
						Diagram,
						Icon(graphics={Line(points = {{-88.2603,-0.282885},{-52.6167,-0.282885},{-48.3734,-0.282885}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25),Ellipse(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-42.7157,46.6761},{47.8076,-49.505}}),Line(points = {{51.4851,0.282885},{89.1089,0.565771}}, rotation = 0, color = {0,0,255}, pattern = LinePattern.Solid, thickness = 0.25)}));
				end SignalCurrent;
				class CCS
				...
				Modelica.Electrical.Analog.Ideal.IdealDiode Dout annotation(Placement(
					...
					transformation(
						...
						extent={{12,-12},{-12,12}},
						rotation=90)));
				Modelica.Electrical.Analog.Basic.Capacitor Cin(C=0.00005) annotation(Placement(
					visible=true,
					transformation(
						origin={-76.7755,-2.72419},
						extent={{-12,12},{12,-12}},
						rotation=-90)));
				...
				Modelica.Electrical.Analog.Sensors.VoltageSensor Volt annotation(Placement(
					...
					transformation(
						...
						extent={{-12,12},{12,-12}},
						rotation=-90)));
				Modelica.Electrical.Analog.Basic.Capacitor Cout(C=0.00005) annotation(Placement(
					visible=true,
					transformation(
				...
				annotation(
					Diagram,
					Icon(graphics={Rectangle(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-87.6945,78.6421},{88.5431,-74.6818}}),Text(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{10.4668,68.1754},{76.3791,30.2687}}, textString = "%Vref V"),Text(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-63.6492,18.9533},{57.9915,-33.0976}}, textString = "DCDC")}));
			end DCtoDCModel;
			...
			connector Powerconnector_out
				...
				annotation(
					Icon(graphics={Polygon(points = {{-38.7553,84.2999},{34.7949,84.5827},{89.1089,3.9604},{40.4526,-86.2801},{-41.5842,-87.4116},{-88.826,6.78925},{-38.7553,84.2999}}, rotation = 0, lineColor = {0,0,255}, fillColor = {255,255,0}, pattern = LinePattern.Solid, fillPattern = FillPattern.Solid, lineThickness = 0.25)}),
			...
			connector Powerconnector_in
				...
				annotation(
					Icon(graphics={Polygon(points = {{-38.7553,84.2999},{34.7949,84.5827},{89.1089,3.9604},{40.4526,-86.2801},{-41.5842,-87.4116},{-88.826,6.78925},{-38.7553,84.2999}}, rotation = 0, lineColor = {0,0,255}, fillColor = {255,255,0}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25)}),
			...
			model DCtoPower "generic ideal DC/DC Converter with Power Output"
				...
				annotation(
					Diagram,
					Icon(graphics={Rectangle(rotation = 0, lineColor = {0,0,255}, fillColor = {0,0,255}, pattern = LinePattern.Solid, fillPattern = FillPattern.None, lineThickness = 0.25, extent = {{-87.9774,80.3395},{98.1612,-79.7737}})}));
			end DCtoPower;
			...
			model dcdc_ideal_simple_improved
				...
				equation
					...
					i1 = p1.i;
					i2 = p2.i;
					connect(dcdc_ideal_simple1.p2,p2) annotation(Line(
						points={{8,13},{13,13},{88,13},{88,42},{93,42}},
						thickness=0.0625));
					connect(dcdc_ideal_simple1.n2,n2) annotation(Line(
						points={{8,1},{13,1},{88,1},{88,-47},{93,-47}},
						thickness=0.0625));
					connect(dcdc_ideal_simple1.n1,n1) annotation(Line(
						points={{-16,1},{-21,1},{-88,1},{-88,-32},{-93,-32}},
						thickness=0.0625));
				annotation(
					Icon(
						coordinateSystem(extent={{-100,-100},{100,100}}),
			...
			package examples
				...
				model dcdc_pid_characteristic
					...
					equation
						...
						connect(constantvoltage1.p,dcdc_pid1.p1) annotation(Line(
							points={{-79,8},{-79,13},{-79,24},{-44,24},{-39,24}},
							thickness=0.0625));
						connect(dcdc_pid1.p2,variableresistor1.p) annotation(
							Line(
								points={{-20.66667175292969,24.33333587646484},{-16,20},{50,20},{50,10},{50,5.333335876464844}},
								thickness=0.0625),
							AutoRoute=false);
						connect(dcdc_pid1.n2,dcdc_pid1.n1) annotation(
							Line(
								points={{-21,15},{-16,15},{-16,5},{-44,5},{-44,16},{-39,
								16}},
								thickness=0.0625),
							AutoRoute=false);
						connect(dcdc_pid1.n1,ground1.p) annotation(Line(
				...
				model dcdc_pid_jump
					...
					equation
						...
						connect(dcdc_pid1.n2,dcdc_pid1.n1) annotation(
							Line(
								points={{-20.66667175292969,15.33333587646484},{-16,15},{-16,5},{-44,5},{-44,16},{-39.33333587646484,
								16}},
								thickness=0.0625),
							AutoRoute=false);
						connect(dcdc_pid1.n1,ground1.p) annotation(Line(
							...
							-28}},
							thickness=0.0625));
						connect(dcdc_pid1.p2,resistor1.p) annotation(Line(
							points={{-21,24},{-16,24},{29,24},{29,-7},{24,-7}},
							thickness=0.0625));
						connect(trapezoidVoltage1.p,dcdc_pid1.p1) annotation(Line(
							points={{-70,25},{-70,30},{-57,30},{-57,24},{-44,24},{-39,
							24}},
							thickness=0.0625));
			...
			model dcdc_pid
				...
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C(displayUnit="nF")=1.0000000000000001e-007) annotation(Placement(transformation(
					origin={-75,0},
					extent={{-10,-10},{10,10}},
					rotation=-90)));
				...
				equation
					connect(I2.p,n2) annotation(Line(
						points={{50,-10},{50,-15},{50,-47},{88,-47},{93,-47}},
						thickness=0.0625));
							
					connect(I2.n,p2) annotation(Line(
						points={{50,10},{50,15},{50,42},{88,42},{93,42}},
						thickness=0.0625));
					connect(I2.p,voltagesens.n) annotation(Line(
						points={{50,-10},{50,-15},{70,-15},{70,-10}},
						thickness=0.0625));
					connect(voltagesens.p,I2.n) annotation(Line(
						points={{70,10},{70,15},{50,15},{50,10}},
						thickness=0.0625));
					connect(pID.u_m,voltagesens.v) annotation(
						Line(
							points={{-15,43},{-15,38},{-15,35},{60,35},{60,0}},
							color={0,0,127},
							thickness=0.0625),
						AutoRoute=false);
					connect(const.y,pID.u_s) annotation(Line(
						points={{-44,55},{-39,55},{-32,55},{-27,55}},
						color={0,0,127},
						thickness=0.0625));
					connect(I1.n,n1) annotation(Line(
						points={{-55,-10},{-55,-15},{-55,-47},{-88,-47},{-93,-47}},
						thickness=0.0625));
					connect(I1.p,p1) annotation(
						Line(
							points={{-55,10},{-55,15},{-55,20},{-87,20},{-92.33332824707031,42}},
							thickness=0.0625),
						AutoRoute=false);
					connect(voltageSensor1.v,onOffController1.u) annotation(Line(
						points={{-25,0},{-20,0},{-20,-1},{-22,-1},{-22,-2},{-17,
						-2}},
						color={0,0,127},
						thickness=0.0625));
					connect(const1.y,onOffController1.reference) annotation(Line(
						points={{-24,30},{-19,30},{-19,19},{-22,19},{-22,7},{-17,
						7}},
						color={0,0,127},
						thickness=0.0625));
					connect(pID.y,product1.u1) annotation(Line(
						points={{-4,55},{1,55},{13,55},{13,12},{18,12}},
						color={0,0,127},
						thickness=0.0625));
					connect(product1.y,I2.i) annotation(Line(
						points={{36,7},{41,7},{41,4},{38,4},{38,0},{43,
						0}},
						color={0,0,127},
						thickness=0.0625));
					connect(onOffController1.y,nor1.u) annotation(Line(
						points={{1,2},{6,2},{6,-6},{-2,-6},{-2,-15},{3,
						-15}},
						color={255,0,255},
						thickness=0.0625));
					connect(nor1.y,product1.u2) annotation(Line(
						points={{16,-15},{21,-15},{21,-6},{13,-6},{13,3},{18,
						3}},
						color={255,0,255},
						thickness=0.0625));
					connect(voltageSensor1.n,I1.n) annotation(Line(
						points={{-35,-10},{-35,-15},{-55,-15},{-55,-10}},
						thickness=0.0625));
					connect(voltageSensor1.p,I1.p) annotation(Line(
						points={{-35,10},{-35,15},{-55,15},{-55,10}},
						thickness=0.0625));
					connect(voltagesens.p,capacitor2.p) annotation(Line(
						points={{70,10},{70,15},{90,15},{90,10}},
						thickness=0.0625));
					connect(capacitor2.n,voltagesens.n) annotation(Line(
						points={{90,-10},{90,-15},{70,-15},{70,-10}},
						thickness=0.0625));
					connect(capacitor1.p,I1.p) annotation(Line(
						points={{-75,10},{-75,15},{-55,15},{-55,10}},
						thickness=0.0625));
		...
		package examples
			model unregulated_DET
				...
				Modelica.Electrical.Analog.Basic.Resistor resistor1(R=13) annotation(Placement(transformation(
					origin={75.92480000000001,26.9653},
				...
				equation
					...
					connect(pcu1.VCC3,resistor3.p) annotation(Line(points={{57,3},{62,3},{62,-7},{61,-7},{61,-17},{66,
					-17}}));
					connect(resistor1.p,pcu1.VCC12) annotation(Line(points={{66,27},{61,27},{61,18},{62,18},{62,10},{57,
					10}}));
					connect(pcu1.GND,battery1.n) annotation(Line(points={{37,1},{32,1},{32,-18},{14,-18},{14,-13}}));
					connect(pcu1.gnd,pcu1.GND) annotation(
						Line(points={{57,-1},{62,-1},{62,-10},{32,-10},{32,1},{37,
						1}}),
						AutoRoute=false);
					connect(battery1.p,pcu1.VCC) annotation(Line(points={{14,7},{14,12},{23,12},{23,6},{32,6},{37,
					6}}));
			...
			model EVS3
				...
				Modelica.Electrical.Analog.Basic.Resistor resistor3(R=25) annotation(Placement(transformation(
					origin={60.2546,67.04380000000001},
					extent={{-12,12},{12,-12}},
					rotation=-90)));
				Modelica.Blocks.Sources.Trapezoid trapezoid1(
					amplitude=1000,
				...
				equation
					...
					connect(dcdc_ideal_simple_improved2.p2,resistor2.p) annotation(Line(points={{35.7115,38.4724},{46.6761,38.4724},{46.6761,48.3734},{59.1231,48.3734},{59.1231,46.512},{59.6888,
					46.512}}));
					...
					connect(dcdc_ideal_simple_improved3.p2,resistor3.p) annotation(Line(points={{34.5799,71.56999999999999},{43.2815,71.56999999999999},{43.2815,80.0566},{60.2546,80.0566},{60.2546,79.04380000000001}}));
			...
			model EPS_without_GND
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(
					...
					transformation(
						...
						extent={{-10,-10},{10,10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C=0.0000000001) annotation(Placement(
					visible=true,
					transformation(
						origin={11.5607,-36.4162},
						extent={{-10,-10},{10,10}},
						rotation=0)));
				Modelica.Electrical.Analog.Basic.Capacitor capacitor2(C=0.0000000001) annotation(Placement(
					visible=true,
					transformation(
			...
			model PCU_pid_example
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(
					...
					extent={{-10,-10},{10,10}})));
				equation
					connect(pcu1.GND,pcu1.gnd) annotation(Line(points={{-47,0},{-52,0},{-52,-10},{-22,-10},{-22,-2},{-27,
					-2}}));
					connect(ground1.p,pcu1.GND) annotation(Line(points={{-63,-14},{-63,-9},{-63,0},{-52,0},{-47,0}}));
					connect(battery1.n,ground1.p) annotation(Line(points={{-86,-15},{-86,-20},{-75,-20},{-75,-9},{-63,-9},{-63,
					-14}}));
					connect(battery1.p,pcu1.VCC) annotation(Line(points={{-86,5},{-86,10},{-69,10},{-69,5},{-52,5},{-47,
					5}}));
					connect(pcu1.gnd,resistor3.n) annotation(
						Line(points={{-27,-2},{-22,-30},{40,-30},{40,-21},{35,-21}}),
						AutoRoute=false);
			...
			annotation(
				...
				Icon(
					coordinateSystem(
						...
						initialScale=0.1,
						grid={2,2}),
					graphics={Rectangle(origin = {1.83333,-2.83333}, extent = {{-84.1667,-92.1667},{84.1667,92.1667}}),Text(origin = {1.66667,63}, extent = {{-63.3333,10.6667},{63.3333,-10.6667}}, textString = "Verbraucher"),Text(origin = {3,-23}, extent = {{-61.3333,35.3333},{61.3333,-35.3333}}, textString = "%power_nominal W")}),
				experiment(
					StartTime=0.0,
					StopTime=100.0,
					Tolerance=0.000001));
		...
		model PCU_pid
			...
			equation
					...
					points={{-10,-35},{-15,-35},{-30,-35},{-30,-30},{-30,-25}},
					thickness=0.0625));
					connect(resistor1.n,dcdc_pid12.p1) annotation(
					Line(
						points={{10,0},{25,0},{25,45},{48,45}},
						thickness=0.0625),
					AutoRoute=false);
					connect(dcdc_pid5.p1,resistor1.n) annotation(
					Line(
						points={{48.33332824707031,8},{43,8},{25,8},{25,0},{10,0}},
						thickness=0.0625),
					AutoRoute=false);
					connect(resistor1.n,dcdc_pid3.p1) annotation(
					Line(
						points={{10,0},{15,0},{25,0},{25,-25},{47.66667175292969,-24.66667175292969}},
						thickness=0.0625),
					AutoRoute=false);
					connect(dcdc_pid5.n1,resistor4.p) annotation(
					Line(
						points={{48.33332824707031,-0.3333358764648438},{43,0},{35,0},{35,-35},{10,-35}},
						thickness=0.0625),
					AutoRoute=false);
					connect(dcdc_pid12.n1,resistor4.p) annotation(
					Line(
						points={{48,37},{43,37},{35,37},{35,-35},{10,-35}},
						thickness=0.0625),
					AutoRoute=false);
					connect(dcdc_pid3.n1,resistor4.p) annotation(
					Line(
						points={{47.66667175292969,-33},{43,-33},{35,-33},{35,-35},{10,-35}},
						thickness=0.0625),
					AutoRoute=false);
					connect(dcdc_pid12.p2,VCC12) annotation(Line(
					points={{66,45},{71,45},{94,45},{94,45},{99,45}},
					thickness=0.0625));
					connect(dcdc_pid5.p2,VCC5) annotation(Line(
					points={{67,8},{72,8},{95,8},{95,9},{100,9}},
					thickness=0.0625));
					connect(dcdc_pid3.p2,VCC3) annotation(Line(
					points={{66,-25},{71,-25},{95,-25},{95,-23},{100,-23}},
					thickness=0.0625));
					connect(dcdc_pid12.n2,dcdc_pid5.n2) annotation(Line(
					points={{67,36},{72,36},{72,-1},{67,-1}},
					thickness=0.0625));
					connect(dcdc_pid5.n2,dcdc_pid3.n2) annotation(Line(
					points={{67,-1},{72,-1},{72,-34},{71,-34},{66,-34}},
					thickness=0.0625));
					connect(dcdc_pid3.n2,gnd) annotation(
					Line(
		...
		package Parts
			...
			model reactionwheelsimple
				...
				Modelica.Mechanics.MultiBody.Parts.Body Schwungmasse(
					...
					I_11=0.0000001,
					I_22=0.0000001,
					I_33=0.0000001) annotation(Placement(
					visible=true,
					transformation(
