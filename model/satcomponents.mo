		...
		package dcmodel
			...
			model dcdc_pid
				...
				equation
					...
					i2 = p2.i;
				equation
					connect(powerSensor1.pc,p2) annotation(Line(
						points={{0,40},{0,45},{44,45},{44,42},{88,42},{93,
						42}},
						thickness=0.0625));
					connect(powerSensor1.pv,powerSensor1.nc) annotation(Line(
						points={{10,30},{15,30},{15,15},{0,15},{0,20}},
						thickness=0.0625));
					
					
					
					
					connect(I1.p,p1) annotation(Line(
						points={{-55,10},{-55,15},{-55,42},{-87,42},{-92,42}},
						thickness=0.0625));
					connect(I1.n,n1) annotation(Line(
						points={{-55,-10},{-55,-15},{-55,-47},{-88,-47},{-93,-47}},
						thickness=0.0625));
					connect(I2.p,n2) annotation(Line(
						points={{0,-10},{0,-15},{0,-47},{88,-47},{93,-47}},
						thickness=0.0625));
					connect(voltageSensor1.p,I2.n) annotation(Line(
						points={{35,10},{35,15},{0,15},{0,10}},
						thickness=0.0625));
					connect(I2.p,voltageSensor1.n) annotation(Line(
						points={{0,-10},{0,-15},{35,-15},{35,-10}},
						thickness=0.0625));
					connect(I2.n,powerSensor1.nc) annotation(Line(
		...
		package examples
			model unregulated_DET
				...
				solar_power.SA_Regulator sa_regulator1(Vmax=95) annotation(Placement(transformation(
					...
					extent={{-10,-10},{10,10}})));
				equation
					connect(sa_regulator1.n,battery1.p) annotation(Line(points={{-12.5564,24.9624},{13.8346,24.9624},{13.8346,7},{13.9999,7}}));
					connect(sa_regulator1.pin_n,solarcell_simple1.p) annotation(Line(points={{-22.7669,15.2481},{-22.8571,15.2481},{-22.8571,-15.0376},{-52,-15.0376},{-52,-15}}));
					connect(solarcell_simple1.n,sa_regulator1.p) annotation(Line(points={{-52,5},{-52,24.9624},{-32.8571,24.9624},{-32.5564,24.9624}}));
					connect(resistor3.n,pcu1.gnd) annotation(Line(points={{86.3006,-16.763},{86.4162,-16.763},{86.4162,-36.9942},{56.9364,-36.9942},{56.9364,-1.15607},{56.9364,
					-1.15607}}));
					...
					connect(pcu1.GND,battery1.n) annotation(Line(points={{36.7218,0.76101},{36.4162,0.76101},{36.4162,-36.9942},{13.8728,-36.9942},{13.8728,-12.7168},{13.8728,
					-12.7168}}));
					connect(pcu1.gnd,pcu1.GND) annotation(Line(points={{56.8349,-1.1909},{56.9364,-1.1909},{56.9364,-36.9942},{36.4162,-36.9942},{36.4162,0.867052},{36.4162,
					0.867052}}));
			...
			model PCU_PID_example
				...
				batteries.battery battery1(
					...
					extent={{-10,-10},{10,10}},
					rotation=-90)));
				PCU pcu1(C1(v(start=20))) annotation(Placement(transformation(
					origin={-37.2832,4.04624},
					extent={{-10,-10},{10,10}})));
				...
				Modelica.Electrical.Analog.Basic.Ground ground1 annotation(Placement(transformation(
					...
					extent={{-10,-10},{10,10}})));
				equation
					connect(pcu1.GND,pcu1.gnd) annotation(Line(points={{-47.3822,-0.39506},{-48.2659,-0.39506},{-48.2659,-10.1156},{-26.8786,-10.1156},{-26.8786,-2.60116},{-26.8786,
					-2.60116}}));
					connect(ground1.p,pcu1.GND) annotation(Line(points={{-63.2948,-14.2775},{-48.2659,-14.2775},{-48.2659,0},{-48.2659,0}}));
					connect(battery1.n,ground1.p) annotation(Line(points={{-86.1272,-15.4913},{-86.1272,-14.4509},{-63.2948,-14.4509},{-63.2948,-14.4509}}));
					connect(battery1.p,pcu1.VCC) annotation(Line(points={{-86.1272,4.50867},{-86.1272,4.91329},{-47.9769,4.91329},{-47.9769,4.91329}}));
					connect(pcu1.gnd,resistor3.n) annotation(Line(points={{-27.2691,-2.34697},{-21.0983,-2.34697},{-21.0983,-40.4624},{42.7746,-40.4624},{42.7746,-21.3873},{34.3931,
					-21.3873},{34.3931,-21.3873}}));
					connect(resistor2.n,resistor1.n) annotation(Line(points={{34.2775,1.15607},{42.4855,1.15607},{42.4855,22.2543},{34.104,22.2543},{34.104,22.2543}}));
					connect(resistor3.n,resistor2.n) annotation(Line(points={{34.5665,-21.3873},{42.7746,-21.3873},{42.7746,1.15607},{34.104,1.15607},{34.104,1.15607}}));
					connect(pcu1.VCC3,resistor3.p) annotation(Line(points={{-27.2691,1.72658},{-15.3179,1.72658},{-15.3179,-21.3873},{14.4509,-21.3873},{14.4509,-21.3873}}));
					connect(pcu1.VCC5,resistor2.p) annotation(Line(points={{-27.2973,4.92318},{-12.1387,4.92318},{-12.1387,1.15607},{14.1618,1.15607},{14.1618,1.15607}}));
