model dreiBausteineInReihe
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalconductor2(G=1) annotation(Placement(visible=true, transformation(origin={-40.6933,6.32737}, extent={{-12,-12},{12,12}}, rotation=0)));
  ...
  Modelica.Thermal.HeatTransfer.Components.ThermalConductor thermalconductor1(G=1) annotation(Placement(visible=true, transformation(origin={23.5846,6.05227}, extent={{-12,-12},{12,12}}, rotation=0)));
