model drei_Bausteine_in_Reihe
  ...
  output Modelica.SIunits.Temperature T_BB1xn=buildingBlock_thermal1.thermal_connector_xn.MSS.T "Resulting Temperature";
  output Modelica.SIunits.Temperature T_BB1xp=buildingBlock_thermal1.thermal_connector_xp.MSS.T "Resulting Temperature";
  output Modelica.SIunits.Temperature T_BB2xn=buildingBlock_thermal2.thermal_connector_xn.MSS.T "Resulting Temperature";
  output Modelica.SIunits.Temperature T_BB2xp=buildingBlock_thermal2.thermal_connector_xp.MSS.T "Resulting Temperature";
  output Modelica.SIunits.Temperature T_BB3xn=buildingBlock_thermal3.thermal_connector_xn.MSS.T "Resulting Temperature";
  output Modelica.SIunits.Temperature T_BB3xp=buildingBlock_thermal3.thermal_connector_xp.MSS.T "Resulting Temperature";
  Modelica.Thermal.HeatTransfer.Sources.FixedHeatFlow fixedHeatFlow1(Q_flow=100) annotation(Placement(visible=true, transformation(origin={-125.0,35.0}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
  ...
  thermal_TIM thermal_TIM1(G_TIM_TSS=160, G_MSS=0, G_ESS=0, Gr_Rad=0) annotation(Placement(visible=true, transformation(origin={-42.7906,68.269}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
  thermal_TIM thermal_TIM2(G_ESS=0, G_MSS=0, G_TIM_TSS=160, Gr_Rad=0) annotation(Placement(visible=true, transformation(origin={40.0,67.9424}, extent={{-10.0,-10.0},{10.0,10.0}}, rotation=0)));
...
equation 
  connect(buildingBlock_thermal1.port_b,fixedHeatFlow1.port) annotation(Line(visible=true, origin={-97.0113,46.6667}, points={{8.9943,23.3333},{8.9943,-11.6667},{-17.9887,-11.6667}}, color={191,0,0}));
